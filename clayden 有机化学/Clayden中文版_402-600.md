...
从图中可以清楚地看到，环己烷环翻转的势垒为 $43 \, \mathrm{kJ} \mathrm{mol}^{-1}$ ，因此在 $25^{\circ}C$ 下速率为 $2 \times 10^{5} \, s^{-1}$ 。环翻转同样可以交换直立键和平伏键上的质子，因此它们在 $25^{\circ}C$ 下也会以 $2 \times 10^{5} \, s^{-1}$ 的速率交换——超过了 NMR 可区分的速率，这就是为什么它们以平均信号的形式出现的原因。
...
例如，对于甲基环己烷 $\left(\mathrm{X}=\mathrm{CH}_{3}\right)$ ，甲基处于直立键的构象比处于平伏键的构象高能 $7.3\ \mathrm{kJ}\ \mathrm{mol}^{-1}$ 。这种能量差导致在 $25^{\circ}C$ 下前者和后者的比例为 20:1。
...
IR 中关键的区别在于 C=O 伸缩的频率 (受共轭降低了 $40 \, \mathrm{cm}^{-1}$ ) 和 C=C 伸缩的强度。在 ${}^{13}C$ NMR 中，共轭烯醛的 C3 从烯烃区域移到了羰基区域，这表明碳原子必然变得缺电子。在质子 NMR 中，有很多的影响存在，很可能最有用的是，共轭烯烃中质子向低场区移动，尤其是 C3 上的质子 (和碳谱一样！)。
...
一个很好的延伸例子是环状酰胺，即内酰胺(lactams)间 C=0 伸缩频率的差异。盘尼西林类抗生素都包含被称为 β-内酰胺的四元环。这些化合物中的羰基伸缩频率都超过六元环内酰胺，也是您应当认为无张力酰胺所具有的 $1680 \, \mathrm{cm}^{-1}$ 。
...
| 效应 | 基 | C=0 伸缩频率, cm-1 | 频率改变量a, cm-1 |
| --- | --- | --- | --- |
| 诱导效应 | Cl | 1800 | +85 |
| 诱导效应 | OCOR | 1765, 1815 | +50, +100 |
| 诱导效应 | OR | 1745 | +30 |
| 诱导效应 | H | 1730 | +15 |
| 共轭 | C=C | 1685 | -30 |
| 共轭 | 芳基 | 1685 | -30 |
...
请以页边的五元共轭不饱和内酯为例试一试。需要加酯基的 $30 \, \mathrm{cm}^{-1}$ ，减双键的 $30 \, \mathrm{cm}^{-1}$ ，再加五元环的 $30 \, \mathrm{cm}^{-1}$ 。前两个抵消了，剩下 $1715 + 30 = 1745 \, \mathrm{cm}^{-1}$ 。此化合物实际上在 $1740 - 1760 \, \mathrm{cm}^{-1}$ 吸收，估算是准确的！
...
您可能已经注意到，我们将双键画成了顺式 (Z) 构型。我们通过质子 NMR 获知了这一结果，前者显示出烯烃两端质子存在一个 6.5 Hz 偶合 (相比于反式偶合小得多，见 p. 295)。同样还有刚刚描述过的一个长程偶合 ( $^{4}J = 2.5 \, \mathrm{Hz}$ ) 和一个炔烃质子与烯烃末端质子之间小的非常长程的偶合 ( $^{5}J = 1 \, \mathrm{Hz}$ )。
...
| 元素 | 电负性 | 化合物 | $\delta_{H}$ , ppm | $\delta_{C}$ , ppm |
| --- | --- | --- | --- | --- |
| Li | 1.0 | $CH_3-Li$ | -1.94 | -14.0 |
| Si | 1.9 | $CH_3-SiMe_3$ | 0.0 | 0.0 |
| I | 2.7 | $CH_3-I$ | 2.15 | -23.2 |
| S | 2.6 | $CH_3-SMe$ | 2.13 | 18.1 |
| N | 3.1 | $CH_3-NH_2$ | 2.41 | 26.9 |
| Cl | 3.2 | $CH_3-Cl$ | 3.06 | 24.9 |
| O | 3.4 | $CH_3-OH$ | 3.50 | 50.3 |
| F | 4.0 | $CH_3-F$ | 4.27 | 75.2 |
...
|  | 官能团 | 化合物 | $\delta_{H}$ , ppm | $\delta_{H}-0.9$ , ppm | $\delta_{C}$ , ppm | $\delta_{C}-8.4$ , ppm |
| --- | --- | --- | --- | --- | --- | --- |
| 1 |
| 6 | 氰基 | $PhCH_{2}-CN$ | 3.70 | 1.06 | 23.5 | -5.4 |
| 7 | 羧基 | $PhCH_{2}-CO_{2}H$ | 3.71 | 1.07 | 41.1 | 12.2 |
| 8 | 酯基 | $PhCH_{2}-CO_{2}Me$ | 3.73 | 1.09 | 41.1 | 12.2 |
| 9 | 酰胺基 | $PhCH_{2}-CONEt_{2}$ | 3.70 | 1.06 | ? | ? |
| 10 | 酮羰基 | $(PhCH_{2})_{2}C=O$ | 3.70 | 1.06 | 49.1 | 20.2 |
| 11 | 巯基 | $PhCH_{2}-SH$ | 3.69 | 1.05 | 28.9 | 0.0 |
| 12 | 硫醚 | $(PhCH_{2})_{2}S$ | 3.58 | 0.94 | 35.5 | 6.6 |
| 13 | 亚硫酰基 | $(PhCH_{2})_{2}S=O$ | 3.88 | 1.24 | 57.2 | 28.3 |
| 14 | 硫酰基 | $(PhCH_{2})_{2}SO_{2}$ | 4.11 | 1.47 | 57.9 | 29.0 |
| 15 | 氨基 | $PhCH_{2}-NH_{2}$ | 3.82 | 1.18 | 46.5 | 17.6 |
| 16 | 酰胺(从氮) | $PhCH_{2}-NHCOH$ | 4.40 | 1.76 | 42.0 | 13.1 |
| 17 | 硝基 | $PhCH_{2}-NO_{2}$ | 5.20 | 2.56 | 81.0 | 52.1 |
| 18 | 铵基 | $PhCH_{2}-NMe_{3}^{+}$ | 4.5/4.9 |  | 55.1 | 26.2 |
| 19 | 羟基 | $PhCH_{2}-OH$ | 4.54 | 1.80 | 65.3 | 36.4 |
| 20 | 醚 | $(PhCH_{2})_{2}O$ | 4.52 | 1.78 | 72.1 | 43.2 |
| 21 | 烯醇醚 | $PhCH_{2}-O(p-C_{6}H_{4}CH_{2}Cl)$ | 5.02 | 2.38 | 69.9 | 41.0 |
| 22 | 酯(从氧) | $MeCO_{2}-CH_{2}Ph$ | 5.10 | 2.46 | 68.2 | 39.3 |
| 23 | 磷 | $Ph_{3}P^{+}-CH_{2}Ph$ | 5.39 | 2.75 | 30.6 | 1.7 |
| 24 | 氯 | $PhCH_{2}-Cl$ | 4.53 | 1.79 | 46.2 | 17.3 |
| 25 | 溴 | $PhCH_{2}-Br$ | 4.45 | 1.81 | 33.5 | 4.6 |
...
|  | 与H的键 | π键 | 和 |
| --- | --- | --- | --- |
| 酮式 | 440(C-H) | 720(C=O) | 1160 |
| 烯醇式 | 500(O-H) | 620(C=C) | 1120 |
...
| 化合物 | 生成的产物(%) |  |  | 硝化速率(与苯的相对值) |
| --- | --- | --- | --- | --- |
| 化合物 | 邻位 | 间位 | 对位 | 硝化速率(与苯的相对值) |
| PhF | 13 | 0.6 | 86 | 0.18 |
...
| 电子效应 | 离子 | 活化 | 定位 |
| --- | --- | --- | --- |
| 共轭给电子 | $-NR_{2}, -OR$ | 很活化 | 仅邻对位 |
| 诱导给电子 | 烷基 | 活化 | 大部分邻对位,有一些间位 |
| 共轭给电子并诱导吸电子 | $F, Cl, Br, I$ | 钝化 | 绝大部分的对位和少量邻位 |
| 诱导吸电子 | $-CF_{3}, -NR_{2}^{+}$ | 钝化 | 仅间位 |
| 共轭吸电子 | $-NO_{2}, -CN, -COR, -SO_{3}R$ | 很钝化 | 仅间位 |
...
如果您需要回顾 IR 光谱法，请返回 Chapter 3. 任何 C=O 的峰都会在 $1700 \, \mathrm{cm}^{-1}$ 左右。产物中没有这样的峰，替代的是 O-H 在 $3600 \, \mathrm{cm}^{-1}$ 处的峰。而 $2250 \, \mathrm{cm}^{-1}$ 处的为 C≡N; C=C 在 $1650 \, \mathrm{cm}^{-1}$ 处。
...
IR 光谱法为我们提供了与C=O 共轭的 C=C 键发生极化的证据。一个不共轭的酮的 C=O 在 $1715 \, \mathrm{cm}^{-1}$ 处吸收，一个不共轭烯烃的 C=C 大约在 $1650 \, \mathrm{cm}^{-1}$ 处吸收 (通常很弱). 而将这两个基团组成共轭的 $\alpha,\beta-$ 不饱和羰基化合物则分别观察到了在 1675 和 $1615 \, \mathrm{cm}^{-1}$ 处的两个峰，并且都相当强。两个峰频率的降低和两个 $\pi$ 键的同时减弱是一致的 (注意有一定贡献的极化结构中 C=O 和 C=C 双键原来的位置只有一根单键). 而 C=C 吸收强度的增加与和 C=O 共轭带来的极化是一致的：共轭的 C=C 键的偶极矩显著地比不共轭的大。
...
| 硬的亲核试剂 | 分界 | 软的亲核试剂 |
| --- | --- | --- |
| $F^{-}$ , $OH^{-}$ , $RO^{-}$ , $SO_{4}^{2-}$ , $Cl^{-}$ | $N_{3}^{-}$ , $CN^{-}$ | $I^{-}$ , $RS^{-}$ , $RSe^{-}$ , $S^{2-}$ |
| $H_{2}O$ , $ROH$ , $ROR'$ , $RCOR'$ | $RNH_{2}$ , $R^{1}R^{2}NH$ | $RSH$ , $RSR'$ , $R_{3}P$ |
| $NH_{3}$ , $RMgBr$ , $RLi$ | $Br^{-}$ | 烯烃,芳环 |
...
|  | 有利于共轭加成的 | 有利于对 C=0 直接加成的 |
| --- | --- | --- |
| 反应条件 (用于可逆加成): $\alpha, \beta$ -不饱和化合物的结构: | 热力学控制: 高温、长时间不活泼的 C=0 基 (酰胺、酯)无空阻的 $\beta$ 碳 | 动力学控制: 低温、短时间活泼的 C=0 基 (醛、酰氯)有空阻的 $\beta$ 碳 |
| 亲核试剂的种类:有机金属: | 软亲核试剂有机铜或催化量的铜(I) | 硬亲核试剂有机锂、格氏试剂 |
...
| 保护基 | 结构 | 保护对象 | 面对 | 保护方法 | 脱保护方法 |
| --- | --- | --- | --- | --- | --- |
| 三烷基硅基 $R_{3}Si$ ,e.g. TBDMS | RO— $SiMe_{3}$ RO— $SiMe_{2}t-Bu$ | 醇 (OH 一般而言) | 亲核试剂, C或 N 碱 | $R_{3}SiCl$ , 碱 | $H^{+}$ , $H_{2}O$ , 或 $F^{-}$ |
...
| 保护基 | 结构 | 保护对象 | 面对 | 保护方法 | 脱保护方法 |
| --- | --- | --- | --- | --- | --- |
| Cbz (Z) (OCOBn) | RHN $\ce{ \chemfig{*6(-=-(-O-(-Ph)=-=))-=)} }$ | 胺 | 亲电试剂 | BnOCOCl, 碱 | HBr, AcOH; 或 H2, Pd |
...
| 保护基 | 结构 | 保护对象 | 面对 | 保护方法 | 脱保护方法 |
| --- | --- | --- | --- | --- | --- |
| Boc (t-BuOCO) |  | 胺 | 亲电试剂 | $(t\text{-BuOCO})_2\text{O}$ , 碱 | $H^+, H_2O$ |
