...
两者都从醛合成环氧化物，但机理和底物完全不同：

| 特征 | Corey-Chaykovsky 反应 | Darzens 缩合 |
|:---|:---|:---|
| 碳烯等价物 | 硫叶立德（S⁺-C⁻） | α-卤代酯的碳负离子 |
| 底物 | 醛或酮 | α-卤代酯（如 ClCH₂CO₂Et） |
| 碱 | NaH 或 DBU | NaOEt, LDA 等 |
| 产物 | 环氧化物（无酯基） | 环氧酯（带酯基，可后续水解脱羧） |
| 机理 | 1,2-两性离子 → 内环化 | 1,2-加成 → 分子内 SN2 关环 |
| 选择性 | E/Z 取决于叶立德稳定化 | 通常给出反式环氧酯 |
| 竞赛相关度 | 高 | 中等 |

**合成意义**：JCC 产物环氧化物可直接用于后续亲核开环；Darzens 产物环氧酯经水解-脱羧后也得环氧化物，但多了两步。Darzens 的独特价值在于环氧酯是 β-羟基-α-氨基酸的前体。
