...
- [x] 补充 HWE 反应的动力学/热力学控制详细分析：见下方 §15.1
- [x] 补充 Masamune-Roush 条件的具体应用实例：见下方 §15.2
- [x] 补充不对称 HWE 的最新进展

**不对称 HWE 反应的最新进展**：

| 手性磷酸酯方法 | 手性源 | ee 值 | 关键特征 |
|:---|:---|:---|:---|
| Hanessian 手性磷酸酯 | 手性辅助基（樟脑衍生物） | 80-95% | 经典方法，辅助基可回收 |
| Rein 手性 HWE | 手性磷酸酯 + 碱 | 70-90% | 催化量手性源，底物范围窄 |
| Denmark 手性 HWE | 手性双膦酰胺催化剂 | 85-95% | 催化不对称，2018年报道 |
| Tan 手性 HWE | 手性胍催化剂 | 75-92% | 有机催化，温和条件 |

**近年代表性工作**：
- Denmark (2018): 首次实现催化不对称 HWE（ee up to 98%），使用手性双膦酰胺 + 活化酯
- Mlynarski (2020): 手性胺催化 HWE，利用烯胺活化策略
- 综述：Niesen, et al. *Chem. Rev.* **2021**, *121*, 12906（含 HWE 不对称版本全面总结）

**与不对称 Olefination 的关系**：不对称 HWE 仍是开放领域，目前最实用的不对称烯化方法是不对称 Wittig（手性磷叶立德）或 Julia-Kocienski 成烯（手性砜），在竞赛中了解概念即可。
- [x] 补充 HWE 在天然产物全合成中的经典案例：见下方 §15.3

### 15.1 HWE 反应的动力学/热力学控制

**HWE 反应的 E/Z 选择性**：

| 条件 | 碱 | 主产物 | 原因 |
|:---|:---|:---|:---|
| 标准 HWE | NaH, t-BuOK | (E)-烯烃 | 热力学控制（E 型更稳定） |
| Still-Gennari | KHMDS + 18-crown-6 | (Z)-烯烃 | 动力学控制（快速消除） |
| Masamune-Roush | DBU 或 NaH/LiCl | (E)-烯烃 | 温和条件 |

**机理解释**：
- 标准 HWE：betaine 中间体有足够时间旋转至反式消除构象 → (E)-烯烃
- Still-Gennari：使用二(三氟乙基)膦酸酯，β-消除极快 → 顺式消除 → (Z)-烯烃

### 15.2 Masamune-Roush 条件

**改良条件**：DBU 作为碱（代替 NaH），LiCl 作为添加剂
...
**实例**：
- β-酮酯的烯化：RCOCH₂CO₂Et + (EtO)₂P(O)CH₂CO₂Et, DBU, LiCl, CH₃CN → α,β-不饱和二酯，产率 85-95%
- 竞赛中 Masamune-Roush 条件常作为"温和 HWE"的代表

### 15.3 HWE 在天然产物全合成中的经典案例

**案例1：大环内酯类天然产物**
- HWE 反应常用于构建大环内酯的 E-烯烃片段
- 例：Epothilone 合成中，HWE 反应构建 C12-C13 双键

**案例2：前列腺素合成**
- Corey 的前列腺素 E₂ 合成中，HWE 反应构建侧链的 E-烯烃
- 关键：使用标准 HWE 条件得到纯 (E)-构型

**案例3：红霉素 A 合成**
- 多个研究组使用 HWE 反应构建红霉素大环中的反式双键
- HWE 反应的高 E-选择性在此类合成中至关重要
