...
Clapeyron方程描述纯物质两相平衡时蒸气压随温度的变化关系：dP/dT = ΔH/(TΔV)。Clausius-Clapeyron方程为其近似形式。
...
### 入门级例题
**题目**：水在373K时蒸气压为1 atm，蒸发焓为40.68 kJ/mol。估算水在383K时的蒸气压。
...
2. **高海拔烹饪**：海拔升高导致气压降低，水的沸点下降
3. **蒸馏技术**：利用不同物质蒸气压的温度依赖性差异进行分离
