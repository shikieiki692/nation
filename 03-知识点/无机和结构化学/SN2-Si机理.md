...
source_extracts:
  - source_file: "[[07-资料提炼/书籍提炼/提炼-无机化学第6版-第20章-配位化学理论]]"
    ...
    asset_type: "书籍提炼"
    asset_summary: "配位化学理论教材主干，含硅的亲核取代、SN2-Si机理"
---
...
## 十二、🎯 教学视角
**学习路径**：先掌握碳上经典SN2的协同机理 → 引出重元素（Si、P、S）无法一步完成的矛盾 → 讲解两步缔合-离解机制 → 通过SiCl₄水解与CCl₄不水解的对比建立直觉 → 讨论Berry假旋转对立体化学的影响

| 常见误区 | 正确理解 |
|:---|:---|
| "SN2-Si和碳上SN2一样是一步协同反应" | SN2-Si是两步过程（缔合形成高价中间体，再离解离去基团），中间体可独立存在 |
| "Si上不可能有SN1" | 正确——Si⁺极不稳定，几乎只走SN2-Si，不走SN1 |
| "五配位中间体一定是三角双锥" | 大多数情况是TBP，但Berry假旋转可使其变为SP（方锥），影响立体化学结果 |
