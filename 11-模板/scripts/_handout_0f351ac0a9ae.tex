...
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-2a-line-lattice.jpg}
\caption{(a) 一维直线点阵—等间距重复的几何点}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-2b-plane-lattice.jpg}
\caption{(b) 二维平面点阵—平面上周期排列的点}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{spatial-lattice.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-3-simple-cubic.jpg}
\caption{(a) 简单立方(P)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-3-body-centered-cubic.jpg}
\caption{(b) 体心立方(I)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-3-face-centered-cubic.jpg}
\caption{(c) 面心立方(F)}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-6a-non-close-packed-layer.jpg}
\caption{(a) 非密置层—球心呈正方形排列，空隙较大}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-6b-close-packed-layer.jpg}
\caption{(b) 密置层—球心呈正三角形排列，每个球与6个球相切}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-7b-sc-unit-cell.jpg}
\caption{(c) 简单立方晶胞—非密置层逐层正对叠加(配位数6，空间利用率52\%)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-7b-bcc-unit-cell.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{ccp-unit-cell.jpg}
\caption{(a) 面心立方晶胞(fcc/ccp)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{hcp-unit-cell.jpg}
\caption{(b) 六方晶胞(hcp)}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9b-ccp-layer-relation.jpg}
\caption{(a) CCP层序—第三层落在C位(ABCABC…)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9b-hcp-layer-relation.jpg}
\caption{(b) HCP层序—第三层回到A位(ABAB…)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9c-fcc-unit-cell-from-packing.jpg}
\caption{(c) 从CCP堆积中取出面心立方晶胞}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9c-hex-unit-cell-from-packing.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-8b-tetrahedral-void.jpg}
\caption{(a) 四面体空隙—4个等径球围成}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-8c-octahedral-void.jpg}
\caption{(b) 八面体空隙—6个等径球围成}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-8a-close-packed-bilayer.jpg}
\caption{密置双层—第二层球占据第一层凹陷的一半位置}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9a-ccp-stacking.jpg}
\caption{(a) CCP(ABCABC…层序)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-9a-hcp-stacking.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-11a-nacl.jpg}
\caption{(a) NaCl型—Cl面心立方堆积，Na占全部八面体空隙(6:6)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-11b-cscl.jpg}
\caption{(b) CsCl型—Cl简单立方堆积，Cs占立方体空隙(8:8)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-11c-cubic-zns.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{nacl-structure-unit-cell.jpg}
\caption{NaCl型晶胞结构}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{cscl-structure-unit-cell.jpg}
\caption{CsCl型结构}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{zns-structure-unit-cell.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{weller-12-2-caf2-fluorite.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{tio2-rutile-structure.png}
\caption{金红石型TiO结构—Ti(青色)位于四方晶胞顶点和体心，O(橙色)形成八面体配位}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{wurtzite-structure.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{perovskite-full.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{octahedral-coordination-radius-ratio.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{radius_ratio_decision.png}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-12-octahedral-coordination.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-17a-no-polarization.jpg}
\caption{(a) 理想离子键(无极化)—电子云球形对称}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-17b-slight-polarization.jpg}
\caption{(b) 轻微极化—负离子电子云略变形}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-17c-strong-polarization.jpg}
\caption{(c) 较强极化—电子云明显偏向正离子}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{puha-13-17d-covalent-bond.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{diamond-structure.jpg}
\caption{金刚石晶体结构(左)及其晶胞(右)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{13-14-co2-molecular-crystal-unit-cell.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.45\textwidth,keepaspectratio]{graphite-structure.jpg}
\caption{石墨的层状结构}
\end{figure}
