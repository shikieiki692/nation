...
\textbf{上节衔接}：← 化学平衡-超级充实版(自学完整)\textbar 化学平衡(平衡常数与 Q-K 分析)
\textbf{下节衔接}：→ 2026-06-23-沉淀溶解平衡\textbar 沉淀溶解平衡(\(K_{\1}\) 与酸碱的耦合)→ 2026-06-23-电化学基础\textbar 电化学(电极电势与酸碱)
\textbf{主框架教材}：《普通化学原理》第4版 第8章
\textbf{辅助教材}：上海中学竞赛课程第五讲、质心化学原理 L5-L7、周坤无机新课 Ch5
...
\textbf{动机段}：中学告诉我们''电离出 H\textsuperscript{+} 的是酸''(Arrhenius 定义)，但：
- NH\textsubscript{3} 没有 H\textsuperscript{+} 可电离，却是碱---为什么？
- HCl 溶于水是强酸，溶于液氨却变成弱酸---酸的强度取决于什么？
- BF\textsubscript{3} 没有 H\textsuperscript{+}，却能和 NH\textsubscript{3} 反应---这算酸碱反应吗？
...
\bottomrule\noalign{}
\endlastfoot
\textbf{H\textsubscript{2}O} & H\textsubscript{2}O → OH\textsuperscript{-} + H\textsuperscript{+} & H\textsubscript{2}O + H\textsuperscript{+} → H\textsubscript{3}O\textsuperscript{+} \\
\textbf{HCO\textsubscript{3}\textsuperscript{-}} & HCO\textsubscript{3}\textsuperscript{-} → CO\textsubscript{3}\textsuperscript{2-} + H\textsuperscript{+} & HCO\textsubscript{3}\textsuperscript{-} + H\textsuperscript{+} → H\textsubscript{2}CO\textsubscript{3} \\
\textbf{HPO\textsubscript{4}\textsuperscript{2-}} & HPO\textsubscript{4}\textsuperscript{2-} → PO\textsubscript{4}\textsuperscript{3-} + H\textsuperscript{+} & HPO\textsubscript{4}\textsuperscript{2-} + H\textsuperscript{+} → H\textsubscript{2}PO\textsubscript{4}\textsuperscript{-} \\
\textbf{H\textsubscript{2}O} & NH\textsubscript{3} + H\textsubscript{2}O → NH\textsubscript{4}\textsuperscript{+} + OH\textsuperscript{-}(水是酸) & NH\textsubscript{3} + H\textsubscript{2}O ← NH\textsubscript{4}\textsuperscript{+} + OH\textsuperscript{-}(水是碱) \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{电离} & HAc + H\textsubscript{2}O ⇌ H\textsubscript{3}O\textsuperscript{+} + Ac\textsuperscript{-} & 酸把质子给水 \\
\textbf{自偶电离} & H\textsubscript{2}O + H\textsubscript{2}O ⇌ H\textsubscript{3}O\textsuperscript{+} + OH\textsuperscript{-} & 水既给质子又接受质子 \\
\textbf{中和} & H\textsubscript{3}O\textsuperscript{+} + OH\textsuperscript{-} ⇌ 2H\textsubscript{2}O & 酸和碱直接反应 \\
\end{longtable}
}
...
\[
$K_{\1}$ = \frac{[\mathrm{H_3O^+}][\mathrm{A^-}]}{[\mathrm{HA}]} \qquad $K_{\1}$ = \frac{[\mathrm{HA}][\mathrm{OH^-}]}{[\mathrm{A^-}]}
\]

两式相乘：

\[
\boxed{$K_{\1}$ \cdot $K_{\1}$ = $K_{\1}$ = 1.0 \times 10^{-14} \quad (25°C)}
\]

\[
\boxed{\mathrm{p}$K_{\1}$ + \mathrm{p}$K_{\1}$ = 14.00}
\]
...
\[
\boxed{$K_{\1}$ = [\mathrm{H_3O^+}][\mathrm{OH^-}] = 1.0 \times 10^{-14} \quad (25°C)}
\]
...
\textbf{温度升高 → Kw 增大}：水的自偶电离是吸热过程(ΔH \textgreater{} 0)，升温促进电离。
\textbf{37°C(体温)时 Kw = 2.42 × 10\textsuperscript{-14}}，此时中性 pH ≈ 6.81(不是 7.00！)。
...
\[
[\mathrm{H_3O^+}] \approx \sqrt{$K_{\1}$ \cdot c}
\]

同时需要 \$c \cdot \(K_{\1}\) \textgreater{} 10 K\_w\$(确保水的电离可忽略)。
\textbf{易错点}：如果 Ka 较大(如二氯乙酸 Ka = 4.5 × 10\textsuperscript{-2})，即使 c/Ka \textgreater{} 400 也可能不满足 α \textless{} 5\%，此时必须用精确法(二次方程)。

\textbf{弱碱的对应公式}：

\[
[\mathrm{OH^-}] \approx \sqrt{$K_{\1}$ \cdot c} \qquad (c/$K_{\1}$ > 400)
\]
...
\[
x = \frac{-$K_{\1}$ + \sqrt{$K_{\1}$^2 + 4$K_{\1}$ c}}{2}
\]
...
精确法：x\textsuperscript{2}/(0.10 − x) = 0.083 → x\textsuperscript{2} + 0.083x − 0.0083 = 0 → x = 0.059 M
...
即 H\textsuperscript{+} 既来自 HA 的电离，也来自水的电离。当 c·Ka \textgreater{} 10Kw 时，{[}OH\textsuperscript{-}{]} 可忽略，简化为 {[}H\textsuperscript{+}{]} ≈ {[}A\textsuperscript{-}{]}。
...
- {[}S\textsuperscript{2-}{]} ≈ Ka\textsubscript{2}(与 c 无关！)
...
\]
\[
\mathrm{HCO_3^- + H_2O \rightleftharpoons H_2CO_3 + OH^-} \quad $K_{\1}$ = $K_{\1}$/K_{a1}
\]
...
\[
\boxed{\mathrm{pH} = \mathrm{p}$K_{\1}$ + \lg\frac{[\mathrm{A^-}]}{[\mathrm{HA}]}}
\]

对弱碱 B 及其共轭酸 BH\textsuperscript{+} 的混合溶液：

\[
\mathrm{pOH} = \mathrm{p}$K_{\1}$ + \lg\frac{[\mathrm{BH^+}]}{[\mathrm{B}]}
\]
...
\bottomrule\noalign{}
\endlastfoot
BF\textsubscript{3} & NH\textsubscript{3} & F\textsubscript{3}B←NH\textsubscript{3}(配位键) \\
...
K = Ka\textsubscript{1}(H\textsubscript{2}CO\textsubscript{3})/Ka\textsubscript{2}(H\textsubscript{2}SiO\textsubscript{3}) ≈ 10\textsuperscript{-6}·\textsuperscript{35}/10\textsuperscript{-12}·\textsuperscript{8} = 10\textsuperscript{6}·\textsuperscript{45}
...
\begin{verbatim}
物质是两性物质(如 NaHCO~3~)
  → 检查 Ka~2~ 和 Kb = Kw/Ka~1~ 的大小关系
  → 若 Ka~2~ ≈ Kb：用 [H^+^] = √(Ka~1~·Ka~2~)
  → 若 Ka~2~ ≫ Kb：视为弱酸处理
  → 若 Kb ≫ Ka~2~：视为弱碱处理
\end{verbatim}
...
\bottomrule\noalign{}
\endlastfoot
H\textsubscript{2}S → HS\textsuperscript{-} & 酸 → 共轭碱 & H\textsubscript{2}S / HS\textsuperscript{-} \\
CN\textsuperscript{-} → HCN & 碱 → 共轭酸 & HCN / CN\textsuperscript{-} \\
\end{longtable}
}
...
\[\lg\frac{[\mathrm{Ac^-}]}{[\mathrm{HAc}]} = \mathrm{pH} - \mathrm{p}$K_{\1}$ = 5.00 - 4.76 = 0.24\]
...
\textbf{1.} NH\textsubscript{3} + H\textsubscript{2}O ⇌ NH\textsubscript{4}\textsuperscript{+} + OH\textsuperscript{-}。共轭酸碱对：(NH\textsubscript{4}\textsuperscript{+}/NH\textsubscript{3}) 和 (H\textsubscript{2}O/OH\textsuperscript{-})。
...
(c) 错误。37°C 时中性 pH ≈ 6.81(因为 Kw = 2.42×10\textsuperscript{-14})。
...
\textbf{11.} 混合弱酸中，Ka(HF) ≫ Ka(HAc)，HAc 的电离被抑制。近似认为 {[}H\textsuperscript{+}{]} ≈ √(Ka(HF)·c) = √(7.2×10\textsuperscript{-4} × 0.10) = 8.5×10\textsuperscript{-3}，pH ≈ 2.07。
...
{[}H\textsuperscript{+}{]} ≈ {[}H\textsubscript{2}PO\textsubscript{4}\textsuperscript{-}{]} ≈ √(Ka\textsubscript{1}·c) = √(7.1×10\textsuperscript{-3} × 0.10) = 2.66×10\textsuperscript{-2} M
{[}HPO\textsubscript{4}\textsuperscript{2-}{]} ≈ Ka\textsubscript{2} = 6.3×10\textsuperscript{-8} M(与 c 无关)
{[}PO\textsubscript{4}\textsuperscript{3-}{]} ≈ Ka\textsubscript{2}·Ka\textsubscript{3}/{[}H\textsuperscript{+}{]} = 6.3×10\textsuperscript{-8} × 4.2×10\textsuperscript{-13}/2.66×10\textsuperscript{-2} = 1.0×10\textsuperscript{-18} M
...
设 {[}OH\textsuperscript{-}{]} = x：x\textsuperscript{2}/(0.10−x) = 0.083 → x\textsuperscript{2} + 0.083x − 0.0083 = 0
...
\textbf{19.} NaNH\textsubscript{2} + NH\textsubscript{3} → NH\textsubscript{2}\textsuperscript{-} + NH\textsubscript{4}\textsuperscript{+}(NaNH\textsubscript{2} 是强碱，完全夺取 NH\textsubscript{3} 的质子)
NH\textsubscript{4}Cl + NH\textsubscript{3} → NH\textsubscript{3} + NH\textsubscript{4}\textsuperscript{+} + Cl\textsuperscript{-}(NH\textsubscript{4}Cl 是强酸，完全给出质子给 NH\textsubscript{3})
...
lg({[}HPO\textsubscript{4}\textsuperscript{2-}{]}/{[}H\textsubscript{2}PO\textsubscript{4}\textsuperscript{-}{]}) = 7.21 − 7.20 = 0.01 → 比例 = 1.02:1。

H\textsubscript{3}PO\textsubscript{4} + Na\textsubscript{3}PO\textsubscript{4} → 3 NaH\textsubscript{2}PO\textsubscript{4}(完全反应后)
但我们需要 H\textsubscript{2}PO\textsubscript{4}\textsuperscript{-}/HPO\textsubscript{4}\textsuperscript{2-} 缓冲，所以不能直接混合。

更实际的方案：H\textsubscript{3}PO\textsubscript{4} + 2Na\textsubscript{3}PO\textsubscript{4} → 3Na\textsubscript{2}HPO\textsubscript{4}(控制比例)。
或 H\textsubscript{3}PO\textsubscript{4} + NaOH → NaH\textsubscript{2}PO\textsubscript{4} / Na\textsubscript{2}HPO\textsubscript{4} 缓冲。
...
等当点(25.00 mL)时生成 NaA，pH = 8.00 → pOH = 6.00 → {[}OH\textsuperscript{-}{]} = 10\textsuperscript{-6}。
...
\textbf{24.}
(a) AgCl 溶于浓氨水：AgCl + 2NH\textsubscript{3} → {[}Ag(NH\textsubscript{3})\textsubscript{2}{]}\textsuperscript{+} + Cl\textsuperscript{-}，K = Ksp·Kf = 1.8×10\textsuperscript{-10} × 1.1×10\textsuperscript{7} = 2.0×10\textsuperscript{-3}(较大会溶解)。AgI 不溶：K = Ksp·Kf = 8.5×10\textsuperscript{-17} × 1.1×10\textsuperscript{7} = 9.4×10\textsuperscript{-10}(极小不溶)。

\begin{enumerate}
\def\labelenumi{(\alph{enumi})}
\setcounter{enumi}{1}
\item
  HgS 极难溶(Ksp ≈ 10\textsuperscript{-52})，浓 HNO\textsubscript{3} 和王水无法提供足够的驱动力。但 Na\textsubscript{2}S 溶液中 S\textsuperscript{2-} 浓度高，与 Hg\textsuperscript{2+} 形成更稳定的 {[}HgS\textsubscript{2}{]}\textsuperscript{2-} 配离子，使溶解平衡右移。
\item
