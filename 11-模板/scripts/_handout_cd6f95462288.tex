...
\textbf{16.} CaCO\textsubscript{3}：\(T_{转}\) \约等于 1106 K；MgCO\textsubscript{3}：\(T_{转}\) \约等于 577 K。MgCO\textsubscript{3} 更易分解，因为 MgO 晶格能更大(Mg\textsuperscript{2+} 半径更小)。
