...
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-2a-line-lattice.jpg}
\caption{(a) 一维直线点阵—等间距重复的几何点}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-2b-plane-lattice.jpg}
\caption{(b) 二维平面点阵—平面上周期排列的点}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/spatial-lattice.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-3-simple-cubic.jpg}
\caption{(a) 简单立方(P)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-3-body-centered-cubic.jpg}
\caption{(b) 体心立方(I)}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-3-face-centered-cubic.jpg}
\caption{(c) 面心立方(F)}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/weller-12-2-caf2-fluorite.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/tio2-rutile-structure.png}
\caption{金红石型TiO结构—Ti(青色)位于四方晶胞顶点和体心，O(橙色)形成八面体配位}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/wurtzite-structure.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/octahedral-coordination-radius-ratio.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/puha-13-12-octahedral-coordination.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{media/diamond-structure.jpg}
