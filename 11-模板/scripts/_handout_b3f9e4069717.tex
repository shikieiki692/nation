...
\bottomrule\noalign{}
\endlastfoot
\textbf{负极(阳极)} & 氧化反应，释放电子 & Zn(s) \箭 Zn\textsuperscript{2+}(aq) + 2e\textsuperscript{-} \\
\textbf{正极(阴极)} & 还原反应，接收电子 & Cu\textsuperscript{2+}(aq) + 2e\textsuperscript{-} \箭 Cu(s) \\
\textbf{外电路} & 电子传输路径 & 导线 \\
...
\bottomrule\noalign{}
\endlastfoot
\textbf{金属-金属离子} & Cu/Cu\textsuperscript{2+} & Cu\textsuperscript{2+} + 2e\textsuperscript{-} \衡 Cu(s) & Cu(s) \textbar{} Cu\textsuperscript{2+}(aq) \\
\textbf{气体电极} & H\textsubscript{2}/H\textsuperscript{+} & 2H\textsuperscript{+} + 2e\textsuperscript{-} \衡 H\textsubscript{2}(g) & Pt(s) \textbar{} H\textsubscript{2}(g) \textbar{} H\textsuperscript{+}(aq) \\
\textbf{难溶盐电极} & AgCl/Ag & AgCl(s) + e\textsuperscript{-} \衡 Ag(s) + Cl\textsuperscript{-} & Ag(s) \textbar{} AgCl(s) \textbar{} Cl\textsuperscript{-}(aq) \\
\textbf{氧化还原电极} & Fe\textsuperscript{3+}/Fe\textsuperscript{2+} & Fe\textsuperscript{3+} + e\textsuperscript{-} \衡 Fe\textsuperscript{2+} & Pt(s) \textbar{} Fe\textsuperscript{2+}(aq), Fe\textsuperscript{3+}(aq) \\
\end{longtable}
}
...
\begin{quote}
\textbf{易错点}：\(E^{\circ}\) 是强度量，不能像 ΔH 那样乘以系数。即 \(E^\theta\) 不随半反应乘以 2 而加倍。这是因为 \(E^{\circ}\) 对应的是每个电子的能量，而不是整个反应的能量。
\end{quote}
...
\begin{quote}
\textbf{与 Q-K 框架的对应}：Nernst 方程中的 Q 与化学平衡中的 Q 形式完全相同。当 Q = \(K^{\circ}\) 时 E\_cell = 0(平衡)；当 Q \textless{} \(K^{\circ}\) 时 E\_cell \textgreater{} 0(正向自发)。

\textbf{版本差异}：不同教材的 Nernst 方程系数不同(如 0.0591 vs 0.0651)，这不是印刷错误，而是温度不同！普化默认 298 K(0.05916)，生化默认 310 K(人体温度，0.0651)。
\end{quote}
...
pH 增大({[}H\textsuperscript{+}{]} 减小)\箭 E 显著降低 \箭 KMnO\textsubscript{4} 氧化能力减弱。
...
\begin{quote}
\textbf{本质}：沉淀使 {[}Ag\textsuperscript{+}{]} 降低 \箭 Nernst 方程预测 E 降低 \箭 Ag 的还原能力减弱。
\end{quote}

\textbf{(4) 配合物对电极电势的影响}

配合物形成使游离金属离子浓度降低 \箭 E 降低。例如 {[}Cu(NH\textsubscript{3})\textsubscript{4}{]}\textsuperscript{2+}/Cu 的 \(E^{\circ}\) = −0.05 V(远低于 Cu\textsuperscript{2+}/Cu 的 +0.34 V)。
...
\subsection{\texorpdfstring{五、\(\Delta \1^{\circ}\) = −nF\(\1^{\circ}\) 与 \(\Delta \1^{\circ}\) = −RT ln \(K^{\circ}\) 的统一}{五、\textbackslash Delta \textbackslash1\^{}\{\textbackslash circ\} = −nF\textbackslash1\^{}\{\textbackslash circ\} 与 \textbackslash Delta \textbackslash1\^{}\{\textbackslash circ\} = −RT ln K\^{}\{\textbackslash circ\} 的统一}}\label{ux4e94delta-1circ-nf1circ-ux4e0e-delta-1circ-rt-ln-kcirc-ux7684ux7edfux4e00}
...
\begin{quote}
\(K^{\circ}\) 极大，说明 Zn + Cu\textsuperscript{2+} \箭 Zn\textsuperscript{2+} + Cu 几乎完全进行。
\end{quote}
...
Ag\textsuperscript{+}/Ag：Ag\textsuperscript{+} + e\textsuperscript{-} \箭 Ag(s)，\(E^{\circ}\) = +0.799 V
AgCl/Ag：AgCl(s) + e\textsuperscript{-} \箭 Ag(s) + Cl\textsuperscript{-}，\(E^{\circ}\) = +0.222 V

两式相减：AgCl(s) \箭 Ag\textsuperscript{+}(aq) + Cl\textsuperscript{-}
...
\begin{quote}
\textbf{不能简单平均}---必须用电子数加权平均。这是因为 \(E^{\circ}\) 是强度量，而 \(\Delta \1^{\circ}\) 是广度量(\(\Delta \1^{\circ}\) = −nF\(\1^{\circ}\))，叠加时必须按 \(\Delta \1^{\circ}\) 叠加。
\end{quote}
...
Cu\textsuperscript{+} 的歧化：2Cu\textsuperscript{+} \箭 Cu\textsuperscript{2+} + Cu
...
\bottomrule\noalign{}
\endlastfoot
\textbf{吸氢腐蚀} & H\textsuperscript{+} & 强酸性 & Fe + 2H\textsuperscript{+} \箭 Fe\textsuperscript{2+} + H\textsubscript{2}\上箭 \\
\textbf{耗氧腐蚀} & O\textsubscript{2} & 中性/弱酸性 & 2Fe + O\textsubscript{2} + 2H\textsubscript{2}O \箭 2Fe(OH)\textsubscript{2} \\
\end{longtable}
}
...
负极：Pb(s) + SO\textsubscript{4}\textsuperscript{2-}(aq) \箭 PbSO\textsubscript{4}(s) + 2e\textsuperscript{-}，\(E^{\circ}\) = −0.356 V
正极：PbO\textsubscript{2}(s) + 4H\textsuperscript{+}(aq) + SO\textsubscript{4}\textsuperscript{2-}(aq) + 2e\textsuperscript{-} \箭 PbSO\textsubscript{4}(s) + 2H\textsubscript{2}O(l)，\(E^{\circ}\) = +1.685 V
...
\begin{quote}
\textbf{\(K^{\circ}\) 极大}，反应几乎完全进行到底。放电时 H\textsubscript{2}SO\textsubscript{4} 浓度降低，由 Nernst 方程可知 {[}H\textsuperscript{+}{]}\下箭 \箭 E 正极\下箭 \箭 E\_cell\下箭，这就是铅蓄电池放电时电压缓慢下降的原因。
\end{quote}
...
负极：H\textsubscript{2} + 2OH\textsuperscript{-} \箭 2H\textsubscript{2}O + 2e\textsuperscript{-}
正极：O\textsubscript{2} + 2H\textsubscript{2}O + 4e\textsuperscript{-} \箭 4OH\textsuperscript{-}
总反应：2H\textsubscript{2} + O\textsubscript{2} \箭 2H\textsubscript{2}O
...
\textbf{题干}：写出以下电池的电极反应和电池反应，计算 \(E^{\circ}\) 和 Δ\_r\(\1^{\circ}\)：
...
负极(氧化)：Zn(s) \箭 Zn\textsuperscript{2+}(aq) + 2e\textsuperscript{-}，\(E^{\circ}\) = −0.763 V
正极(还原)：2H\textsuperscript{+}(aq) + 2e\textsuperscript{-} \箭 H\textsubscript{2}(g)，\(E^{\circ}\) = 0.000 V
...
\textbf{题干}：298 K 时已知：
- Ag\textsuperscript{+} + e\textsuperscript{-} \衡 Ag(s)，\(E^{\circ}\) = +0.799 V
- Fe\textsuperscript{3+} + e\textsuperscript{-} \衡 Fe\textsuperscript{2+}，\(E^{\circ}\) = +0.771 V

\begin{enumerate}
\def\labelenumi{(\alph{enumi})}
\tightlist
\item
  判断 Ag + Fe\textsuperscript{3+} \箭 Ag\textsuperscript{+} + Fe\textsuperscript{2+} 是否自发。
\item
...
\tightlist
\item
  Cu\textsuperscript{2+} + 2e\textsuperscript{-} \箭 Cu：n\textsubscript{1} = 1, E\textsubscript{1} = 0.159 V；n\textsubscript{2} = 1, E\textsubscript{2} = 0.520 V
\end{enumerate}
...
\textbf{题干}：铅蓄电池反应：Pb(s) + PbO\textsubscript{2}(s) + 2H\textsubscript{2}SO\textsubscript{4}(aq) \衡 2PbSO\textsubscript{4}(s) + 2H\textsubscript{2}O(l)
...
\item
  ...
  Δ\_r\(\1^{\circ}\) = −2 × 96485 × 2.041 = −393,700 J/mol \约等于 −394 kJ/mol
\item
  lg \(K^{\circ}\) = 2×2.041/0.05916 = 69.0 \箭 \(K^{\circ}\) \约等于 10\textsuperscript{69。\$K}\{\circ\}\$ 极大，反应几乎完全进行到底。由于 \(K^{\circ}\) 极大，在正常放电范围内 H\textsubscript{2}SO\textsubscript{4} 浓度变化相对较小，电压基本恒定。
\item
  放电消耗 H\textsubscript{2}SO\textsubscript{4}，{[}H\textsuperscript{+}{]} 降低。正极反应：PbO\textsubscript{2} + 4H\textsuperscript{+} + SO\textsubscript{4}\textsuperscript{2-} + 2e\textsuperscript{-} \箭 PbSO\textsubscript{4} + 2H\textsubscript{2}O
  由 Nernst 方程，{[}H\textsuperscript{+}{]}\下箭 \箭 E 正极\下箭 \箭 E\_cell\下箭。
\end{enumerate}
...
pH 影响 & H\textsuperscript{+} 出现在 Q 中 & pH\上箭 \箭 E\下箭(对含 H\textsuperscript{+} 的半反应) \\
...
\textbf{7.} 用 \(\Delta \1^{\circ}\) = −nF\(\1^{\circ}\) 计算第 6 题反应的 Δ\_r\(\1^{\circ}\)。
...
\textbf{13.} \textbf{(\(\Delta \1^{\circ}\) − \(E^{\circ}\) − \(K^{\circ}\) 三角)} 某氧化还原反应的 \(E^{\circ}\)\_cell = 0.30 V，n = 2。分别计算 Δ\_r\(\1^{\circ}\) 和 \(K^{\circ}\)(298 K)。
...
\item
  计算 Fe + 2Fe\textsuperscript{3+} \箭 3Fe\textsuperscript{2+} 的 \(E^{\circ}\)\_cell 和 \(K^{\circ}\)。
\end{enumerate}
...
并用此公式从 Δ\_f\(\1^{\circ}\) 数据计算 \(E^{\circ}\)(Cu\textsuperscript{2+}/Cu)。
...
\textbf{1.}
负极：Zn(s) \箭 Zn\textsuperscript{2+}(aq) + 2e\textsuperscript{-}
正极：Cu\textsuperscript{2+}(aq) + 2e\textsuperscript{-} \箭 Cu(s)
电池反应：Zn(s) + Cu\textsuperscript{2+}(aq) \箭 Zn\textsuperscript{2+}(aq) + Cu(s)
...
\textbf{7.} Δ\_r\(\1^{\circ}\) = −nF\(\1^{\circ}\) = −2 × 96485 × 0.46 = −88,767 J/mol \约等于 −88.8 kJ/mol
...
\textbf{10.} lg \(K^{\circ}\) = n\(\1^{\circ}\)/0.05916 = 1×0.50/0.05916 = 8.45。\(K^{\circ}\) = 10\^{}8.45 \约等于 2.8 × 10\textsuperscript{8}。
...
\textbf{13.} Δ\_r\(\1^{\circ}\) = −2 × 96485 × 0.30 = −57,891 J/mol \约等于 −57.9 kJ/mol
\(K^{\circ}\) = e\^{}(2×96485×0.30/(8.314×298)) = e\^{}23.4 \约等于 1.4 × 10\textsuperscript{10}
...
当两侧浓度趋近时，Q \箭 1，lg Q \箭 0，E\_cell \箭 0。浓差电池的驱动力就是浓度梯度。

\textbf{18.}
(a) 电池反应：2Fe(s) + O\textsubscript{2}(g) + 4H\textsuperscript{+}(aq) \箭 2Fe\textsuperscript{2+}(aq) + 2H\textsubscript{2}O(l)
(b) \(E^{\circ}\)\_cell = 1.23 − (−0.44) = +1.67 V
Δ\_r\(\1^{\circ}\) = −4 × 96485 × 1.67 = −644,390 J/mol \约等于 −644 kJ/mol
...
MnO\textsubscript{4}\textsuperscript{-} + 8H\textsuperscript{+} + 5e\textsuperscript{-} \箭 Mn\textsuperscript{2+} + 4H\textsubscript{2}O \ldots{} E\textsubscript{1} = +1.51 V, n\textsubscript{1} = 5
MnO\textsubscript{4}\textsuperscript{-} + 2H\textsubscript{2}O + 3e\textsuperscript{-} \箭 MnO\textsubscript{2} + 4OH\textsuperscript{-} \ldots{} E\textsubscript{2} = +0.59 V, n\textsubscript{2} = 3

先将(2)在碱性条件下转化为酸性：MnO\textsubscript{4}\textsuperscript{-} + 4H\textsuperscript{+} + 3e\textsuperscript{-} \箭 MnO\textsubscript{2} + 2H\textsubscript{2}O，E\textsubscript{2} = ?
...
简化处理：目标反应 = (1) − (2) 适当调整。
MnO\textsubscript{2} + 4H\textsuperscript{+} + 2e\textsuperscript{-} \箭 Mn\textsuperscript{2+} + 2H\textsubscript{2}O
...
实际上在酸性条件下：MnO\textsubscript{4}\textsuperscript{-} + 4H\textsuperscript{+} + 3e\textsuperscript{-} \箭 MnO\textsubscript{2} + 2H\textsubscript{2}O，\(E^{\circ}\) = +1.70 V(文献值)
...
\setcounter{enumi}{1}
\item
  MnO\textsubscript{2} 在碱中歧化：2MnO\textsubscript{2} + 2OH\textsuperscript{-} \箭 MnO\textsubscript{4}\textsuperscript{-} + MnO\textsubscript{2}\textsuperscript{2-} + H\textsubscript{2}O(不常见)
...
(b) Δ\_r\(\1^{\circ}\) = −2 × 96485 × 2.041 = −393,700 J/mol \约等于 −394 kJ/mol
(c) lg \(K^{\circ}\) = 2×2.041/0.05916 = 69.0 \箭 \(K^{\circ}\) \约等于 10\textsuperscript{69。\$K}\{\circ\}\$ 极大，反应几乎完全进行到底。
(d) 放电消耗 H\textsubscript{2}SO\textsubscript{4}，{[}H\textsuperscript{+}{]} 降低。由 Nernst 方程，H\textsuperscript{+} 出现在正极反应(PbO\textsubscript{2} + 4H\textsuperscript{+} + SO\textsubscript{4}\textsuperscript{2-} + 2e\textsuperscript{-} \箭 PbSO\textsubscript{4} + 2H\textsubscript{2}O)中，{[}H\textsuperscript{+}{]}\下箭 \箭 E 正极\下箭 \箭 E\_cell\下箭。
...
\textbf{23.}
(a) Cu\textsubscript{2}O + 2H\textsuperscript{+} \箭 Cu + Cu\textsuperscript{2+} + H\textsubscript{2}O
E\_cell = \(E^{\circ}\)(Cu\textsuperscript{2+}/Cu\textsubscript{2}O) − \(E^{\circ}\)(Cu\textsuperscript{+}/Cu\textsubscript{2}O)

由 Cu\textsubscript{2}O/Cu: Cu\textsubscript{2}O + 2H\textsuperscript{+} + 2e\textsuperscript{-} \箭 2Cu + H\textsubscript{2}O，E = −0.36 V(已知)
由 Cu\textsubscript{2}O/Cu\textsuperscript{2+}: Cu\textsubscript{2}O + 2H\textsuperscript{+} \箭 2Cu\textsuperscript{2+} + H\textsubscript{2}O + 2e\textsuperscript{-}(逆向)

需要用 Cu\textsuperscript{2+}/Cu\textsubscript{2}O 和 Cu\textsuperscript{+}/Cu\textsubscript{2}O 的数据。Cu\textsubscript{2}O 歧化的 \(E^{\circ}\)\_cell \约等于 +0.46 V(文献值)。

\begin{enumerate}
\def\labelenumi{(\alph{enumi})}
\setcounter{enumi}{1}
\item
  Cu\textsubscript{2}O 溶解：Cu\textsubscript{2}O + H\textsubscript{2}O \衡 2Cu\textsuperscript{+} + 2OH\textsuperscript{-}
...
\textbf{24.} 对半反应 Ox + ne\textsuperscript{-} \箭 Red：
由热力学：Δ\_r\(\1^{\circ}\) = Δ\_f\(\1^{\circ}\)(Red) − Δ\_f\(\1^{\circ}\)(Ox)(标准反应的生成焓差)
又 Δ\_r\(\1^{\circ}\) = −nFE°

\[E^\theta = \frac{\Delta_f G^\theta(\mathrm{Ox}) - \Delta_f G^\theta(\mathrm{Red})}{nF}\]

注意符号：Δ\_r\(\1^{\circ}\) = −nF\(\1^{\circ}\)，所以 \(E^{\circ}\) = −Δ\_r\(\1^{\circ}\)/(nF) = {[}Δ\_f\(\1^{\circ}\)(Ox) − Δ\_f\(\1^{\circ}\)(Red){]}/(nF)

对 Cu\textsuperscript{2+} + 2e\textsuperscript{-} \箭 Cu：Δ\_f\(\1^{\circ}\)(Cu) = 0，Δ\_f\(\1^{\circ}\)(Cu\textsuperscript{2+}) = +64.98 kJ/mol
