...
\thispagestyle{plain}
\begin{center}
{\zihao{2}\bfseries 分子结构基础\par}
\end{center}
\vspace{1em}
\section{分子结构基础}\label{ux5206ux5b50ux7ed3ux6784ux57faux7840}
...
\includegraphics[width=0.55\textwidth,keepaspectratio]{13-6-bond-type-transition-triangle-ionic-covalent-metallic.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{covalent-ionic-bonds-wikipedia.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.58\textwidth,keepaspectratio]{11-25-electronegativity-periodic-trend.jpg}
\caption{电负性的周期表递变趋势}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{h2-energy-curve.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{sigma-pi-bond-formation.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{12-21-vsepr-ax5-ax6-molecular-geometries.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.32\textwidth,height=0.24\textheight,keepaspectratio]{12-7c-hybrid-orbital-formation-ch4-sp3.jpg}
\hspace{0.015\textwidth}
\includegraphics[width=0.32\textwidth,height=0.24\textheight,keepaspectratio]{12-7a-hybrid-orbital-formation-sp-sp2-sp3.jpg}
\hspace{0.015\textwidth}
\includegraphics[width=0.32\textwidth,height=0.24\textheight,keepaspectratio]{12-7b-hybrid-orbital-formation-bcl3-sp2.jpg}
\caption{sp、sp、sp 杂化示意}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{12-8-ch4-nh3-h2o-bond-angle-comparison-sp3.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{mo-energy-diagram.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth,keepaspectratio]{o2-mo-diagram.jpg}
\caption{O 的分子轨道能级图}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.48\textwidth,height=0.32\textheight,keepaspectratio]{12-26-orientation-induction-intermolecular-forces.jpg}
\hspace{0.015\textwidth}
\includegraphics[width=0.48\textwidth,height=0.32\textheight,keepaspectratio]{12-27-dispersion-force-nonpolar-molecules.jpg}
...
\begin{quote}
\textbf{使用建议}：🌱 基础巩固覆盖 §二 Lewis 到 §八 分子间力的核心概念；🔥 竞赛入门需要综合运用 MO 理论和多种结构工具；🏆 真题挑战训练竞赛级结构推断与分析。
\end{quote}
...
\begin{quote}
\textbf{编号说明}：练习题编号已更新(新增 §一 化学键基础 4 题)，原第 3-10 题\箭现第 5-12 题，原第 11-19 题\箭现第 15-23 题，原第 20-24 题\箭现第 24-28 题。下方答案按新编号排列。
\end{quote}
