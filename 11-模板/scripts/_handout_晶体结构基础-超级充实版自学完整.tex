...
\includegraphics[width=0.9\textwidth,keepaspectratio]{spatial-lattice.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-3a-bravais-lattice-primitive-body-face-centered.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{金属晶体A1A2A3对比.并列对比.png}
\caption{图12 金属晶体A1/A2/A3并列对比 — 三种基本堆积方式（fcc/bcc/hcp）的参数与实例一览}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{close-packed-layer.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-7-10-four-unit-cell-types-sc-bcc-fcc.png}
\caption{图6 四种晶胞对比 — 简单立方（左上）、体心立方（右上）、面心立方（右下）及原子接触方向}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-7-10-unit-cell-types-sc-bcc-fcc-comparison.png}
\caption{图7 晶胞参数与原子半径关系对比图 — 从左至右：sc（棱边=2r）、bcc（体对角线=4r）、fcc（面对角线=4r）}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{ccp-unit-cell.png}
...
\begin{figure}[H]\centering
\textbf{[⛔ 缺图: tetrahedral_octahedral_voids]}
\caption{图14 四面体空隙与八面体空隙的位置标注 — 空隙类型对比、计数公式与fcc应用实例}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-8a-close-packed-bilayer-tetrahedral-octahedral-voids.png}
\caption{图9 密置双层中的空隙 —— 从双层俯视可见四面体空隙（T）和八面体空隙（O）的位置分布}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-8b-tetrahedral-void-structure.png}
\caption{图10 正四面体空隙（左）与正八面体空隙（右）—— 四面体空隙由4个等径球围成，八面体空隙由6个等径球围成}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{ccp-stacking.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-11-three-ab-ionic-crystal-structures-nacl-cscl-zns.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{晶体结构-NaCl-CsCl-ZnS对比.关系图.png}
\caption{图12 三种AB型离子晶体结构对比 — 从左至右：NaCl型（6:6）、CsCl型（8:8）、ZnS型（4:4）}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{nacl_crystal_structure.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{cscl_crystal_structure.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{zns_crystal_structure.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{octahedral-coordination-radius-ratio.png}
...
\begin{figure}[H]\centering
\textbf{[⛔ 缺图: radius_ratio_decision]}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-12-octahedral-coordination.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-17-ion-polarization-ideal-vs-polarized.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{diamond-structure.png}
\caption{图20 金刚石晶体结构（左）及其晶胞（右）— 每个C原子sp3杂化，四面体配位。金刚石是典型的原子晶体（共价晶体）}
\end{figure}

\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{13-14-co2-molecular-crystal-unit-cell.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.9\textwidth,keepaspectratio]{graphite-structure.png}
