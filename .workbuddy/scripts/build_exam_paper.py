...
PAPERS = [
    ...
    (QB / "省预赛专项卷I.md", "省预赛专项卷I"),
    (QB / "综合模拟卷VII.md", "综合模拟卷VII"),
    (QB / "一分册专项卷I.md", "一分册专项卷I"),
    (QB / "二分册专项卷I.md", "二分册专项卷I"),
    (QB / "一分册专项卷II.md", "一分册专项卷II"),
    (QB / "二分册专项卷II.md", "二分册专项卷II"),
    (QB / "一分册专项卷III.md", "一分册专项卷III"),
    (QB / "二分册专项卷III.md", "二分册专项卷III"),
    (QB / "一分册专项卷IV.md", "一分册专项卷IV"),
    (QB / "二分册专项卷IV.md", "二分册专项卷IV"),
    (QB / "一分册专项卷V.md", "一分册专项卷V"),
    (QB / "二分册专项卷V.md", "二分册专项卷V"),
    (QB / "一分册专项卷VI.md", "一分册专项卷VI"),
    (QB / "二分册专项卷VI.md", "二分册专项卷VI"),
    (QB / "一分册专项卷VII.md", "一分册专项卷VII"),
    (QB / "二分册专项卷VII.md", "二分册专项卷VII"),
    (QB / "一分册专项卷VIII.md", "一分册专项卷VIII"),
    (QB / "二分册专项卷VIII.md", "二分册专项卷VIII"),
    (QB / "一分册专项卷IX.md", "一分册专项卷IX"),
    (QB / "二分册专项卷IX.md", "二分册专项卷IX"),
    (QB / "一分册专项卷XII.md", "一分册专项卷XII"),
    (QB / "二分册专项卷XII.md", "二分册专项卷XII"),
    (QB / "第二轮习题集-化学原理I.md", "第二轮习题集-化学原理I"),
    (QB / "预赛基础卷I.md", "预赛基础卷I"),
    (QB / "第二轮习题集-化学原理II.md", "第二轮习题集-化学原理II"),
    (QB / "第二轮习题集-结构化学一.md", "第二轮习题集-结构化学一"),
    (QB / "第二轮习题集-结构化学二.md", "第二轮习题集-结构化学二"),
    (QB / "第二轮习题集-有机化学一.md", "第二轮习题集-有机化学一"),
    (QB / "第二轮习题集-有机化学二.md", "第二轮习题集-有机化学二"),
    (QB / "第二轮习题集-元素与分析一.md", "第二轮习题集-元素与分析一"),
    (QB / "第二轮习题集-元素与分析二.md", "第二轮习题集-元素与分析二"),
    (QB / "预赛基础卷II.md", "预赛基础卷II"),
    (QB / "预赛基础卷III.md", "预赛基础卷III"),
    (QB / "一分册专项卷X.md", "一分册专项卷X"),
    (QB / "二分册专项卷X.md", "二分册专项卷X"),
    (QB / "一分册专项卷XI.md", "一分册专项卷XI"),
    (QB / "二分册专项卷XI.md", "二分册专项卷XI"),
