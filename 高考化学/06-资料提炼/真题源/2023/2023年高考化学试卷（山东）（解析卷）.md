...
$$
\begin{array}{l l}&\mathrm{HCOOH} \rightleftharpoons \mathrm{CO} + \mathrm{H} _ {2} \mathrm{O}\\\mathrm{t} _ {1} \text {时刻转化浓度(mol} \bullet \mathrm{L} ^ {- 1})&0.70\\&0.70\end{array}
$$

$$
\begin{array}{l l}&\mathrm{HCOOH} \rightleftharpoons \mathrm{CO} _ {2} + \mathrm{H} _ {2}\\\mathrm{t} _ {1} \text {时刻转化浓度(mol} \bullet \mathrm{L} ^ {- 1})&0.16 \quad 0.16 \quad 0.16\end{array}
$$
...
$$
\text { 则 } c \left(\mathrm{H} _ {2}\right) = \mathrm{b} + 0.16 = \mathrm{y}, \quad \mathrm{b} = (\mathrm{y} - 0.16) \mathrm{mol} \cdot \mathrm{L} ^ {- 1}, \quad c (\mathrm{HCOOH}) = 0.14 - \mathrm{a} - \mathrm{b} = 0.3 - \mathrm{a} - \mathrm{y}, \quad c (\mathrm{CO}) = \mathrm{a} + 0.7, \quad \mathrm{K} (\mathrm{I}) =
$$
