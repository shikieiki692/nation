...
|  | c(KI) | 实验现象 |
| --- | --- | --- |
| 实验I | $0.01\mathrm{mol}·\mathrm{L}^{-1}$ | 极少量 $I_2$ 溶解,溶液为淡红色;充分反应后,红色的铜粉转化为白色沉淀,溶液仍为淡红色 |
| 实验II | $0.1\mathrm{mol}·\mathrm{L}^{-1}$ | 部分 $I_2$ 溶解,溶液为红棕色;充分反应后,红色的铜粉转化为白色沉淀,溶液仍为红棕色 |
| 实验III | $4\mathrm{mol}·\mathrm{L}^{-1}$ | $I_2$ 完全溶解,溶液为深红棕色;充分反应后,红色的铜粉完全溶解,溶液为深红棕色 |
