...
$$
\mathrm{C} _ {3} \mathrm{H} _ {8} (\mathrm{g}) = \mathrm{C} _ {3} \mathrm{H} _ {6} (\mathrm{g}) + \mathrm{H} _ {2} (\mathrm{g}) \quad \Delta \mathrm{H} _ {1} = + 124 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} \quad \Delta \mathrm{S} _ {1} = 127 \mathrm{J} \cdot \mathrm{K} ^ {- 1} \cdot \mathrm{mol} ^ {- 1} \quad \mathrm{K} _ {\mathrm{p} 1}
$$

$$
\mathrm{C} _ {3} \mathrm{H} _ {8} (\mathrm{g}) = \mathrm{C} _ {2} \mathrm{H} _ {4} (\mathrm{g}) + \mathrm{CH} _ {4} (\mathrm{g}) \quad \Delta \mathrm{H} _ {2} = + 82 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} \quad \Delta \mathrm{S} _ {2} = 135 \mathrm{J} \cdot \mathrm{K} ^ {- 1} \cdot \mathrm{mol} ^ {- 1} \quad \mathrm{K} _ {\mathrm{p} 2}
$$

iii.

$$
\mathrm{C} _ {3} \mathrm{H} _ {8} (\mathrm{g}) + 2 \mathrm{H} _ {2} (\mathrm{g}) = 3 \mathrm{CH} _ {4} (\mathrm{g}) \quad \Delta \mathrm{H} _ {3} = - 120 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} \quad \Delta \mathrm{S} _ {3} = 27.5 \mathrm{J} \cdot \mathrm{K} ^ {- 1} \cdot \mathrm{mol} ^ {- 1} \quad \mathrm{K} _ {\mathrm{p} 3}
$$
...
$$
\delta (\mathrm{HA} ^ {-}) = 0.70
$$

$$
\delta (\mathrm{H} _ {2} \mathrm{A}) = \delta (\mathrm{A} ^ {2 -}) = 0.15
$$

$$
\mathrm{K} _ {\mathrm{a} 2} = \frac {\mathrm{c} (\mathrm{A} ^ {2 -}) \mathrm{c} (\mathrm{H} ^ {+})}{\mathrm{c} (\mathrm{HA} ^ {-})} = 10 ^ {- 4.37}, \quad \mathrm{c} (\mathrm{H} ^ {+}) = \frac {0.70}{0.15} \times 10 ^ {- 4.37}, \quad \mathrm{pH} \neq 4.37
$$
...
$$
\mathrm{iv.} \quad \mathrm {CH_ {3} OH(g) = CO(g) + 2 H _ {2} (g)} \quad \Delta \mathrm {H_ {4}} = + 91 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1}
$$
