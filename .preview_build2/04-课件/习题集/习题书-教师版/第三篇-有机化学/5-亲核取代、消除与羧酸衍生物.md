...
$$\ce{PhCO-COPh ->[\ce{OH-}] Ph2C(OH)COO-}$$

二苯基乙二酮是对称 α-二酮，OH⁻ 从任一羰基进攻等价。碱性条件先得羧酸盐 $\ce{Ph2C(OH)COO-}$，酸化后得到游离二苯乙醇酸 $\ce{Ph2C(OH)COOH}$。

### 步骤 1：OH⁻ 亲核加成

$$\ce{PhCO-COPh + OH- -> PhC(OH)(O-)COPh}$$
...
$$\ce{PhC(OH)(O-)COPh -> Ph2C(O-)COO-.. }$$

净结果：苯基完成 1,2-迁移，中心碳由酮碳变为 α-烷氧基羧酸根负离子，此时已具备羧酸盐结构。

### 步骤 3：质子转移

$$\ce{Ph2C(O-)COO- + H2O -> Ph2C(OH)COO- + OH-}$$
...
- 酸性后处理：$\ce{Ph2C(OH)COO- + H+ -> Ph2C(OH)COOH}$。
