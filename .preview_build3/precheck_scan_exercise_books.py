...
ROOTS = [
    Path(r"C:\Obsidion\妙妙屋\.preview_build3\04-课件\习题集\习题书-教师版"),
    Path(r"C:\Obsidion\妙妙屋\.preview_build3\04-课件\习题集\习题书-学生版"),
]
REPORT = Path(r"C:\Obsidion\妙妙屋\.preview_build3\precheck-report-2026-08-30.txt")
