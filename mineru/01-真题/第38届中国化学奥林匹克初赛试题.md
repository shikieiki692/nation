...
5) 可能用到的常数：法拉第常数 $F=9.6485\times10^{4}\ \mathrm{C}\ \mathrm{mol}^{-1}$ ；气体常数 $R=8.3145\ \mathrm{J}\ \mathrm{K}^{-1}\ \mathrm{mol}^{-1}$
...
| F(pN) | 13.6 | 14.0 | 14.5 | 15.0 |
| --- | --- | --- | --- | --- |
| K° | 0.01832 | 0.2231 | 5.474 | 66.69 |
...
5-4 具有独特光电效应的 $WSe_{2}$ 为层状的二维范德华晶体，具有简单六方结构，晶胞参数 $a = 3.282 \, \text{Å}, c = 12.96 \, \text{Å}$ 。晶体结构如右图所示，其中 Se 的分数坐标分别为 z = 0.1211 和 0.5 - z，W 的分数坐标为 z = 0.25。
