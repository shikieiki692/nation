...
$$
\mathrm{S} _ {8} + 8 \mathrm{I} _ {2} + 12 \mathrm{AsF} _ {5} \longrightarrow 4 \left[ \begin{array}{c c} \mathrm{I} & \mathrm{S} - \mathrm{I} \\ \mathrm{I} & \mathrm{S} - \mathrm{I} \end{array} \right] ^ {2 +} \left[ \begin{array}{c c} \mathrm{F}, & \mathrm{F} \\ \mathrm{F} & \mathrm{As} \\ \mathrm{F} & \mathrm{F} \end{array} \right] _ {2} ^ {-} + 4 \mathrm{AsF} _ {3}
$$
...
$$
\mathrm{Na} _ {2} \mathrm{B} _ {4} \mathrm{O} _ {7} \cdot 10 \mathrm{H} _ {2} \mathrm{O} + 14 \mathrm{HF} \longrightarrow 4 \mathrm{BF} _ {3} + 2 \mathrm{NaF} + 17 \mathrm{H} _ {2} \mathrm{O} 。
$$
...
$$
3 \mathrm{Fe} (\mathrm{CO}) _ {5} + 4 \mathrm{NaOH} \longrightarrow \mathrm{Na} _ {2} \left[ \mathrm{Fe} _ {3} (\mathrm{CO}) _ {11} \right] + \mathrm{Na} _ {2} \mathrm{CO} _ {3} + 2 \mathrm{H} _ {2} \mathrm{O} + 3 \mathrm{CO},
$$
...
$$
\mathrm{R} _ {2} (\mathrm{CO}) \mathrm{R} _ {3} + \mathrm{NaMn} (\mathrm{CO}) _ {5} \longrightarrow \mathrm{ReMn} (\mathrm{CO}) _ {10} + \mathrm{NaBr},
$$
...
| 1-0.2244/n | A的相对原子质量 | 0.2244/n | A的相对原子质量 |
| --- | --- | --- | --- |
| 1 | 5.5 | 1 | 65.7 |
| 2 | 11.0 | 2 | 131 |
| 3 | 16.5 | 3 | 197 |
...
$$
12 \mathrm{NaOH} + 4 \mathrm{MnO} _ {2} + \mathrm{O} _ {2} \longrightarrow 4 \mathrm{Na} _ {3} \mathrm{MnO}
$$
...
7.28 $CuSO_{4} \cdot 3H_{2}O$ ，密度为 $2.75g/\mathrm{cm}^{3}$ ，Boothite 为七水硫酸铜，密度为 $1.966g/\mathrm{cm}^{3}$ 。
...
4. 密度为 $1.75 \, g/\mathrm{cm}^{3}$ 。

7.46 1. 如右图所示, 浅色为 Sm。提示: 比六方晶胞多一个不同的堆积周期。

2. 配位数为 6。

7.47 1. $l_{x}=0.192\mathrm{nm}, l_{z}=0.207\mathrm{nm}$ ，密度为 $6.88g/\mathrm{cm}^{3}$ 。
...
8.42 1. 至少 2 步。
消光系数可能是 $4.4 \times 10^{3} \mathrm{L} \cdot \mathrm{mol}^{-1} \cdot \mathrm{cm}^{-1}$ 或 $2.2 \times 10^{3} \mathrm{L} \cdot \mathrm{mol}^{-1} \cdot \mathrm{cm}^{-1}$ ，但速率常数 $k_{f}$ 和 $k_{g}$ 都只有一种可
...
9.37 碳酸钙溶度积取 $8.7 \times 10^{-9}$ ，碳酸两级电离常数分别取 6.37、10.32。溶解度分别为 $1.22 \times 10^{-4} \, \mathrm{mol}/\mathrm{L}$ 、0.027 mol/L。

9.38 氯化铅溶度积取 $1.7 \times 10^{-5}$ ，溶解度为 0.063 mol/L。提示：三级及以上累计稳定常数变小，忽略这些物种。

9.39 溴化银溶度积取 $5.4 \times 10^{-13}$ ，银氨二级稳定常数取 $1.6 \times 10^{7}$ ，溶解度为 $2.9 \times 10^{-4} \, \mathrm{mol}/\mathrm{L}$ 。
...
$$
\left[ \mathrm{Cr} (\mathrm{SCN}) _ {6} \right] ^ {3 -} + 24 \mathrm{I} _ {2} + 24 \mathrm{H} _ {2} \mathrm{O} \longrightarrow \mathrm{Cr} ^ {3 +} + 6 \mathrm{SO} _ {4} ^ {2 -} + 6 \mathrm{ICN} + 42 \mathrm{I} ^ {-} + 48 \mathrm{H} ^ {+},
$$
