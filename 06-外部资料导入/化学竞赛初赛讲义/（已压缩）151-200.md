...
| 样品 | $n(^{143}\text{Nd})/n(^{144}\text{Nd})$ | $n(^{147}\text{Sm})/n(^{144}\text{Nd})$ |
| --- | --- | --- |
...
| $S_m/[J·(\mathrm{mol}\cdot\mathrm{K})^{-1}]$ | 42.6 | 205.8 | 144 | 130.7 |
...
| $S_m/[J·(\mathrm{mol}\cdot\mathrm{K})^{-1}]$ | 195.2 | 269.9 | 205.0 | 213.7 | 70.0 | 188.7 |
...
| 物质 | HCl | NaCl | NaA |
| --- | --- | --- | --- |
| $A_{m}/[S \cdot (m \cdot \mathrm{mol})^{-1}]$ | 0.04262 | 0.01266 | 0.0086 |
...
| 波长/nm | 260 | 395 | 720 | 815 |
| --- | --- | --- | --- | --- |
| $Cu^{2+}$ | 0.6847 | 0.0110 | 0.9294 | 1.428 |
| $Ni^{2+}$ | 0.0597 | 0.6695 | 0.3000 | 0.1182 |
