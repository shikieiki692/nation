...
$$
2 M n O _ {4} ^ {-} + 10 C l ^ {-} + 16 H ^ {+} = 2 M n ^ {2 +} + 5 C l _ {2} \uparrow + 8 H _ {2} O
$$
...
$$
\begin{array}{l l}{\Delta H ^ {a}}&{k J \cdot m o l ^ {- 1}}\\{\mathrm{K} (s) \rightarrow k (g)}&{+ 89}\\{K (g) \rightarrow k ^ {+} (g)}&{+ 42}\end{array}
$$
...
$$
89 + 425 + \frac {244}{2} - 355 - \Delta H _ {\text { lattice }} = - 438
$$

■ $\Delta H_{lattice} = 719 \, \mathrm{kJ} / \mathrm{mol}$   
...
$$
148 + 2187 + 31 + 193 - 331 \times 2 - \Delta H _ {\text { lattice }} = - 524
$$

■ $\Delta H_{lattice} = 2421 \, \mathrm{kJ} / \mathrm{mol}$   
...
■ 计算结果： $r \approx 144.6\mathrm{pm}$ （保留三位有效数字）
