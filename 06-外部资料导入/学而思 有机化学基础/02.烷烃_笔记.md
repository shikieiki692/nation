...
| TABLE 1.4. Approximate ${\mathrm{pK}}_{\mathrm{a}}$ values for some organic acids |  |  |  |
| --- | --- | --- | --- |
| ${\mathrm{CCl}}_{2}{\mathrm{CO}}_{2}\mathrm{H}$ | 0 | EtOH | *17 |
| ${\mathrm{CH}}_{3}{\mathrm{CO}}_{2}\mathrm{H}$ | *4.7 | ${\mathrm{CH}}_{3}{\mathrm{CONH}}_{2}$ | 17 |
| pyrH+ | *5 | t-BuOH | 19 |
| ${\mathrm{PhNH}}_{3}^{ + }$ | 5 | ${\mathrm{CH}}_{3}{\mathrm{COCH}}_{3}$ | *20 |
| HC=N | 9 | ${\mathrm{CH}}_{3}{\mathrm{SO}}_{2}{\mathrm{CH}}_{3}$ | 23 |
| N=CCH ${}_{2}{\mathrm{CO}}_{2}\mathrm{Et}$ | 9 | HC=CH | *25 |
| ${\mathrm{Et}}_{3}{\mathrm{NH}}^{ + }$ | *10 | ${\mathrm{CH}}_{3}{\mathrm{CO}}_{2}\mathrm{Et}$ | *25 |
| PhOH | 10 | ${\mathrm{CH}}_{3}\mathrm{CN}$ | 26 |
| ${\mathrm{CH}}_{3}{\mathrm{NO}}_{2}$ | 10 | ${\mathrm{CH}}_{3}{\mathrm{SOCH}}_{3}$ | 31 |
| EtSH | 11 | ${\mathrm{NH}}_{3}$ | *35 |
| MeCOCH ${}_{2}{\mathrm{CO}}_{2}\mathrm{Et}$ | 11 | ${\mathrm{C}}_{6}{\mathrm{H}}_{6},{\widehat{\mathrm{H}}}_{2}\mathrm{C} = {\mathrm{CH}}_{2}$ | *37 |
| EtO ${}_{2}{\mathrm{CCH}}_{2}{\mathrm{CO}}_{2}\mathrm{Et}$ | *14 | ${\mathrm{CH}}_{3}\mathrm{CH} = {\mathrm{CH}}_{2}$ | 37 |
| HOH | *15 | alkanes | *40-44 |
| cyclopentadiene | *15 |  |  |
...
| Compound | pKROH | pKDMSO | Base | pKROH | pKDMSO |
| --- | --- | --- | --- | --- | --- |
| $\mathrm{C_{2}NCH_{2}NO_{2}}$ | 3.6 |  | $\mathrm{CH_{3}CO_{2}^{-}}$ | 4.2 | 11.6 |
| $\mathrm{CH_{3}COCH_{2}NO_{2}}$ | 5.1 |  |  |  |  |
| $\mathrm{CH_{3}CH_{3}NO_{3}}$ | 8.6 | 16.7 | $\mathrm{HCO_{2}^{-}}$ | 6.5 |  |
| $\mathrm{CH_{3}COCH_{2}COCH_{3}}$ | 9 |  |  |  |  |
| $\mathrm{PbCOCH_{2}COCH_{3}}$ | 9.6 |  | $\mathrm{PhO^{-}}$ | 9.9 | 16.4 |
| $\mathrm{CH_{3}NO_{2}}$ | 10.2 | 17.2 |  |  |  |
| $\mathrm{CH_{3}COCH_{2}CO_{2}C_{2}H_{5}}$ | 10.7 | 14.2 | $\mathrm{CO_{2}^{3-}}$ | 10.2 |  |
| $\mathrm{NCCCH_{3}CN}$ | 11.2 | 11.0 | $(\mathrm{C_{2}H_{5})_{2}N}$ | 10.7 |  |
| $\mathrm{PbCH_{3}NO_{2}}$ |  | 12.3 | $(\mathrm{CH_{3}CH_{3})_{2}NH}$ | 11 |  |
| $\mathrm{CH_{3}(SO_{4})CH_{3})_{2}}$ | 12.2 | 14.4 |  |  |  |
| $\mathrm{CH_{3}(CO_{2}C_{2}H_{5})_{2}}$ | 12.7 | 16.4 |  |  |  |
| Cyclopentadiene | 15 |  | $\mathrm{CH_{3}O^{-}}$ | 15.5 | 29.0 |
| $\mathrm{PS\&CH_{2}COCH_{3}}$ |  | 18.7 | $\mathrm{HO^{-}}$ | 15.7 | 31.4 |
| $\mathrm{CH_{3}CH_{3}CH(CO_{2}C_{2}H_{5})_{2}}$ | 15 |  | $\mathrm{C_{2}H_{5}O^{-}}$ | 15.9 | 29.8 |
| $\mathrm{PbSCCH_{3}CN}$ |  | 20.8 | $(\mathrm{CH_{3}CH_{2}CHO^{-}}$ |  | 30.3 |
| $(\mathrm{PbCH_{3})_{2}SO_{2}}$ |  | 23.9 | $(\mathrm{CH_{3}CH_{2}CO^{-}}$ | 19 | 32.2 |
| $\mathrm{PbCOCH_{3}}$ | 15.8 | 24.7 |  |  |  |
| $\mathrm{PbCH_{3}COCH_{3}}$ | 19.9 |  |  |  |  |
| $\mathrm{CH_{3}COCH_{3}}$ | 20 | 26.5 |  |  |  |
| $\mathrm{CH_{3}CH_{2}COCH_{2}CH_{3}}$ |  | 27.1 |  |  |  |
| Fluorene | 20.5 | 22.6 |  |  |  |
| $\mathrm{PS\&O, CH_{3}}$ |  | 29.0 |  |  |  |
| $\mathrm{PbCH_{3}SOCH_{3}}$ | 29.0 |  | $[(CH_{3})_{2}Si]_{2}N^{-}$ | $30^{\text{b}}$ |  |
| $\mathrm{CH_{3}CN}$ | 25 | 31.3 |  |  |  |
| $\mathrm{Pb_{2}CH_{2}}$ |  | 32.2 |  |  |  |
| $\mathrm{Pb_{3}CH}$ | 33 | 30.6 | $NH_{2}^{+}$ | 35 | 41 |
|  |  |  | $\mathrm{CH_{3}SOCH_{2}^{-}}$ | 35 | 35.1 |
|  |  |  | $(CH_{3}CH_{2})_{2}N^{-}$ | 36 |  |
| $\mathrm{PbCH_{3}}$ |  | 43 |  |  |  |
| $\mathrm{CH_{4}}$ |  | 56 |  |  |  |
...
| ${\mathrm{CH}}_{3} \leftrightarrow {\mathrm{CH}}_{3}$ eclipsed | Torsional and steric strain | 11 | 2.6 |
| ${\mathrm{CH}}_{3} \leftrightarrow {\mathrm{CH}}_{3}$ gauche | Steric strain | 3.8 | 0.9 |
...
$$
\mathrm{CH} _ {4} + 2 \mathrm{O} _ {2} \rightarrow \mathrm{CO} _ {2} + 2 \mathrm{H} _ {2} \mathrm{O} + 890 \mathrm{kJ/mol(213kcal/mol)}
$$
...
- 燃烧反应: $CH_{4} + 2O_{2} \rightarrow CO_{2} + 2H_{2}O + 890\mathrm{kJ}/\mathrm{mol}$ (213kcal/mol)
...
| $\bullet \mathrm{X} + {\mathrm{CH}}_{3} - \mathrm{H} \longrightarrow \bullet {\mathrm{CH}}_{3} + \mathrm{H} - \mathrm{X}\;\Delta \mathrm{H}\left( {\mathrm{KJ}/\mathrm{mol}}\right)$ |  |  |  | Ea (KJ/mol) |
| --- | --- | --- | --- | --- |
...
$$
\begin{array}{c} \mathrm{CH} _ {3} \\ \mathrm{CH} _ {3} \mathrm{CHCH} _ {3} \end{array} \xrightarrow [ \text {hv,127°C} ]{\mathrm{Br} _ {2}} \begin{array}{c} \mathrm{CH} _ {3} \\ \mathrm{CH} _ {3} \mathrm{CHCH} _ {2} - \mathrm{Br} \\ \text {少量} \end{array} + \begin{array}{c} \mathrm{CH} _ {3} \\ \mathrm{CH} _ {3} \mathrm{CCH} _ {3} \\ \mathrm{Br} \\ > 97 \% \end{array}
$$

选择性： $3^{\circ}H:1^{\circ}H = 1600:1$

$$
\begin{array}{r l} & \text {溴代选择性(127°C):} \\ & 3 ^ {\circ} \mathrm{H}: 2 ^ {\circ} \mathrm{H}: 1 ^ {\circ} \mathrm{H} = 1600: 82: 1 \end{array}
$$
...
| --- | --- | --- | --- |
| CH5+正离子结构 | 甲烷质子化产物,SP3杂化碳与氢形成三中心两电子键,五个氢原子高速旋转不可区分 | 布朗斯泰德酸性与路易斯酸性双重性质 | ★★★☆ |
| 酸碱理论对比 | 布朗斯泰德理论(质子转移) vs 路易斯理论(电子对接受),超共轭效应稳定碳正离子 | 弱酸共轭碱是强碱的机理 | ★★★★ |
| 烷烃命名规则 | IUPAC系统命名法:主链选择>编号规则>取代基排序,中国命名特殊调整项 | 取代基排序规则(原子序数>连接原子>支链复杂度) | ★★★☆ |
| 构象分析 | 乙烷交叉式(稳定) vs重叠式,丁烷反交叉式能垒最低,Newman投影式解析 | 超共轭作用对构象稳定性的影响 | ★★★★ |
| 自由基反应机理 | 链引发(光照均裂)→链增长(自由基传递)→链终止(自由基结合),甲烷氯代反应能量曲线 | 溴代反应选择性显著高于氯代(1600:82:1) | ★★★★☆ |
| 小环烷烃特性 | 环丙烷角张力大( $60^{\circ}$ vs $109.5^{\circ}$ ),易发生开环加成(催化加氢/与卤化氢反应) | 开环方向选择:位阻最小原则 vs 碳正离子稳定性 | ★★★★ |
| 反应活性顺序 | 氢原子活性: $3^{\circ}>2^{\circ}>1^{\circ}>CH3$ ;卤素活性: $F2>Cl2>Br2>>I2$ (吸热反应) | 温度升高导致选择性降低 | ★★★☆ |
| 立体化学基础 | 顺反异构标记法,环己烷椅式构象的轴向/平伏键区分 | 未来将引入R/S命名体系 | ★★★★ |
| 互变异构现象 | 酮式-烯醇式平衡(涉及质子迁移),与共振结构的本质区别 | 芳香性对互变异构平衡的影响 | ★★★★ |
| 分子轨道理论 | σ键最大重叠原理,SP杂化轨道s成分与酸性关系(乙炔>乙烯>乙烷) | 碳负离子稳定性与杂化轨道关系 | ★★★★☆ |