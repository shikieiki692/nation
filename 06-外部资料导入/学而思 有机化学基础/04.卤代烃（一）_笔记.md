...
| 按烃基的结构分类 | CH₃CH₂X 饱和卤代烃 | CH₂=CHCH₂X 不饱和卤代烃 | 芳香卤代烃 |
| --- | --- | --- | --- |
| 按卤素数目分类 | 一卤代烃 CH₃CH₂Br |  | 三卤代烃 |
| 按卤素数目分类 | 二卤代烃 ClCH₂CH₂Cl CH₂Br₂ | 连二卤代烃 倍二卤代烃 | CHF₃ 氟仿(fluroform) CHCl₃ 氯仿(chloroform) CHBr₃溴仿(Bromoform) CHI₃碘仿(Iodoform) |
| 按卤素连接的碳原子分类 | (CH₃)₂CHCH₂Cl |  | Br CH₃CH₂CHCH₃ 二级卤代烷 三级卤代烷 |
| 按卤素连接的碳原子分类 | 一级卤代烷 |  | Br CH₃CH₂CHCH₃ 二级卤代烷 三级卤代烷 |
...
| Halomethane | Bond length (pm) | (kJ/mol) | (kcal/mol) | $\left( {\mathrm{cm}/{\mathrm{m}}^{2}}\right)$ | pole moment (D) |
| --- | --- | --- | --- | --- | --- |
...
|  | 动力学证据反应速率 | 立体化学证据对手性底物,产物的立体化学 | 重排现象 | 反应类型 |
| --- | --- | --- | --- | --- |
| I | $\propto [RX][Nu^{\ominus}]$ | 构型翻转 | 无 | 双分子机理bimolecular mechanism $S_{N}2$ |
| II | $\propto [RX]$ | 消旋化 | 有 | 单分子机理unimolecular mechanism $S_{N}1$ |
...
| 极性溶剂 | 质子性溶剂 | ROH | H₂O | RCOOH | 具有可解 离活泼氢 |
| --- | --- | --- | --- | --- | --- |
| 极性溶剂 | 非质子 性溶剂 (偶极 溶剂) | H₃C-S-CH₃ |  | N, N-二甲基甲酰胺 DMF (N, N-Dimethylformamide) |  |
| 极性溶剂 | 非质子 性溶剂 (偶极 溶剂) | 二甲亚砜 DMSO (Dimethyl Sulfoxide) |  | N, N-二甲基甲酰胺 DMF (N, N-Dimethylformamide) |  |
| 极性溶剂 | 非质子 性溶剂 (偶极 溶剂) | CH₃CN |  | H₃C-C-CH₃ |  |
| 非极性和 低极性溶剂 (非质子性溶剂) 烷烃，苯，醚类，酯类 (亲核试剂较难溶解，较少使用) |  |  |  |  |  |
...
| --- | --- | --- | --- |
| 卤代烃分类 | 按烃基结构(饱和/不饱和)、卤素数目、碳原子种类(伯仲叔)、卤素种类分类 | 多卤代烃特殊命名(氯仿/溴仿/碘仿) | ★★☆☆☆ |
| 卤代烃命名 | IUPAC命名法(主链含卤素)、普通命名法(正/异/仲/叔) | 立体构型标记(R/S构型在命名中的体现) | ★★★☆☆ |
| 碳正离子稳定性 | 三级>二级>一级>甲基;烯丙基≈苄基>二级 | 超共轭效应对稳定性的影响 | ★★★★☆ |
| SN1反应机理 | 两步反应、碳正离子中间体、外消旋化产物 | 溶剂极性对反应速率的影响 | ★★★★☆ |
| SN2反应机理 | 一步反应、构型翻转、双分子动力学 | 空间位阻对反应的影响(桥头卤素难反应) | ★★★★☆ |
| 亲核试剂类型 | 孤对电子型(OH-）、π电子型(烯烃)、σ电子型(AlH4-) | 双位负离子(CN-的碳/氮进攻选择性) | ★★★★☆ |
| 离去基团能力 | I->Br->Cl->F-;好的离去基=弱碱稳定阴离子 | 醇的活化(转化为磺酸酯提高离去能力) | ★★★☆☆ |
| 分子内亲核取代 | 五/六元环易形成(环张力适中) | 邻基参与效应导致构型保持 | ★★★★★ |
| 反应条件影响 | SN1:极性溶剂有利;SN2:低极性非质子溶剂有利 | 硝酸银促进SN1并引发重排 | ★★★★☆ |