...
|  | 动力学证据反应速率 | 反应的立体化学 | 重排现象 | 反应类型 |
| --- | --- | --- | --- | --- |
| I | $\alpha [RX][B:]$ | 立体专一性 | 无 | 双分子机理E2 |
| II | $\alpha [RX]$ | 无选择性 | 有 | 单分子机理E1 |
...
| --- | --- | --- | --- | --- | --- |
| ${\left( {\mathrm{{CH}}}_{3}\right) }_{2}\mathrm{C}$ 、H | 71 | ${\left( {\mathrm{{CH}}}_{3}\right) }_{3}{\mathrm{C}}^{\text{① }}$ | ${\mathrm{H}}_{2}\mathrm{\;N} - \mathrm{H}$ | 36 | ${\mathrm{H}}_{2}{\mathrm{\;N}}^{\text{①}}$ |
| ${\mathrm{{CH}}}_{3}{\mathrm{{CH}}}_{2}$ 、H | 62 | ${\mathrm{{CH}}}_{3}{\mathrm{{CH}}}_{2}{}^{\text{②}}$ | HC=C-H | 26 | $\mathrm{{HC}} = {\mathrm{C}}^{\text{① }}$ |
| ${\mathrm{{CH}}}_{3}$ 、 $\mathrm{H}$ | 60 | ${\mathrm{{CH}}}_{3}{}^{\text{③}}$ | ${\mathrm{{CH}}}_{3}{\mathrm{{CH}}}_{2}\mathrm{O} - \mathrm{H}$ | 16 | ${\mathrm{{CH}}}_{3}{\mathrm{{CH}}}_{2}{\mathrm{O}}^{\text{① }}$ |
|  |  |  | HO-H | 15.7 | ${\mathrm{{HO}}}^{\text{① }}$ |
