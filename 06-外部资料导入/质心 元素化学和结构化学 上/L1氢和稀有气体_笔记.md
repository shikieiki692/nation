...
熔点(K) $: H _ { 2 } ( 13.96 ) < D _ { 2 } ( 18.73 ) < T _ { 2 } ( 20.63 )$   
沸点(K) ${ | \cdot { H _ { 2 } } ( 20.30 ) \cdot { \cal D } _ { 2 } ( 23.67 ) \cdot { \cal T } _ { 2 } ( 25.01 ) }$   
键能(k $\mathbf { \left| \right)} / \mathbf { m o l }  : H _ { 2 } ( 436 ) < D _ { 2 } ( 443 ) < T _ { 2 } ( 447 )$
...
特点：强吸热反应 $( \Delta \mathsf { H } = 204.7 \mathsf { k } ) \cdot \mathsf { m o } l ^ { - 1 } )$ ），热量来⾃甲烷燃烧
...
第⼀步： $C ( s ) + H _ { ? } O ( g ) 10 \theta \theta ^ { \circ } C C O ( g ) + H _ { ? } ( g )$   
第⼆步： $C O + H _ { 2 } O 400 - 600 ^ { \circ } \mathrm { C } , F e _ { 2 } O _ { 3 } / C o _ { 2 } O _ { 3 } C O _ { 2 } + H _ { 2 }$   
...
 焓变 $\cdot \Delta { \sf H } = 1312 \mathrm { \sf k J } \cdot \sf m o l ^ { - 1 } ( 13.59 \mathrm { e V } )$   
...
 键能影响：氢分⼦键能 $H \cdot H { : } B D E = 436 k J \cdot m o l ^ { - 1 }$ ，氧⽓ $\bar { \mathsf { \Omega } } O _ { 2 } { : } 490 k J \cdot m o l ^ { - 1 }$ ，氯⽓ $\bar { \backslash } C l _ { > } : 239 k J \cdot m o l ^ { - 1 }$ 。由于键能较⼤，室温下氢⽓表现惰性  
...
 典型反应： $M n O + H _ { 2 } {  } M n + H _ { 2 } O \mathrm { ( 500 ^ { \circ } C }$ 以下）  
 反应判据：
...
o $3 F e _ { 2 } O _ { 3 } + H _ { 2 } {  } 2 F e _ { 3 } O _ { 4 } + H _ { 2 } O ( < 325 ^ { \circ } \mathrm { C } )$   
$F e _ { 2 } O _ { 3 } + 3 H _ { 2 } > 325 ^ { \circ } \mathrm { C } 2 F e + 3 H _ { 2 } O$
...
温度范围：通常在 $100 { - } 200 ^ { \circ } \mathrm { C }$ 即可反应
...
2 $X e P t F _ { 6 } + 6 H _ { 2 } O {  } 2 X e + 2 P t O _ { 2 } + O _ { 2 } + 12 H F$   
配平技巧：将Pt视为+6价，Xe为0价
...
实验条件A： $125 \mathsf { m m o l } \mathsf { X e } + 275 \mathsf { m m o l } F _ { 2 }$ （1L容器）→ ${ \mathrm { } } { \cdot } X e F _ { 2 }$ 占⽐⾼

实验条件B：125mmol $\mathsf { X e } ~ + ~ 1225 \mathsf { m m o l } F _ { 2 } { \longrightarrow } { \mathit { X e F } } _ { 2 }$ 显著减少（氟过量导致进⼀步氟化）
...
 条件： $X e { : } F _ { \gamma } = 1 { : } 5 , 400 ^ { \circ } \mathbb { C }$ 反应1⼩时  
 过程： $X e + F _ { 2 } 400 { \overset { \circ } { \doublebarwedge } } 1 h X e F _ { 4 } ( g ) - 8 \theta { \overset { \circ } { \displaybreaks } } \mathrm { C } X e F _ { 4 } ( s )$

定量分析⽅法：

 反应原理： $X e F _ { 4 } + 2 H _ { 2 } 136 ^ { \circ } \mathrm { C } X e + 4 H F$   
...
 总反应： $6 X e F _ { 4 } + 12 H _ { 2 } O  2 X e O _ { 3 } + 4 X e + 3 O _ { 2 } + 24 H F$
...
o $X e F _ { 2 }$ 反应温度：约 $. 30 ^ { \circ } \mathsf { C }$   
o $X e F _ { 4 } .$ 反应温度：约 $400 \%$
...
熔点反常： $X e F _ { 2 } ~ ( 117 ^ { \circ } \mathsf { C } ) { } ~ { } > X e F _ { 4 } ~ ( 129 ^ { \circ } \mathsf { C } ) { } ~ { } > X e F _ { 6 }$ （49.5℃）  
 键能与键⻓：
...
o 强氧化性 $( E ^ { \theta } ( X e O _ { 3 } / X e ) = 2.10 V )$   
o 分析应⽤：
...
室温⽆⾊液体， $m { \tt p } { = } 46.2 ^ { \circ } \mathrm { C }$   
四⽅锥结构（VSEPR理论）  
...
⽆⾊晶体， $m { \mathsf { p } } { = } 308 ^ { \circ } { \mathrm { C } }$   
跷跷板型结构（VSEPR理论）  
仅作氟给予体，易分解失去氧
...
 稳定形式：四氟化纤在氢氧化钠溶液中⽔解得到的⽆⽔盐（加热⾄ $. 500 ^ { \circ } \mathrm { C }$ 才分解）
...
| --- | --- | --- | --- |
| 氢的性质 | 最简单的原子和分子,研究结构的基础 | 氢在周期表中的位置争议(第1/14/17族) | ★★★ |
| 氢的制备方法 | 实验室制法(活泼金属+水/酸/碱)、工业制法(电解/天然气裂解) | 氢化铝锂野外制备氢气的特点(定量/纯/高效) | ★★★★ |
| 氢的成键形式 | 共价单键/离子键/金属键/氢键/多中心桥键/负氢配位键 | 二氢键解释异常熔点现象(如CH3F与NH3化合物) | ★★★★★ |
| 稀有气体化合物 | 1962年首次发现XePtF6,突破惰性认知 | 六氟化铂强氧化性突破稀有气体反应壁垒 | ★★★★ |
| 氟化氙系列 | 二氟化氙(直线型)/四氟化氙(平面四方)/六氟化氙(变形八面体) | 水解差异:XeF2直接氧化还原,XeF4歧化+氧化还原,XeF6分步水解 | ★★★★★ |
| 氟化氙加合物 | XeF2/XeF4作F-给体,XeF6兼具给体受体特性 | 加合物离子性判断([XeF5]+[MF6]-为离子化合物) | ★★★★ |
| 高氙酸盐 | Na4XeO6·6H2O稳定分析试剂,氧化Mn24/Fe2+/Cr3+ | 碱性条件下稳定(pH>11.5),酸化分解为XeO3 | ★★★★ |
| 氢化物特殊反应 | BeH2制备(LiAlH4+二甲基铍)、LiAlH4氨解取代反应 | 氢化铝锂与醇的烷氧基取代(控制还原性) | ★★★★ |
| 实验现象解析 | 氢气检测(PdCl2溶液变黑)、XeF2与苯在CCl4中氟化(68%产率) | 硅氢键/硅氯键氟化选择性(Cl-Si键优先断裂) | ★★★★ |