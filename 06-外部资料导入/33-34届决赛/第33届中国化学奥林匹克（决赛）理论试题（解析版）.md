...
当 Mn(II) 浓度也是定值时，有 $\ln\frac{A_{t}}{A_{t+\Delta t}} = -k c_{Mn(II)} \Delta t = k'' \Delta t$ ，代入表 2-2 数据，可得 $k''_{363.15} = 0.168 \, min^{-1}$ ， $k''_{373.15} = 0.490 \, min^{-1}$ ，则 $\ln\frac{k''_{373.15}}{k''_{363.15}} = \frac{E_{a}}{R} \left( \frac{1}{363.15} - \frac{1}{373.15} \right)$ ，解得 $E_{a} = 121 \, \mathrm{kJ} \cdot \mathrm{mol}^{-1}$ 。
