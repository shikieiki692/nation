...
$$
\mathrm{A} + \mathrm{CH} _ {3} \mathrm{MgI} \longrightarrow \xrightarrow {\mathrm{H} _ {2} \mathrm{O}} \mathrm{M} (\mathrm{C} _ {8} \mathrm{H} _ {12} \mathrm{O}) \xrightarrow [ \triangle ]{\text {浓硫酸}} \mathrm{N} (\mathrm{C} _ {8} \mathrm{H} _ {10})
$$
