...
$$
\mathrm {CH_ {3} CH = CH_ {2}} \xrightarrow [ 500 \sim 600 ^ {\circ} \mathrm{C} ]{\mathrm {Cl_ {2}}} \mathrm {ClCH_ {2} CH = CH_ {2}}
$$
...
$$
\mathrm{CH} \equiv \mathrm{CH} + \mathrm{HCN} \xrightarrow [ 70 ^ {\circ} \mathrm{C} ]{\mathrm{CuCl} _ {2} (\mathrm{aq})} \mathrm{CH} _ {2} = \mathrm{CH} - \mathrm{CN}
$$

由于乙炔成本高,现在普遍采用丙烯的氨氧化反应制丙烯腈。反应如下:

$$
2 \mathrm{CH} _ {2} = \mathrm{CHCH} _ {3} + 3 \mathrm{O} _ {2} + 2 \mathrm{NH} _ {3} \xrightarrow [ 400 \sim 500 ^ {\circ} \mathrm{C} ]{\text {催化剂}} 2 \mathrm{CH} _ {2} = \mathrm{CHCN} + 6 \mathrm{H} _ {2} \mathrm{O}
$$
...
$$
\mathrm{C} _ {6} \mathrm{H} _ {5} + \mathrm{HNO} _ {3} \xrightarrow [ 60 ^ {\circ} \mathrm{C} ]{\mathrm{H} _ {2} \mathrm{SO} _ {4}} \mathrm{C} _ {6} \mathrm{H} _ {5} \mathrm{NO} _ {2} + \mathrm{H} _ {2} \mathrm{O}
$$
...
| 因素 | $S_{N}1$ 机理 | $S_{N}2$ 机理 |
| --- | --- | --- |
| 烃基 | 3°RX、 $CH_{2}=CHCH_{2}X$ 、 $PhCH_{2}X$ 生成稳定的碳正离子 | 1°RX、 $CH_{2}=CHCH_{2}X$ 、 $PhCH_{2}X$ 体积小,利于接近 |
| 离去基团 | 离去性能好对反应有利 | 离去性能好对反应有利 |
| 亲核试剂的亲核性 | 亲核性强弱与反应关系不大 | 亲核性强对反应有利 |
| 溶剂 | 强极性溶剂有利 | 弱极性溶剂有利 |
...
$$
\mathrm{C} _ {2} \mathrm{H} _ {5} \mathrm{OH} \xrightarrow [ 170 ^ {\circ} \mathrm{C} ]{\mathrm{H} _ {2} \mathrm{SO} _ {4}} \mathrm{CH} _ {2} = \mathrm{CH} _ {2} \uparrow + \mathrm{H} _ {2} \mathrm{O}
$$
...
$$
2 \mathrm{C} _ {2} \mathrm{H} _ {5} \mathrm{OH} \xrightarrow [ 140 ^ {\circ} \mathrm{C} ]{\mathrm{H} _ {2} \mathrm{SO} _ {4}} \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{OCH} _ {2} \mathrm{CH} _ {3} + \mathrm{H} _ {2} \mathrm{O}
$$
...
| $RNH_{2}$ | $R_{2}NH$ | $R_{3}N$ | $R_{4}N^{+}X^{-}$ |
| --- | --- | --- | --- |
| 1°胺 | 2°胺 | 3°胺 | 四级铵盐 |
| 伯胺 | 仲胺 | 叔胺 | 季铵盐 |
