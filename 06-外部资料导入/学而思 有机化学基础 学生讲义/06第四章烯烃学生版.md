...
$$
\mu = 1.167 \mathrm{X} 10 ^ {- 30} \mathrm{C} \cdot \mathrm{m}
$$
...
$$
\begin{array}{c c c} \mathrm{H} & \mathrm{H} \\ \mathrm{C} = \mathrm{C} & + & \mathrm{H} _ {2} \mathrm{O} \\ \mathrm{H} & \mathrm{H} \end{array} \xrightarrow [ 250 ^ {\circ} \mathrm{C} ]{\mathrm{H} _ {3} \mathrm{PO} _ {4} \text {催化剂}} \quad \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{OH}
$$
