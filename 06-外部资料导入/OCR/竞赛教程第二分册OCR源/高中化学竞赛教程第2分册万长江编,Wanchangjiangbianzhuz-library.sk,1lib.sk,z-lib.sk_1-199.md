...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/96ac230fc919fde4d736ddedc562e4048de84b2ccdf91def66cede3d000b82c0.jpg)
...
$$
\begin{array}{r l} \text {   斜率   } & = \frac {(0.92 - 0) \mathrm{mol} \cdot \mathrm{L} ^ {- 1}}{(0 - 4.1) \mathrm{min}} \\ & = - 0.22 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1} \\ & (\text {   取   } A, B \text {   两点   }) \end{array}
$$

$$
\begin{array}{r l} v & = \frac {1}{\nu} \frac {\mathrm{d} c}{\mathrm{d} t} = - \frac {1}{2} (- 0.22 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1}) \\ & = 0.11 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1} \end{array}
$$

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8a4221311edd02f85c081f033933709572e50fad424fd01c93fc6b9b80e808fb.jpg)  
$\mathbf{N}_2\mathbf{O}_5$ 分解的 $c - t$ 曲线

3 min 时

$$
\begin{array}{r l} \text {斜率} & = \frac {(0.73 - 0.20) \mathrm{mol} \cdot \mathrm{L} ^ {- 1}}{(0 - 4.2) \mathrm{min}} \\ & = - 0.13 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1} \quad (\text {取} C, D \text {两点}) \end{array}
$$

$$
v = \frac {1}{\nu} \frac {\mathrm{d} c}{\mathrm{d} t} = - \frac {1}{2} (- 0.13 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1}) = 0.065 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{min} ^ {- 1}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1c5e2a87b59771c7aca60145636f5b22e455b9f64e3de99db0a0b15280f30a22.jpg)  
催化剂改变反应活化能的示意图  
若产物之一对反应本身有催化作用,则称之为自催化反应。如:

$$
2 \mathrm{MnO} _ {4} ^ {-} + 6 \mathrm{H} ^ {+} + 5 \mathrm{H} _ {2} \mathrm{C} _ {2} \mathrm{O} _ {4} \longrightarrow 10 \mathrm{CO} _ {2} \uparrow + 8 \mathrm{H} _ {2} \mathrm{O} + 2 \mathrm{Mn} ^ {2 +}
$$
...
$$
① 5.30 \times 10 ^ {- 9} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1} = k (0.10 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {x} (0.10 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {y}
$$

$$
2.67 \times 10 ^ {- 8} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1} = k (0.50 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {x} (0.10 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {y}
$$

$$
4.25 \times 10 ^ {- 7} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1} = k (0.50 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {x} (0.40 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {y}
$$

②÷①得

$$
\frac {2.67 \times 10 ^ {- 8}}{5.30 \times 10 ^ {- 9}} = \left(\frac {0.50}{0.10}\right) ^ {x}
$$
...
$$
\frac {4.25 \times 10 ^ {- 7}}{2.67 \times 10 ^ {- 8}} = \left(\frac {0.40}{0.10}\right) ^ {y}
$$
...
$$
k = \frac {5.30 \times 10 ^ {- 9} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1}}{0.10 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \times (0.10 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {2}} = 5.3 \times 10 ^ {- 6} \mathrm{L} ^ {2} \cdot \mathrm{mol} ^ {- 2} \cdot \mathrm{s} ^ {- 1}
$$

$$
\begin{array}{r l} (3) v & = 5.3 \times 10 ^ {- 6} \mathrm{L} ^ {2} \cdot \mathrm{mol} ^ {- 2} \cdot \mathrm{s} ^ {- 1} \times 1.0 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \times (1.0 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {2} \\ & = 5.3 \times 10 ^ {- 6} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1} \end{array}
$$
...
$$
K _ {c} = \frac {[ \mathrm{NH} _ {3} ] ^ {2}}{[ \mathrm{N} _ {2} ] [ \mathrm{H} _ {2} ] ^ {3}} = \frac {(0.102) ^ {2}}{(1.03) (1.62) ^ {3}} = 2.38 \times 10 ^ {- 3} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1}) ^ {- 2}
$$
...
$$
\begin{array}{r l} & p (\mathrm {NH_ {3}}) = (0.102) \times (R T) \\ & p (\mathrm {N_ {2}}) = (1.03) \times (R T) \\ & p (\mathrm {H_ {2}}) = (1.62) \times (R T) \end{array}
$$

所以

$$
K _ {p} = \frac {p ^ {2} (\mathrm{NH} _ {3})}{p (\mathrm{N} _ {2}) \times p ^ {3} (\mathrm{H} _ {2})} = 3.44 \times 10 ^ {- 11} (\mathrm{kPa} ^ {- 2})
$$

解法 2 利用 $K_{p}$ 与 $K_{c}$ 的关系式 $K_{p} = K_{c}(RT)^{\Delta n}$ 来计算 $K_{p}$ :

$$
K _ {p} = 2.38 \times 10 ^ {- 3} \times (8.314 \times 1000) ^ {- 2} = 3.44 \times 10 ^ {- 11} (\mathrm{kPa} ^ {- 2})
$$
...
$$
K _ {c} = \frac {[ \mathrm{H} _ {2} ] [ \mathrm{CO} _ {2} ]}{[ \mathrm{CO} ] [ \mathrm{H} _ {2} \mathrm{O} ]} = \frac {x ^ {2}}{(a - x) ^ {2}} = 2.60
$$
...
$$
K _ {c} = \frac {[ \mathrm{H} _ {2} ] [ \mathrm{CO} _ {2} ]}{[ \mathrm{CO} ] [ \mathrm{H} _ {2} \mathrm{O} ]} = \frac {y ^ {2}}{(b - y) (3 b - y)} = 2.60
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d2321ffaa5e5ca1cb2c10a7fcb0e412f4f3c4278b628e5d334acf5e9e120b9f5.jpg)
...
$$
K _ {p} = \frac {p (\mathrm{H} _ {2})}{p (\mathrm{H} _ {2} \mathrm{O})} = \frac {n (\mathrm{H} _ {2})}{n (\mathrm{H} _ {2} \mathrm{O})} = 1.49
$$
...
$$
\begin{array}{r l} & n (\mathrm{H} _ {2}) = 0.30 \mathrm{mol} \\ & n (\mathrm{H} _ {2} \mathrm{O}) = 1.00 - 0.30 = 0.70 \mathrm{mol} \\ & n (\mathrm{FeO}) = 0.30 \mathrm{mol} \\ & n (\mathrm{Fe}) = 0 \mathrm{mol} \end{array}
$$
...
$$
\begin{array}{r l r l r l}&&{\mathrm {Fe(s)+ H_ {2} O(g)\rightleftharpoons FeO(s)+ H_ {2} (g)}}\\{n (\text {起始})}&{0.80}&{1.00}&{0}&{0}\\{n (\text {转化})}&{x}&{x}&{x}&{x}\\{n (\text {平衡})}&{0.80 - x}&{1.00 - x}&{x}&{x}\end{array}
$$
...
$$
\begin{array}{r l} & n (\mathrm{H} _ {2}) = 0.60 \mathrm{mol}, n (\mathrm{H} _ {2} \mathrm{O}) = 0.40 \mathrm{mol} \\ & n (\mathrm{FeO}) = 0.60 \mathrm{mol}, n (\mathrm{Fe}) = 0.20 \mathrm{mol} \end{array}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ecf2df0b69df4fecc4ab183c0b8da9576340cdcb0c56d9522678b6a1603f43a7.jpg)
...
$$
n (\mathrm{HNO} _ {3}) = \frac {0.10 \mathrm{g}}{44 \mathrm{g} \cdot \mathrm{mol} ^ {- 1}} \times 2 = \frac {1}{220} \mathrm{mol}
$$

③ 溶液体积为 $25 \mathrm{~mL} = 0.025 \mathrm{~L}$ , 所以 $\mathrm{HNO}_{3}$ 减少的浓度;

$$
\Delta c (\mathrm{HNO} _ {3}) = \frac {2}{11} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
v (\mathrm{HNO} _ {3}) = \Delta c (\mathrm{HNO} _ {3}) / \Delta t = \frac {1}{110} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \cdot \mathrm{s} ^ {- 1}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/66b08849fe50da7fa23fe000960efe44646e71e048d843c98b3048b0edcefdd2.jpg)
...
$$
n \left(\mathrm{CH} _ {4}\right) = (250.0 \times 10 ^ {3} \times 55.0) / (8.314 \times 298) = 5.55 \times 10 ^ {3} (\mathrm{mol})
$$

$$
n \left[ \mathrm{H} _ {2} \mathrm{O} (\mathrm{g}) \right] = (200.0 \times 10 ^ {3} \times 150.0) / (8.314 \times 423) = 8.53 \times 10 ^ {3} (\mathrm{mol})
$$
...
$$
\begin{array}{r l} n _ {\mathrm{T}} & = n (\mathrm{CO}) + n (\mathrm{H} _ {2}) + n (\mathrm{CH} _ {3} \mathrm{OH}) \\ & = \{5.55 \times 10 ^ {3} \times 1 / 3 + (16.65 \times 10 ^ {3} - 5.55 \times 10 ^ {3} \times 2 / 3 \times 2) + \\ & \quad 5.55 \times 10 ^ {3} \times 2 / 3 \} \mathrm{mol} \\ & = 14.8 \times 10 ^ {3} \mathrm{mol} \end{array}
$$
...
$$
p (\mathrm{CO}) = 10.0 \mathrm{MPa} \times 5.55 \times 10 ^ {3} \times 1 / 3 / (14.8 \times 10 ^ {3}) = 1.25 \mathrm{MPa}
$$

$$
p (\mathrm{H} _ {2}) = 10.0 \mathrm{MPa} \times 9.25 \times 10 ^ {3} / (14.8 \times 10 ^ {3}) = 6.25 \mathrm{MPa}
$$

$$
p \left(\mathrm{CH} _ {3} \mathrm{OH}\right) = 10.0 \mathrm{MPa} \times 5.55 \times 10 ^ {3} \times 2 / 3 / (14.8 \times 10 ^ {3}) = 2.50 \mathrm{MPa}
$$

$$
(4) K _ {p} = 2.50 \times (0.100) ^ {2} / (1.25 \times 6.25 ^ {2}) = 5.12 \times 10 ^ {- 4}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/382ed09ec731bd4288d5cc7ae2c95c2c12182b8599c9b90ad5d50a9baaa8fe1f.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b7ab717b24d387d5c0c6e8d4a973f80e8fe4afcc86ead7e7ddeded38a1b9d29e.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/9d041104f52cc0e611e3b35966cb5b0e2e64da27fec068eb5de961012eb526ac.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/747615873d9e347b461ed30e988d3cc4d8e52c741db182637d71f3e32aad8724.jpg)  
A

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3c2268ddba9cf22031b5c872a91523e2739287496d47cef821bb98078098c3db.jpg)  
B

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b242158c022aac6ab5c3eaa39b61fd900638873cf411149764c43e01e621b3c0.jpg)  
C

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a44f112f6baaa046068ea7471dd7d4615746e325f47e1c0fecf2c6c6aa0d88a1.jpg)  
D
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/34f6074214832a519db259f22b73d14615a7659bdaf2782dd5f829a7637923ed.jpg)
...
$$
K = \frac {0.114 ^ {2}}{0.193 \times 0.579 ^ {3}} = 0.347 \quad \alpha = \frac {0.114}{0.307} \times 100 \% = 37.1
$$
...
$$
\frac {\frac {1 - y}{2} \times \frac {1}{2}}{\left(\frac {y}{2}\right) ^ {3} \times p (\mathrm{CO})} = 1.98 \times 10 ^ {10}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/68687f53c6a0fa13d06738873aab76281c30aa22110b659e0c28c886fbedbdcc.jpg)
...
$$
\mathrm{Ca} _ {10} (\mathrm{OH}) _ {2} \left(\mathrm{PO} _ {4}\right) _ {6} (\mathrm{s}) + 2 \mathrm{F} ^ {-} \longrightarrow \mathrm{Ca} _ {10} \mathrm{F} _ {2} \left(\mathrm{PO} _ {4}\right) _ {6} (\mathrm{s}) + 2 \mathrm{OH} ^ {-}
$$

$$
K = \frac {c ^ {2} (\mathrm{OH} ^ {-})}{c ^ {2} (\mathrm{F} ^ {-})} = \frac {K _ {\mathrm{sp}} [ \mathrm{Ca} _ {10} (\mathrm{OH}) _ {2} (\mathrm{PO} _ {4}) _ {6} ]}{K _ {\mathrm{sp}} [ \mathrm{Ca} _ {10} \mathrm{F} _ {2} (\mathrm{PO} _ {4}) _ {6} ]} = \frac {3.8 \times 10 ^ {- 37}}{1.0 \times 10 ^ {- 60}} = 3.8 \times 10 ^ {23}
$$
...
$$
K _ {\mathrm{a}} = \frac {[ \mathrm{H} ^ {+} ] [ \mathrm{Ac} ^ {-} ]}{[ \mathrm{HAc} ]} = 1.8 \times 10 ^ {- 5}
$$

类似氨水有：

$$
\mathrm{NH} _ {3} \cdot \mathrm{H} _ {2} \mathrm{O} \rightleftharpoons \mathrm{NH} _ {4} ^ {+} + \mathrm{OH} ^ {-} K _ {\mathrm{b}} = \frac {[ \mathrm{NH} _ {4} ^ {+} ] [ \mathrm{OH} ^ {-} ]}{[ \mathrm{NH} _ {3} \cdot \mathrm{H} _ {2} \mathrm{O} ]} = 1.8 \times 10 ^ {- 5}
$$
...
$$
\mathrm{H} _ {2} \mathrm{S} \rightleftharpoons \mathrm{H} ^ {+} + \mathrm{HS} ^ {-} \quad K _ {\mathrm{a}} = \frac {[ \mathrm{H} ^ {+} ] [ \mathrm{HS} ^ {-} ]}{[ \mathrm{H} _ {2} \mathrm{S} ]} = 1.3 \times 10 ^ {- 7}
$$

第二步

$$
\mathrm{HS} ^ {-} \rightleftharpoons \mathrm{H} ^ {+} + \mathrm{S} ^ {2 -} \quad K _ {\mathrm{a} _ {2}} = \frac {[ \mathrm{H} ^ {+} ] [ \mathrm{S} ^ {2 -} ]}{[ \mathrm{HS} ^ {-} ]} = 7.1 \times 10 ^ {- 15}
$$
...
$$
\mathrm{H} _ {2} \mathrm{S} \rightleftharpoons 2 \mathrm{H} ^ {+} + \mathrm{S} ^ {2 -} \quad K _ {\mathrm{a}} = \frac {[ \mathrm{H} ^ {+} ] ^ {2} [ \mathrm{S} ^ {2 -} ]}{[ \mathrm{H} _ {2} \mathrm{S} ]} = K _ {\mathrm{a} _ {1}} \cdot K _ {\mathrm{a} _ {2}} = 9.2 \times 10 ^ {- 22}
$$
...
$$
(\text { 已知 }: \mathrm{H} _ {3} \mathrm{PO} _ {4} \quad K _ {\mathrm{a} _ {1}} = 7.5 \times 10 ^ {- 3}, K _ {\mathrm{a} _ {2}} = 6.2 \times 10 ^ {- 8}, K _ {\mathrm{a} _ {3}} = 2.2 \times 10 ^ {- 13})
$$
...
$$
\frac {c}{K _ {\mathrm{a} _ {1}}} = \frac {0.10}{7.5 \times 10 ^ {- 3}} = 13 <   500
$$

$$
\begin{array}{r l} \left[ \mathrm{H} ^ {+} \right] & = \frac {- 7.5 \times 10 ^ {- 3} + \sqrt {(7.5 \times 10 ^ {- 3}) ^ {2} + 4 \times 7.5 \times 10 ^ {- 3} \times 0.10}}{2} \\ & = 2.4 \times 10 ^ {- 2} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \end{array}
$$

$$
\left[ \mathrm{H} _ {2} \mathrm{PO} _ {4} ^ {-} \right] = \left[ \mathrm{H} ^ {+} \right] = 2.4 \times 10 ^ {- 2} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$

由 $\mathrm{H}_{3} \mathrm{PO}_{4}$ 的第二级离解平衡可得

$$
[ \mathrm{HPO} _ {4} ^ {2 -} ] = K _ {\mathrm{a} _ {2}} \frac {[ \mathrm{H} _ {2} \mathrm{PO} _ {4} ^ {-} ]}{[ \mathrm{H} ^ {+} ]} = K _ {\mathrm{a} _ {2}} = 6.2 \times 10 ^ {- 8} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$

由 $\mathrm{H}_{3} \mathrm{PO}_{4}$ 的第三级离解平衡可得

$$
\begin{array}{r l} & {\left[ \mathrm{PO} _ {4} ^ {3 -} \right] = K _ {\mathrm{a} _ {3}} \frac {\left[ \mathrm{HPO} _ {4} ^ {2 -} \right]}{\left[ \mathrm{H} ^ {+} \right]} = \frac {K _ {\mathrm{a} _ {3}} \cdot K _ {\mathrm{a} _ {2}}}{\left[ \mathrm{H} ^ {+} \right]} = \frac {2.2 \times 10 ^ {- 13} \times 6.2 \times 10 ^ {- 8}}{2.4 \times 10 ^ {- 2}}} \\ & {\qquad = 5.7 \times 10 ^ {- 19} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}} \\ & {\left[ \mathrm{H} _ {3} \mathrm{PO} _ {4} \right] = c (\mathrm{H} _ {3} \mathrm{PO} _ {4}) - ([ \mathrm{H} _ {2} \mathrm{PO} _ {4} ^ {-} ] + [ \mathrm{HPO} _ {4} ^ {2 -} ] + [ \mathrm{PO} _ {4} ^ {3 -} ])} \\ & {\qquad = 0.10 - (2.4 \times 10 ^ {- 2} + 6.2 \times 10 ^ {- 8} + 5.7 \times 10 ^ {- 19})} \\ & {\qquad = 7.6 \times 10 ^ {- 2} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}} \end{array}
$$
...
$$
\mathrm{pH} = \mathrm{pK} _ {\mathrm{a}} + \lg \frac {c (\mathrm{NH} _ {3})}{c (\mathrm{NH} _ {4} ^ {+})} = 9.25 + \lg \frac {0.20 \times 200}{0.10 \times 300} = 9.37
$$
...
$$
\mathrm{pH} = 9.25 + \lg \frac {0.20 \times 200 - 0.10 \times 20}{0.10 \times 300 + 0.10 \times 20} = 9.32
$$
...
$$
\begin{array}{l} 9.00 = 9.25 + \lg \frac {V (\mathrm{NH} _ {3})}{V (\mathrm{NH} _ {4} ^ {+})} \\ 100 = V (\mathrm{NH} _ {4} ^ {+}) + V (\mathrm{NH} _ {3}) \end{array}
$$
...
$$
\mathrm{HIn} \rightleftharpoons \mathrm{In} ^ {-} + \mathrm{H} ^ {+} \quad K _ {\mathrm{a}} = 4 \times 10 ^ {- 4}
$$
...
$$
\begin{array}{r l} & K _ {\mathrm{a}} (\mathrm{NH} _ {4} ^ {+}) = 5.71 \times 10 ^ {- 10}, c (\mathrm{NH} _ {4} ^ {+}) = 0.05 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \\ & c / K _ {\mathrm{a}} \gg 500, [ \mathrm{H} ^ {+} ] = (c \cdot K _ {\mathrm{a}}) ^ {1 / 2} = (0.05 \times 5.71 \times 10 ^ {- 10}) ^ {1 / 2} \\ & \qquad = 5.34 \times 10 ^ {- 6} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1}) \\ & \qquad \mathrm{pH} = 5.27 \end{array}
$$

(2) 同浓度、同体积的 HAc 溶液和 $NH_{3}$ 溶液混合, 二者反应, 产物是 $NH_{4}Ac$ , 混合溶液是两性体系:

$$
K _ {\mathrm{a}} (\mathrm{NH} _ {4} ^ {+}) = 5.71 \times 10 ^ {- 10}, K _ {\mathrm{a}} (\mathrm{HAc}) = 1.76 \times 10 ^ {- 5}
$$

应用两性体系的 $\mathrm{pH}$ 计算公式:

$$
\begin{array}{r l} \mathrm{pH} & = [ \mathrm {pK_ {a} (HAc) + pK_ {a} (NH_ {4} ^ {+})} ] / 2 \\ & = [ - \lg (5.71 \times 10 ^ {- 10} \times 1.76 \times 10 ^ {- 5}) ] / 2 = 7.00 \end{array}
$$

(3) 同浓度、同体积的 HCl 溶液和 $Na_{2}CO_{3}$ 溶液混合, 二者反应, 产物是 $NaHCO_{3}$ , 混合溶液是两性体系:

$$
\begin{array}{r l} & K _ {a _ {1}} (\mathrm{H} _ {2} \mathrm{CO} _ {3}) = 4.46 \times 10 ^ {- 7}, K _ {a _ {2}} (\mathrm{H} _ {2} \mathrm{CO} _ {3}) = 4.68 \times 10 ^ {- 11} \\ & \quad \mathrm{pH} = [ \mathrm{pK} _ {a _ {1}} (\mathrm{H} _ {2} \mathrm{CO} _ {3}) + \mathrm{pK} _ {a _ {2}} (\mathrm{H} _ {2} \mathrm{CO} _ {3}) ] / 2 \\ & \quad = [ - \lg (4.46 \times 10 ^ {- 7} \times 4.68 \times 10 ^ {- 11}) ] / 2 = 8.34 \end{array}
$$

(4) 同浓度、同体积的 $\mathrm{NaOH}$ 溶液和 $\mathrm{Na}_{2} \mathrm{HPO}_{4}$ 溶液混合, 二者反应, 产物是 $\mathrm{Na}_{3} \mathrm{PO}_{4}$ , 这是一个多元弱碱体系:

$$
K _ {\mathrm{b}} (\mathrm{PO} _ {4} ^ {3 -}) = 1 \times 10 ^ {- 14} / (4.5 \times 10 ^ {- 13}) = 2.2 \times 10 ^ {- 2}
$$
...
$$
K _ {\mathrm{b}} = [ \mathrm{OH} ^ {-} ] ^ {2} / (0.05 - [ \mathrm{OH} ^ {-} ]) = 2.2 \times 10 ^ {- 2}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4c538e6af3b48fae25af3145c54a9f50d68881405ce73cea36327657e72b9c5b.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0dad1710a54199d8759cfcad1009579abae6ea9436d799480cc003796b6aaf32.jpg)
...
$$
\mathrm{H} _ {2} \mathrm{CO} _ {3} \rightleftharpoons \mathrm{H} ^ {+} + \mathrm{HCO} _ {3} ^ {-} \qquad K _ {\mathrm{a} _ {1}} = \frac {c (\mathrm{H} ^ {+}) \cdot c (\mathrm{HCO} _ {3} ^ {-})}{c (\mathrm{H} _ {2} \mathrm{CO} _ {3})} = 4.30 \times 10 ^ {- 7}
$$

$$
\mathrm{HCO} _ {3} ^ {-} \rightleftharpoons \mathrm{H} ^ {+} + \mathrm{CO} _ {3} ^ {2 -} \quad K _ {\mathrm{a} _ {2}} = \frac {c (\mathrm{H} ^ {+}) \cdot c (\mathrm{CO} _ {3} ^ {2 -})}{c (\mathrm{HCO} _ {3} ^ {-})} = 5.60 \times 10 ^ {- 11}\tag{②}
$$
...
$$
c (\mathrm{CO} _ {3} ^ {2 -}) = 1.14 \times 10 ^ {- 3} \mathrm{mol} \cdot \mathrm{L} ^ {- 1} > c (\mathrm{OH} ^ {-})
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/08de81fe7514b742619eaa5e9600071f3754a8b3949a5ef3a31837d8843817cf.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d642c9a7fa3f238926c8f56194590f848d38bc9d821cc4d5b9c3944e2f1579ea.jpg)

参考解答 见上述分析。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/057e203df83335b88c74d5c70a6836af4d813d1866a4df0c4ae9bdedee8079db.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e3d503ea8286b47e01b633b58ad5dc7c129e6d2f832c6a05490c3762a3a45d2b.jpg)
...
$$
c (\mathrm{H} _ {2} \mathrm{O}) = \frac {1000 \mathrm{g}}{18 \mathrm{g} \cdot \mathrm{mol} ^ {- 1} \times 1 \mathrm{L}} = 55.6 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$

$$
K _ {1} = \frac {c (\mathrm{H} _ {3} \mathrm{O} ^ {+}) \bullet c (\mathrm{OH} ^ {-})}{c (\mathrm{H} _ {2} \mathrm{O})} = 1.8 \times 10 ^ {- 16}
$$

(2) 水中 $c(\mathrm{H}_{3}\mathrm{O}^{+}) = c(\mathrm{OH}^{-})$

$$
c (\mathrm{O} ^ {2 -}) = \frac {K _ {2} \cdot c (\mathrm{OH} ^ {-})}{c (\mathrm{H} _ {3} \mathrm{O} ^ {+})} = K _ {2} = 10 ^ {- 36} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
n (\mathrm{NaOH}) = c _ {\text {酸}} (V _ {1} - V _ {2}) = 0.100 \times (35.00 - 5.00) \times 10 ^ {- 3} = 3.00 \times 10 ^ {- 3} (\mathrm{mol})
$$
...
$$
n (\mathrm{Na} _ {2} \mathrm{CO} _ {3}) = c _ {\mathrm{酸}} V _ {2} = 0.100 \times 5.00 \times 10 ^ {- 3} = 5.00 \times 10 ^ {- 4} (\mathrm{mol})
$$

$$
\mathrm{Na} _ {2} \mathrm{CO} _ {3} \% = \frac {5.00 \times 10 ^ {- 4} \times \frac {100.00}{20.00} \times 106}{1.200} \times 100 \% = 22.1 \%
$$
...
$$
K _ {\mathrm{a} _ {4}} = \left[ \mathrm{H} ^ {+} \right] \left[ \mathrm{HCO} _ {3} ^ {-} \right] / \left[ \mathrm{H} _ {2} \mathrm{CO} _ {3} + \mathrm{CO} _ {2} \right] = 4.45 \times 10 ^ {- 7}
$$
...
$$
4.80 = \mathrm{p} K _ {\mathrm{a}} + \lg \frac {1.210}{1.496}
$$
...
$$
K _ {\mathrm{sp}} = \left[ \mathrm{Ag} ^ {+} \right] ^ {2} \left[ \mathrm{CrO} _ {4} ^ {2 -} \right] = \left[ 2.6 \times 10 ^ {- 4} \right] ^ {2} \times \left[ 1.3 \times 10 ^ {- 4} \right] = 8.8 \times 10 ^ {- 12}
$$
...
$$
S \times 0.01 = 1.08 \times 10 ^ {- 10}, S = 1.08 \times 10 ^ {- 8}
$$
...
$$
\left[ \mathrm{H} ^ {+} \right] = \sqrt {\frac {K _ {\mathrm{a} _ {1}} K _ {\mathrm{a} _ {2}} \left[ \mathrm{H} _ {2} \mathrm{S} \right]}{\left[ \mathrm{S} ^ {2 -} \right]}} = \sqrt {\frac {1.1 \times 10 ^ {- 21} \times 0.10}{3.4 \times 10 ^ {- 23}}} = 1.8 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
[ \mathrm{S} ^ {2 -} ] = \frac {K _ {\mathrm{sp}} (\mathrm{MnS})}{[ \mathrm{Mn} ^ {2 +} ]} = \frac {1.4 \times 10 ^ {- 15}}{0.010} = 1.4 \times 10 ^ {- 13} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$

此时 $[\mathrm{H}^{+}]$ 为

$$
\left[ \mathrm{H} ^ {+} \right] = \sqrt {\frac {K _ {\mathrm{a} _ {1}} K _ {\mathrm{a} _ {2}} \left[ \mathrm{H} _ {2} \mathrm{S} \right]}{\left[ \mathrm{S} ^ {2 -} \right]}} = \sqrt {\frac {1.1 \times 10 ^ {- 21} \times 0.10}{1.4 \times 10 ^ {- 13}}} = 2.8 \times 10 ^ {- 5} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
\mathrm{BaCO} _ {3} \rightleftharpoons \mathrm{Ba} ^ {2 +} + \mathrm{CO} _ {3} ^ {2 -} \quad K _ {\mathrm{sp}} (\mathrm{BaCO} _ {3}) = [ \mathrm{Ba} ^ {2 +} ] [ \mathrm{CO} _ {3} ^ {2 -} ] = 2.58 \times 10 ^ {- 9}\tag{①}
$$

$$
\mathrm{BaCrO} _ {4} \rightleftharpoons \mathrm{Ba} ^ {2 +} + \mathrm{CrO} _ {4} ^ {2 -} K _ {\mathrm{sp}} (\mathrm{BaCrO} _ {4}) = [ \mathrm{Ba} ^ {2 +} ] [ \mathrm{CrO} _ {4} ^ {2 -} ] = 1.6 \times 10 ^ {- 10}\tag{②}
$$
...
$$
K _ {3} = \frac {[ \mathrm{CO} _ {3} ^ {2 -} ]}{[ \mathrm{CrO} _ {4} ^ {2 -} ]} = \frac {K _ {\mathrm{sp}} (\mathrm{BaCO} _ {3})}{K _ {\mathrm{sp}} (\mathrm{BaCrO} _ {4})} = \frac {2.58 \times 10 ^ {- 9}}{1.6 \times 10 ^ {- 10}} = 16
$$
...
$$
K = \frac {[ \mathrm{SO} _ {4} ^ {2 -} ]}{[ \mathrm{CO} _ {3} ^ {2 -} ]} = \frac {K _ {\mathrm{sp}} (\mathrm{BaSO} _ {4})}{K _ {\mathrm{sp}} (\mathrm{BaCO} _ {3})} = \frac {1.07 \times 10 ^ {- 10}}{2.58 \times 10 ^ {- 9}} \approx \frac {1}{24}
$$
...
$$
\begin{array}{r l}&\mathrm {CaSO_ {4} + CO_ {3} ^ {2 - } \rightleftharpoons CaCO_ {3} + SO_ {4} ^ {2 - }}\\&K = K _ {\mathrm{sp}} (\mathrm {CaSO_ {4}}) / K _ {\mathrm{sp}} (\mathrm {CaCO_ {3}}) \approx 5.1 \times 10 ^ {3}\end{array}
$$
...
$$
n (\mathrm{CaC} _ {2} \mathrm{O} _ {4}) = n (\mathrm{CaCO} _ {3}) = 1.5 \times 10 ^ {- 3} \mathrm{mol}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/2b3d1c6705fbc1bb6ca8fc46afb8a0752076a797ccbe70fb0b265447d758cf74.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/86b3ce2ed13c7c9b46536d1c2ca6e7ba5688564c5a0a5bbb408e8c8fb357dae8.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3476bdb3ab8d853dd15bfa48d081359663fd4428b30c209f24cef55a907c17c8.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/540457a9a6eada87a4a441041e5b8db913629d627176832569021a4b60921b67.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/862439437d055dca0fcdecc4a852d8e49281d1ac3305948c6e7a5aeea230ff53.jpg)  
B.

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f823e46947bcb63ff7fb05dc272352728a65be6d35e94d942616d1cda2b0c7ea.jpg)  
C.

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f95de3996aff0f658c017fe8345b93a0e6d09dbd788e73aa4500dadeb04e711b.jpg)  
D.
...
$$
K _ {\mathrm{sp}} (\mathrm{Tl} _ {2} \mathrm{S}) = 10 ^ {- 20}, K _ {\mathrm{sp}} (\mathrm{CuS}) = 10 ^ {- 35} 。
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/146cfba04b2cdf71b21615c0f7620a1aafa901d913d163e78680d598d801acff.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/983239eed15d9bcf2ed1623e6f06e3c64444740c2b1286c4dec8edc88a68fbae.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/01928911814db6d0969b77a722235168f66d6da1b91a9ab20607511540e4fca2.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e2a888e8f424dba091244db16bb5823b0168aa072345e7e3cad6df0a70d5cc82.jpg)
...
$$
[ \mathrm{S} ^ {2 -} ] = \frac {K _ {\mathrm{sp}} (\mathrm{MnS})}{[ \mathrm{Mn} ^ {2 +} ]} = \frac {2.5 \times 10 ^ {- 10}}{0.10} = 2.5 \times 10 ^ {- 9} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1})
$$
...
$$
\begin{array}{r l} \left[ \mathrm{OH} ^ {-} \right] & = \sqrt {K _ {\mathrm{b}} \left[ \mathrm{S} ^ {2 -} \right]} = \sqrt {\frac {K _ {\mathrm{w}} \left[ \mathrm{S} ^ {2 -} \right]}{K _ {\mathrm{a} _ {2}} (\mathrm{H} _ {2} \mathrm{S})}} = \sqrt {\frac {1.0 \times 10 ^ {- 14} \times 2.5 \times 10 ^ {- 9}}{1.1 \times 10 ^ {- 12}}} \\ & = 4.8 \times 10 ^ {- 6} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1}) \end{array}
$$

$$
\begin{array}{r l} {[ \mathrm {Mn^ {2 + }} ] [ \mathrm {OH^ {-}} ] ^ {2}} & = 0.10 \times (4.8 \times 10 ^ {- 6}) ^ {2} = 2.3 \times 10 ^ {- 12} \\ & > K _ {\mathrm{sp}} [ \mathrm {Mn(OH) _ {2}} ] = 1.9 \times 10 ^ {- 13} \end{array}
$$
...
$$
\begin{array}{r l}&{\mathrm {H_ {2} CO_ {3}} \rightleftharpoons 2 \mathrm {H^ {+}} + \mathrm {CO_ {3} ^ {2 - }}}\\&{K = \frac {[ \mathrm {H^ {+}} ] ^ {2} [ \mathrm {CO_ {3} ^ {2 - }} ]}{[ \mathrm {H_ {2} CO_ {3}} ]} = K _ {\mathrm {a_ {1}}} K _ {\mathrm {a_ {2}}}}\\&{\qquad = 4.3 \times 10 ^ {- 7} \times 4.7 \times 10 ^ {- 11} = 2.0 \times 10 ^ {- 17}}\end{array}
$$

$$
\begin{array}{r l} {[ \mathrm{CO} _ {3} ^ {2 -} ] = \frac {K [ \mathrm{H} _ {2} \mathrm{CO} _ {3} ]}{[ \mathrm{H} ^ {+} ] ^ {2}} = \frac {2.0 \times 10 ^ {- 17} \times 0.034}{(3.2 \times 10 ^ {- 6}) ^ {2}}} \\ & {= 6.6 \times 10 ^ {- 8} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1})} \end{array}
$$

因此溶液中 $Ca^{2+}$ 可达到的最高浓度为

$$
[ \mathrm{Ca} ^ {2 +} ] = \frac {K _ {\mathrm{sp}} (\mathrm{CaCO} _ {3})}{[ \mathrm{CO} _ {3} ^ {2 -} ]} = \frac {2.8 \times 10 ^ {- 9}}{6.6 \times 10 ^ {- 8}} = 0.042 (\mathrm{mol} \cdot \mathrm{L} ^ {- 1})
$$
...
$$
[ \mathrm{Mg} ^ {2 +} ] = 0.050 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}; [ \mathrm{OH} ^ {-} ] = 1.8 \times 10 ^ {- 5} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}; \mathrm{pH} = 9.3
$$

$$
11. (1) ① \frac {\left[ c (\mathrm{HCl}) \times 0.04000 \mathrm{L} - c (\mathrm{NaOH}) \times V (\mathrm{NaOH}) \right] \times \frac {40.00 \mathrm{g} \cdot \mathrm{mol} ^ {- 1}}{2}}{0.3000 \mathrm{g}} \times 100\%
$$

② 不是

$$
\begin{array}{r l} & {(2) \textcircled {1} \mathrm {CaCO_ {3}} + 2 \mathrm{H} ^ {+} \longrightarrow \mathrm{Ca} ^ {2 +} + \mathrm{CO} _ {2} \uparrow + \mathrm{H} _ {2} \mathrm{O}} \\ & {\quad \mathrm{Ca} ^ {2 +} + \mathrm{C} _ {2} \mathrm{O} _ {4} ^ {2 -} \longrightarrow \mathrm{CaC} _ {2} \mathrm{O} _ {4} \downarrow} \\ & {\quad \mathrm{CaC} _ {2} \mathrm{O} _ {4} + 2 \mathrm{H} ^ {+} \longrightarrow \mathrm{Ca} ^ {2 +} + \mathrm{H} _ {2} \mathrm{C} _ {2} \mathrm{O} _ {4}} \\ & {\quad 2 \mathrm{MnO} _ {4} ^ {-} + 5 \mathrm{H} _ {2} \mathrm{C} _ {2} \mathrm{O} _ {4} + 6 \mathrm{H} ^ {+} \longrightarrow 2 \mathrm{Mn} ^ {2 +} + 10 \mathrm{CO} _ {2} \uparrow + 8 \mathrm{H} _ {2} \mathrm{O}} \\ & {\quad \text {即} 1 \mathrm{molCaCO} _ {3} \sim 1 \mathrm{molCa} ^ {2 +} \sim 1 \mathrm{molH} _ {2} \mathrm{C} _ {2} \mathrm{O} _ {4} \sim \frac {2}{5} \mathrm{molKMnO} _ {4}} \\ & {\quad w (\mathrm{Ca}) = \frac {5}{2} c (\mathrm{KMnO} _ {4}) \times V (\mathrm{KMnO} _ {4}) \times \frac {40.00 \mathrm{g} \cdot \mathrm{mol} ^ {- 1}}{0.3000 \mathrm{g}} \times 100 \%} \end{array}
$$
...
$$
c (\mathrm{Ca} ^ {2 +}) = 0.10 \mathrm{g} / (40 \mathrm{g} \cdot \mathrm{mol} ^ {- 1} \times 1.4 \mathrm{L}) = 1.8 \times 10 ^ {- 3} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$

$$
c \left(\mathrm{C} _ {2} \mathrm{O} _ {4} ^ {2 -}\right) = K _ {\mathrm{sp}} / c \left(\mathrm{Ca} ^ {2 +}\right) = 2.3 \times 10 ^ {- 9} / 1.8 \times 10 ^ {- 3} = 1.3 \times 10 ^ {- 6} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
\begin{array}{r l} & \mathrm {Zn(s) + Cu^ {2 + } (aq)\longrightarrow Zn^ {2 + } (aq) + Cu(s);} \\ & \Delta_ {r} H _ {m} ^ {\ominus} (298 \mathrm{K}) = - 281.66 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} \end{array}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/cd9809e7ef4cff7f4b453bee264e8bf81d12b2bae4577409a3573ebdab677a15.jpg)
...
$$
2 \mathrm{KMnO} _ {4} + 10 \mathrm{KCl} + 3 \mathrm{H} _ {2} \mathrm{SO} _ {4} \longrightarrow 2 \mathrm{MnSO} _ {4} + 5 \mathrm{Cl} _ {2} \uparrow + \mathrm{K} _ {2} \mathrm{SO} _ {4} + 8 \mathrm{H} _ {2} \mathrm{O}
$$
...
$$
\lg K ^ {\ominus} = \frac {z E _ {\mathrm{MF}} ^ {\ominus}}{0.0592}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4560329f3df5e72a1a951ebb61560c1d7fbde6228395ebc48f076c60f259a376.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/fe5d821f5697c96168b75ddf16d80d0cf12bd18f00f2a79cac3f590ed8038980.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d75dca505ba9cfe91aab4673382c6aedf5696350163aa1d9434fb990bad249f6.jpg)  
KOH溶液
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/9e6b039f4c35f821bd695cc3fc363e5eebf130400ab0c33a536aef4de2465c55.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4d328c5237526c9656a030822a4a4d32491d09274abc7f36b3b97a33a88b7dcd.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f968dfc4e6857c3c40c72cfddb0dbb8d9042ef277f7e2478a3197e1df967a306.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/c2b92a66de31845b4649baa9a7ed2bd56d9dce37e0c0e649894f8c2362e23fef.jpg)
...
$$
63.55 n _ {\mathrm{Cu}} + 107.9 n _ {\mathrm{Ag}} + 52.00 n _ {\mathrm{Cr}} = 1.500
$$

$$
n _ {\mathrm{Cu}} = 0.0143 \mathrm{mol} n _ {\mathrm{Ag}} = 0.0042 \mathrm{mol}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0afdd7ae740da7ecc34c24962966ebc809806981cb02ec4a298ed0420ed299a2.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/56aeff499338d878d759c08bb557912a28b9d697af891813593af70d550e4f49.jpg)  
锂锰复合氧化物正极材料的理想晶体的结构示意图

## 参考解答 1.

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8b2fa0d1f2aa0bfc6013996ac06d339f62d8fbf3400f9ca453c6caf3bc0f0b8a.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/052808623823ce0502690b3b8607d3704f9fb8530c3428fc07606257566d52f8.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/83f35be7f8183284623971afa32f2f84c825ba13b2d8cf09b82227cbbe84f2d4.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3350bab475bbde48b9a917ba11d4da681a911686cb675ebe62cc6842b000787e.jpg)

【例 1】（2006 年江苏高考）用太阳光分解水制氢是未来解决能源危机的理想方法之一。某研究小组设计了如下图所示的循环系统实现光分解水制氢。反应过程中所需的电能由太阳能光电池提供，反应体系中 $I_{2}$ 和 $Fe^{3+}$ 等可循环使用。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/16307f0a8872945b9098e1b933f8dea8efc749461119969206249e21e5d6df7c.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/585c87057fd0c14e21d406c911e3ec207ebdd0123990681ec90d1073ba36d56f.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/881bf42ac01a113629e4c7494b27dfcc0affa457a3d8688cf89e929cd66aaf7d.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0684d4c0b2902f0ef1d333845e6c9b02fccc22beea4e653a97c3d54c71aec175.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/2842cf81c372431f302ea1428ef87d07c336b1025bd6aed3a01ff0cf09304196.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e43abeb660000d332fae14dcee0635f695ac639f4ffbf39ed8f3fceb3937897e.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0a79dab6525d836b40f3ed3518f8144971c71c7aff14310c93b702d0f3469e50.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3d587d0a39691bd8635cde16273cca4e9ecbe75ecacf4b948eb2025962afee65.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b4ae46cd9f5fac532c57aae771672ef28cf288b2593b7a335a9bc305ef1c674f.jpg)  
A

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/34a5815e24ff732f437d8c2a1ffd03f6e7a974eb4468f081de32cb1bb957530e.jpg)

B

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/16fea93236d787b519af80b4ff2f224d503880433466f71259b57e9254914328.jpg)

C

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e962dc5bdf5c269dea53f5f09d14352c9b55fe9ad60a5f508dc3deec395f561d.jpg)  
D
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/bfb0bf83ebcc8279957532004dc846b0577925923b6bf511fbfb6c354176698d.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/00008df042056a0f115eb9ce203e1c81b64ea29866404125b679006c08158344.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/9b5767daad98fc79c560048c041efbcfa66a6549c31178223ab7ba2674f69aaa.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/89308fdf9190d40e9c129841c3ea508f497b5854a2d634a8a2b9eb3e32e6a82b.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e82a815830ca5ef1f250218a08b4e7a298149306df5c81fc8eb895ec0a98205a.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0dc0074c18ac2c215e973f722ff78d21771ce76d960ce9502d4df9ebaef56652.jpg)  
甲  
乙  
丙
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b90a70536a72511d53dfc251b1034a66547bff09586e27593981a0e0523f3458.jpg)  
NaOH 隔膜 NaOH
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/2f44e47e200272689edae95d8db6af28e44722308998fe8189268697a07ed0f5.jpg)
...
$$
Q _ {\mathrm{实}} = \frac {Q _ {\mathrm{理}}}{\eta} = \frac {\frac {100}{27} \times 3 \times 96   500}{0.800} \mathrm{C} = 1.34 \times 10 ^ {6} \mathrm{C} t = \frac {Q _ {\mathrm{实}}}{I} = \frac {1.34 \times 10 ^ {6}}{80 \times 3600} \mathrm{h} = 4.65 \mathrm{h}
$$
...
$$
n _ {\mathrm{H} _ {2}} = n _ {\mathrm{Cu} ^ {2 +}} = c _ {\mathrm{EDTA}} V _ {\mathrm{EDTA}} = 0.05115 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \times 0.05312 \mathrm{L} = 2.717 \times 10 ^ {- 3} \mathrm{mol}
$$

$H_{2}$ 在给定条件下的体积为

$$
\begin{array}{r l} V _ {\mathrm {H_ {2}}} & = \frac {n _ {\mathrm {H_ {2}}} \times R \times T}{p} = \frac {2.717 \times 10 ^ {- 3} \mathrm{mol} \times 8.314 \mathrm{J} \cdot \mathrm{K} ^ {- 1} \cdot \mathrm{mol} ^ {- 1} \times 298.2 \mathrm{K}}{1.01325 \times 10 ^ {5} \mathrm{Pa}} \\ & = 66.48 \mathrm{mL} \end{array}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/7461a189b861814906d28f544a7b5b1537bf7de7efeba2bb7fe6dbe0554f7c60.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3a7a2525d5f875c25717e662f0e9bc62ec8c6e280c969a7008d52c10226af62a.jpg)

由双基配体或多基配体形成的具有环状结构的配合物称螯合物(如下图所示)。含五元环或六元环的螯合物较稳定。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/66b1bd74fa78c7e1ea10843164b75490be0092e0a1cb7c2cf095eeffd611c561.jpg)
...
<table><tr><td> $F^{-}$ </td><td>氟</td><td> $Cl^{-}$ </td><td>氯</td></tr><tr><td> $OH^{-}$ </td><td>羟基</td><td> $CN^{-}$ </td><td>氰</td></tr><tr><td> $NO_{2}^{-}$ </td><td>硝基</td><td> $ONO^{-}$ </td><td>亚硝酸根</td></tr><tr><td> $SO_{4}^{2-}$ </td><td>硫酸根</td><td> $NH_{3}$ </td><td>氨</td></tr><tr><td>Py</td><td>吡啶 <img src="images/59570523be437652a8559594d2cf37401d9e9a32741a7b0572d682a9e9a83edd.jpg"/></td><td>en</td><td>乙二胺</td></tr><tr><td> $Ph_{3}P$ </td><td>三苯基膦</td><td>NO</td><td>亚硝酰</td></tr><tr><td>CO</td><td>羰基</td><td> $H_{2}O$ </td><td>水</td></tr></table>
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f5bd25e455e603a6c0b973cc9b8a641ea511192d1b5ea8ca71fe31a43d48a90e.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4d1413838954136fc8459094d72b42aff40f14508268d72efc40be8621d1bb94.jpg)

反式

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a770c18c6fd60ab0be39d2563774766e43da19224eab0a40b172f8177b272efd.jpg)

顺式

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/619749c7a04916adf0305e202e2221e8d83b29745200f89563a5707c8fcf5565.jpg)

一反二顺 3 种

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e21e32c8226b99abed9b94abcb83357d8fe438d3c92d59764c44419e0cd55566.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1e338de357e74124f927e962a668e40bb0e61d4f16443ee5498842a58ffb6eac.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/80427147305a3e81a73c9d16b642787263f74e4c25bf5741fbcf5c7424372c5d.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ceefa1b4d6d42d2455b473a9668b954f960ea79136e440a6afafa2bf40c2b892.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/73730d48e71d52673311906784def79f540a734f75523c35032cacb7c86a4271.jpg)

六配位的八面体结构的顺式 $M_{2a2b2c}$ 也有旋光异构体, 如下图所示:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b5f87b8a0d0b59495817654ab10e8c77b262d385f92bfe855b2d8934faa71584.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d5fd0e03a826e032acd019e2057b9dacb437bfed3b4757e119f155706203a3b8.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/78ec86670788c24856ff76d8c1faf2dd6cfc29cbee81382b79cfbb9cdf8bc81b.jpg)  
(I)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1252ca4d1e2c7690c2996d05e6133c0618deec1cab1c98c9cfcd9d7ee7391e53.jpg)  
(Ⅱ)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/06613b6f6a1de7d64040c7cae2806af90c6b2dd59710f397d93869c78cf4e984.jpg)  
(Ⅲ)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/60e00a84317fad5ef89e390d28c62d399121d6574f418faf9b63095fcce7d732.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4df974af9760bc286c2e4c66b41c9ca7ef59f250d281131d778dadcc3390c505.jpg)

所以 $\left[M(AB)_{2}cd\right]$ 有6种几何异构体,其中5种有旋光异构体。参考解答 见上所述。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/509be9c2b16bfdcc3c1d7347c4c1f13eb1b4ca78b815363508eff50814f178cb.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/80bd9e0d5599be576500aaf9732c46ba66669c0b45f8778409d8f2c8fb9454da.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/96ba3b639aba43554cbcc674282c35585a4def49736b0f347a906dbab11ebd6c.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d59c155a7b469c0f27f60977390bb5b1aedeeb826e580d95393e253d64a0cc35.jpg)

其中 Met 结构简式为: $CH_{3}-S-CH_{2}-CH$ COOH

NH $_{2}$

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b9912f93cad7f7c19c2a227225ab22e2f07975d3a7c7623b68bd5920cd699eb8.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/7b5d0cc8df826b831a6cf9800c99f1dbffcb309e5e89754ca5df70839573f71a.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1357878fc8ad472d3bef9fa29aec64f786e4517cbd5225b57ca58bea0300dd2c.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/fe2cc4287f75c5b5f20e1267f5b6046d39d30cdd0e04a2196027a8ade9a89525.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a43d64883682a587dda55810c2047e97724d90193150b180999080d61ff9a66c.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/57904d1ca5fdde0cacf86480991cf341e788f627dd2b098dcfc3025edb01a34a.jpg)

(2)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/04358362cdd24d00fa7e63c92521d97cc0ab7b31093304171b5a0418f3038fef.jpg)

(3)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/68392ef976a52b1f4ef7362dff81618e505c9a4ed0b3e875f7fc859882a3b125.jpg)

已知反位效应： $Br^{-}>Cl^{-}>NH_{3}>Py$ 。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/6eeb381dd08f635e5b38ce590b185fab24f7f3a2d8a489a8098cf0bbb327b648.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0dc1583cf66968c6f5416d026c49817a1f544003bdb4e57c959057ee86821a19.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/c99b53aabaa2e8a7417fab32ce1898b7eb49508d9e53e9efb7c3bdeb852edb44.jpg)

(2) $\left[\mathrm{Co}\left(\mathrm{NH}_{3}\right)_{3}(\mathrm{OH})_{3}\right]$ 几何构型为八面体, 有两种几何异构体:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d30ede147718015d2652dcca4a27bc934961e5a012f49ddcaefc583d35c4323c.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1248608f40010ad9cc90a4a40aca1e721a7a639c8823d26c6536eb0aaa22248d.jpg)

(3) $\left[\mathrm{Pt}\left(\mathrm{NH}_{3}\right)_{2}\left(\mathrm{OH}\right)_{2}\mathrm{Cl}_{2}\right]$ 几何构型为八面体,有五种几何异构体:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f339fb8e4fd24a1d84ec241afd6331e86347218ffa55afaa938b40c794d9c942.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/2da1a5762447229cc8e211ecba0136ecf94c509a77a38b3a0fa7675be6d7464c.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/5b77d042dac64ed37fdf92acefbdabf36b75ba78c670a5c4cc1b805220a77d61.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a341108493caac2a7f51be3a00dbd69eb979ba07e9a3460bb97b92f0755c038a.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3f5e555e65446543298e0ffff976ac60cd12fcb0eefedc0ee1b6cae3a2942c39.jpg)

(4) $\left[FeCl_{2}(C_{2}O_{4})(en)\right]^{-}$ 几何构型为八面体,有两种几何异构体:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f138e865343f7bb1c950899a7686b063c5e60b5be5ff4096d17577f99f767280.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/7aa8700241989702d1e1774db0b81381d4717ecb2acf3d8cffcaf6e8522b6dac.jpg)

(5) $\left[\mathrm{Pt}\left(\mathrm{CO}_{3}\right)\left(\mathrm{NH}_{3}\right)(\mathrm{en})\right]$ 几何构型为平面四边形, 没有几何异构体:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0cc89c0dea8b0ad442cd98f6eaeddc58cc4aa6bd2395735e44fed212ab1096ec.jpg)

(6) $\left[\mathrm{Pt}(\mathrm{Py})(\mathrm{NH}_{3})\mathrm{ClBr}\right]$ 几何构型为平面四边形, 有三种几何异构体:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a20179b92fe68224e82522bbb319dcfc5a6d8a9f3477eb7e3986000dd4e4fd16.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b389301abf45f92330c548907060f7601a07b60d1e7c8ced1ab8f8aff07e15aa.jpg)  
顺式  
反式

9. (1)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/bee9ca8160c037441e32f5b43de92c732a3480ca6b1e8b2c575100f883cae379.jpg)

(2) B:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/49d6b2454a37690e462c8c4792d31641c9c3142ae7658c07aaea78bdba3082de.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e2f6a5b4c65258f0b0b61484b1929b798e664ac14b67d7688f8a8fd647522d73.jpg)

(3) 涉及到络合平衡的稳定常数和 B、C 间的异构体互变平衡常数, 它们的关系如下:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8b4c7d5a4c5e16009fb5b9c3ea4f10363cc667bc407bc70f393643e2d0d7e9df.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/40a54533ada0cba4d187b642c1b0cc8a276a401fc6f87278ca973ff3e3a7c735.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/86b9b933970f2b2e6a90ca84f8941312c0a1d67e4dd9143ff3aac04d98ade03c.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/00c8fe6a10f19c78c2a99ae5d662b26184b23ead9bfb04bb6e5eccdfb4efd07c.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f83a530a8de2e75c58648704a717433e5184233ae021621c60b9b98860daf4c4.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d4a4d129a17f06867145aa3c785a9b2a051dd81274e7dc37f1411ed71d16a7b7.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/24a151b9448b53f2fcadabb9d7273b416856b6cd84d87445e768dc03a4a62c95.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/be3dd622024d215feef03b74009770f429e034a15528448fb8e262bd05d1b21d.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/fd6abf622becdfe6b69e1173412768afa47a1df34e893ac7d697041726ccc586.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/fa2a470717a92572756f3263e2acf909810bfc4b2de73976de4311c7157a399f.jpg)
...
(3)  
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/4c0faf85f88c0f3b377375fe7b87123e3d0cccdfb402636013ebf442e7f4d448.jpg)

(4) 有很好的配位能力, 具有某些特殊的催化性能

13. (1) A:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/005f2b583773d900b0509420c66a2e30ed0c3ca79e93ac8fc04cc6b53d86a625.jpg)

B:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/318b0691c6eb9878554b6d5235cb7cdc0a5f9782ff55418d81ef75c996d9990c.jpg)

C:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b3eae7336859a9e4e6d4568b732ec74932639a4f95c655f937478398b4573064.jpg)

D:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/6f2ae1332ba5da4e479e12c8082faaa6f230844cc9c82140116d708c4407efc3.jpg)

E:

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ea57bcd4d798b019cbae4219f8ec76a840b2405ea5e77345b77b728913bf5e19.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a31e977ae287ea19f7ee90e8b802703c946e6dbc8a8d30e5a767490379d32c27.jpg)

A

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/aabfe41268e1f3a8c7f97a041c85ba27454c77437bf1440d6d5235081c7b907e.jpg)

B

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/82aa20f2f19103ed89bf5b863ecc592a11e144a8531555c89dd1e917539e16bb.jpg)

C

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f74319bfb4ea75635e678e546ed6f5afad339707529364f20dd8c5855e712d32.jpg)
...
15. (1)  
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d05e2a66e8895c31f3d7d730274873a3f4df6d02831c5dd262972cf413008b35.jpg)

## 知识要点

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/7e85e6855f9885f0a477c711e58e0c670d67695eacf6ccfff7e2f18e5f00f1cd.jpg)
...
$$
\begin{array}{r l} & 2 \mathrm{NH} _ {4} \mathrm{VO} _ {3} \xrightarrow {873 \mathrm{K}} \mathrm{V} _ {2} \mathrm{O} _ {5} + 2 \mathrm{NH} _ {3} \uparrow + \mathrm{H} _ {2} \mathrm{O} \uparrow \\ & 2 \mathrm{VOCl} _ {3} + 3 \mathrm{H} _ {2} \mathrm{O} \longrightarrow \mathrm{V} _ {2} \mathrm{O} _ {5} + 6 \mathrm{HCl} \end{array}
$$
...
$$
\mathrm{K} _ {2} \mathrm{Cr} _ {2} \mathrm{O} _ {7} + 14 \mathrm{HCl} \xrightarrow {\triangle} 2 \mathrm{KCl} + 2 \mathrm{CrCl} _ {3} + 3 \mathrm{Cl} _ {2} \uparrow + 7 \mathrm{H} _ {2} \mathrm{O}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/42d83ed5576176842759acedc9d77b5b0e8a20b26294990325368d7f037caa4b.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ba2d13e546d96573d95ebe13994d69eec4f5d13512c1b4a80091bf80c751033f.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/01a6d80dc73c5285cc957f04900d023078694e7ffdaac8929c9f13b7477a8577.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/da663ca9285bce0e3663f7f46124716ee371f031e49d658e53bf942c398fbd13.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3e44261a5f3aee943e9b9c7700ee53bfab4c974596eb3d266f5a404e4458de33.jpg)  
e
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/3cdbfa92449bfc52e1b09f4c600163059d122206ad08bf0c57892759ed8342ae.jpg)  
注：钛铁矿的化学式为 $FeTiO_{3}$ 。
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f37b9ed93a8b7352bdb20966bf64f1144deec50209ef9074cff7f61c2a53acec.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/79ccceed09f01f11d726ec182f879893c83b04dd24fd1ea9b16c40fddb1710a2.jpg)
...
$$
\begin{array}{r l} & (\mathrm{VO} _ {2}) _ {2} \mathrm{SO} _ {4} + 2 \mathrm{NaOH} \longrightarrow \mathrm{V} _ {2} \mathrm{O} _ {5} \downarrow + \mathrm{Na} _ {2} \mathrm{SO} _ {4} + \mathrm{H} _ {2} \mathrm{O} \\ & \mathrm{V} _ {2} \mathrm{O} _ {5} + 6 \mathrm{NaOH} \longrightarrow 2 \mathrm{Na} _ {3} \mathrm{VO} _ {4} + 3 \mathrm{H} _ {2} \mathrm{O} \\ & (\mathrm{VO} _ {2}) _ {2} \mathrm{SO} _ {4} + \mathrm{SO} _ {2} \longrightarrow 2 \mathrm{VOSO} _ {4} \\ & 10 \mathrm{VOSO} _ {4} + 2 \mathrm{KMnO} _ {4} + 2 \mathrm{H} _ {2} \mathrm{O} \longrightarrow 5 (\mathrm{VO} _ {2}) _ {2} \mathrm{SO} _ {4} + 2 \mathrm{MnSO} _ {4} + \mathrm{K} _ {2} \mathrm{SO} _ {4} + 2 \mathrm{H} _ {2} \mathrm{SO} _ {4} \\ & 2 \mathrm{AgNO} _ {3} + 2 \mathrm{NH} _ {3} \cdot \mathrm{H} _ {2} \mathrm{O} \longrightarrow \mathrm{Ag} _ {2} \mathrm{O} \downarrow + 2 \mathrm{NH} _ {4} \mathrm{NO} _ {3} + \mathrm{H} _ {2} \mathrm{O} \\ & \mathrm{Ag} _ {2} \mathrm{O} + 4 \mathrm{NH} _ {3} \cdot \mathrm{H} _ {2} \mathrm{O} \longrightarrow 2 [ \mathrm{Ag(NH} _ {3}) _ {2} ] ^ {+} + 2 \mathrm{OH} ^ {-} + 3 \mathrm{H} _ {2} \mathrm{O} \end{array}
$$
...
$$
\begin{array}{r l} & (2) 2 \mathrm{BaCrO} _ {4} + 16 \mathrm{HCl} (\text {浓}) \longrightarrow 2 \mathrm{CrCl} _ {3} + 2 \mathrm{BaCl} _ {2} + 3 \mathrm{Cl} _ {2} \uparrow + 8 \mathrm{H} _ {2} \mathrm{O} \\ & (\text {绿色}) \end{array}
$$

$$
\begin{array}{r l} & {(3) 3 \mathrm{Zn} + \mathrm{Cr} _ {2} \mathrm{O} _ {7} ^ {2 -} + 14 \mathrm{H} ^ {+} \longrightarrow 3 \mathrm{Zn} ^ {2 +} + 2 \mathrm{Cr} ^ {3 +} + 7 \mathrm{H} _ {2} \mathrm{O}} \\ & {\quad (\text {橙色}) \qquad \qquad (\text {绿色})} \\ & {\mathrm{Zn} + 2 \mathrm{Cr} ^ {3 +} \longrightarrow \mathrm{Zn} ^ {2 +} + 2 \mathrm{Cr} ^ {2 +} (\text {蓝色})} \\ & {4 \mathrm{Cr} ^ {2 +} + \mathrm{O} _ {2} + 4 \mathrm{H} ^ {+} \longrightarrow 4 \mathrm{Cr} ^ {3 +} + 2 \mathrm{H} _ {2} \mathrm{O}} \end{array}
$$
...
$$
\begin{array}{r l} {[ \mathrm{OH} ^ {-} ] =} & {\sqrt [ 3 ]{\frac {K _ {\mathrm{sp}} ^ {\ominus}}{[ \mathrm{Cr} ^ {3 +} ]}} = \sqrt [ 3 ]{\frac {6.3 \times 10 ^ {- 31}}{1.0 \times 10 ^ {- 5}}} = 4.0 \times 10 ^ {- 9} (\mathrm{mol} \cdot \mathrm{L} ^ {- 1})} \\ & {\mathrm{pOH=8.40}} \end{array}
$$

$$
\mathrm{pH} = 14 - \mathrm{pOH} = 5.60
$$
...
$$
\begin{array}{r l} 6.3 \times 10 ^ {- 31} \times 6.3 \times 10 ^ {29} & = \frac {0.10}{[ \mathrm{OH} ^ {-} ]} \\ [ \mathrm{OH} ^ {-} ] & = 0.25 (\mathrm{mol} \cdot \mathrm{L} ^ {- 1}) \\ [ \mathrm{OH} ^ {-} ] _ {\text {起始}} & = 0.25 + 0.10 = 0.35 (\mathrm{mol} \cdot \mathrm{L} ^ {- 1}) \end{array}
$$

12. $\mathrm{I}_2 + 2\mathrm{Na}_2\mathrm{S}_2\mathrm{O}_3 \longrightarrow \mathrm{Na}_2\mathrm{S}_4\mathrm{O}_6 + 2\mathrm{NaI}$

$$
\begin{array}{r l} & \mathrm {Cr_ {2} O_ {7} ^ {2 - } + 6 I ^ {-} + 14 H ^ {+} \longrightarrow 2Cr^ {3 + } + 3 I _ {2} + 7 H _ {2} O} \\ & 2 \mathrm {S_ {2} O_ {3} ^ {2 - }} \sim \mathrm {I_ {2}} \sim 1 / 3 \mathrm {Cr_ {2} O_ {7} ^ {2 - }} \sim 2 / 3 \mathrm{A} \\ & 9 \mathrm{mmol} \quad 4.5 \mathrm{mmol} \quad 1.5 \mathrm{mmol} \quad 3 \mathrm{mmol} \\ & 465 / M _ {\mathrm{A}} = 3 \qquad M _ {\mathrm{A}} = 155 \end{array}
$$
...
$$
4 \mathrm{CrO} _ {5} + 12 \mathrm{H} ^ {+} \longrightarrow 4 \mathrm{Cr} ^ {3 +} + 7 \mathrm{O} _ {2} \uparrow + 6 \mathrm{H} _ {2} \mathrm{O}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/33f19c6c67164f33e8c6049b50dbb32d0029a0a67822395874e66bf0a954af2d.jpg)
...
$$
\begin{array}{r l} & {\mathrm{(1)制备:} 4 \mathrm{CuO(黑)} \xrightarrow {1273 \mathrm{K}} 2 \mathrm{Cu} _ {2} \mathrm{O(红)} + \mathrm{O} _ {2} \uparrow} \\ & {\mathrm{Ag} ^ {+} + \mathrm{OH} ^ {-} \longrightarrow \mathrm{AgOH} \downarrow (\text {白}), 2 \mathrm{AgOH} \longrightarrow \mathrm{Ag} _ {2} \mathrm{O(棕黑)} + \mathrm{H} _ {2} \mathrm{O}} \end{array}
$$
...
$$
2 \mathrm{AgNO} _ {3} \xrightarrow {440 ^ {\circ} \mathrm{C}} 2 \mathrm{Ag} + 2 \mathrm{NO} _ {2} \uparrow + \mathrm{O} _ {2} \uparrow
$$
...
|  | 与碱土金属元素及铜族元素对比 | 原因 |
| --- | --- | --- |
| 主要物理性质 | 锌族元素单质的熔点、沸点、熔化热和气化热等不仅比碱土金属低,而且比铜族金属低 | 可能是由于最外层s电子成对后趋于稳定的缘故,而且这种稳定性随着原子序数的增加而增高。在汞原子里,这对s电子最稳定,所以金属键最弱,故在室温时仍为液体 |
| 化学活泼性 | 锌族元素的金属性不及碱土金属但比铜族强,单质的活泼性Zn>Cu,Cd>Ag,Hg>Au。IIA族金属能从稀酸和水中置换出氢气。IIB族不能从水中置换出氢气,在稀的盐酸或硫酸中,锌易溶解,镉较难,汞则不溶解 | 锌族的标准电极电势值比同周期的铜族元素负些,比同周期的碱土金属正些。锌族18电子层结构对原子核的屏蔽作用较小,锌族元素的电负性和电离能都比碱土金属大 |
| 氧化数 | 碱土金属和锌族元素一般只有+2一种氧化态 | 锌族元素原子结构特征为(n-1)d10ns2,IIA族元素原子结构特征为ns2 |
| 键型及配合的倾向 | IIB族元素的化合物所表现的共价性比IIA族元素大。IIB族离子形成配合物的倾向比IIA强得多。由于锌族金属的离子(M2+)d轨道已填满,电子不能发生d-d跃迁,因此其配合物一般无色 | IIB族元素的离子具有18电子构型,有较强的极化力,本身变形性也大 |
...
$$
\begin{array}{r l} & 3 \mathrm{HgS} + 8 \mathrm{H} ^ {+} + 2 \mathrm{NO} _ {3} ^ {-} + 12 \mathrm{Cl} ^ {-} \longrightarrow 3 [ \mathrm{HgCl} _ {4} ] ^ {2 -} + 3 \mathrm{S} + 2 \mathrm{NO} \uparrow + 4 \mathrm{H} _ {2} \mathrm{O} \\ & \quad \mathrm{HgO} + \mathrm{Na} _ {2} \mathrm{S(浓)} \longrightarrow \mathrm{Na} _ {2} [ \mathrm{HgS} _ {2} ] \\ & \quad \mathrm{HgS} + 2 \mathrm{H} ^ {+} + 4 \mathrm{I} ^ {-} \longrightarrow [ \mathrm{HgI} _ {4} ] ^ {2 -} + \mathrm{H} _ {2} \mathrm{S} \uparrow \end{array}
$$
...
$$
\mathrm{Hg} ^ {2 +} + \mathrm{Hg} \rightleftharpoons \mathrm{Hg} _ {2} ^ {2 +} \quad K = 166
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/6cb260bd32b55ec0fe166ecbea45c3af90090a1ec293330e911dd257073800e7.jpg)

(3) (根据 VSEPR 理论, 可预言) $NO_{2}^{-}$ 为角型, 夹角略小于 $120^{\circ}$ , N 取 $sp^{2}$ 杂化轨道。

(4)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/510dda9255e708da508d00c7f825e017364b39634cee2aaa1ff94b91d46089fd.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b657e2a49505025801fb4b7781f020e53cb206509ee5005a5bf359eba1a391f1.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ec431ef008ca3c27312e597ee55699dc1e943803aebcf4d153cf50ae39415eac.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/60dbe57ef0ae93c89815a7b5763bf95018c336d8d64be97e7e560d38e148ab39.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/86f3debe037d361d0888640820841cdc6a096bcb8f218779d5f104991c433ce7.jpg)
...
$$
\frac {100 \times 10 ^ {- 3}}{52} \times 5 \times 278 = 2.67 (\mathrm{g})
$$
...
$$
[ \mathrm{OH} ^ {-} ] = \sqrt [ 3 ]{\frac {1.1 \times 10 ^ {- 36}}{\frac {3 \times 100 \times 10 ^ {- 3}}{52}}} = 5.8 \times 10 ^ {- 12} \quad \mathrm{pH} = 2.76
$$
...
$$
[ \mathrm{OH} ^ {-} ] = \sqrt {\frac {1.6 \times 10 ^ {- 14}}{1 \times 10 ^ {- 5}}} = 4.0 \times 10 ^ {- 5} \quad \mathrm{pH} = 9.60
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b3af51e725f588123803fd1d987eb86b00abcfca5a6a8623165d605dd2fc3503.jpg)

(3) $2\mathrm{NF}_3 + 2\mathrm{Hg}\xrightarrow{\triangle}\mathrm{N}_2\mathrm{F}_2 + 2\mathrm{HgF}_2$

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f3e9e49f651f358e00c0e03f84977066dc36231e98a0b40ab7e961ab4553d4da.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/477d3e44c72bee21e68626df0163f6f5e31e001f2b62d5441ec55c2999be30b8.jpg)
...
$$
\mathrm{M}: \mathrm{CsAu}; 3 \mathrm{CsAu} + 4 \mathrm{HNO} _ {3} + 15 \mathrm{HCl} \longrightarrow 3 \mathrm{HAuCl} _ {4} + 3 \mathrm{CsCl} + 4 \mathrm{NO} \uparrow + 8 \mathrm{H} _ {2} \mathrm{O}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e3f4da675403f2d751ce49fec353e606802541e244afef15179d284b71789498.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/a39cfc9473cc110e657ff699f46c5e8c3507adcdf1666b75ffa00e45050ef49f.jpg)  
2,4,6-三甲基-3-乙基庚烷
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/930de4b68f010b6557f3935463635b770f79ee66bf57aefa4e6c47903b403fe0.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/27a1bb5954a37fb6bb980216d50d8b1dd73af26f08a59773a37c99812fcca857.jpg)

连有取代基的环烷烃,命名时使取代基的编号最小。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b21afa32b7d721d9b29500e4942edc99c88fd4e4d05e80f343f7130492ea9a0c.jpg)

1-甲基-2-乙基环丙烷

取代的不饱和环烃,要从双键或叁键开始编号,并使取代基有较小的位次。

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1cee41f5c506b65d35545ffe65b37a3616d5410b3a04440ea8c4d79143074d58.jpg)  
4-乙基环己烯

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/661c6150bdff17dd870f3696651f73a8d9c9f64dcdc73e28ea61a84250cd5ce4.jpg)  
2-甲基-5-异丙基-1,3-环己二烯
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/f53c88324b398512f3e377a574577bfbb2c7e36e77d797e708c77ec2699edd4b.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e32ba0d46aac112a9cbc7f997a65632f6e25fdf666e726a3e5f4006b69893e23.jpg)  
螺[2,4]庚烷

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/266579088582cd3e8fc8c8e3a0116c62353a8fd1e3bf1aaca5e3b45e74c35b62.jpg)  
1,5-二甲基螺[3,4]辛烷
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ebc4d16e8d8e73f5ec452cc77ba633825a4cc428885ddcb860ebadc70214b803.jpg)

3-甲基苯酚(或称间甲基苯酚)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/49896e36972855033f1f71cfd7c3991fe1451c31633d6e7491290295571b2a48.jpg)

$H_{3}C-\text{CHO}$ 4-甲基苯甲醛(或称对甲基苯甲醛)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/bf5082f180ac4931b5d6577e2a5551961258a9b41c495754a882418a09719e73.jpg)
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/e2b52be90696c2b94aec00ab112708914034c6d4723b5cab6fab93056097d374.jpg)
...
$$
\text {例如:} \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{CH} _ {2} \mathrm{CH} _ {3} \xrightarrow {500 ^ {\circ} \mathrm{C}} \left\{ \begin{array}{l l} \mathrm{C} _ {3} \mathrm{H} _ {6} + \mathrm{CH} _ {4} \\ \mathrm{C} _ {2} \mathrm{H} _ {4} + \mathrm{C} _ {2} \mathrm{H} _ {6} \\ \mathrm{C} _ {4} \mathrm{H} _ {8} + \mathrm{H} _ {2} \end{array} \right.
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b72ee6cc88152e49a296967e0d05c5717be749bf0ac2da667e43ab750d7a60b4.jpg)
...
$$
\begin{array}{r l} & \text {参考解答} \quad (1) \mathrm{C} _ {53} \mathrm{H} _ {108} \quad (2) \mathrm{C} _ {2 \times 3 ^ {n - 1} - 1} \mathrm{H} _ {4 \times 3 ^ {n - 1}} \quad (3) 85.7 \% \\ & (4) \mathrm{C} _ {3 \times 3 ^ {n - 1} - 1} \mathrm{H} _ {6 \times 3 ^ {n - 1}} \end{array}
$$
...
$$
\mathrm{Cl} _ {2} \xrightarrow [ \text {或} 500 ^ {\circ} \mathrm{C} ]{h v} 2 \mathrm{Cl} \cdot
$$
...
$$
\begin{array}{c} \mathrm {(CH_ {3}) _ {2} CHCH(CH_ {3}) _ {2}} \xrightarrow [ h \nu , 127 ^ {\circ} \mathrm{C} ]{\mathrm{Br} _ {2}} (\mathrm{CH} _ {3}) _ {2} \mathrm{CHCHCH} _ {2} \mathrm{Br} + (\mathrm{CH} _ {3}) _ {2} \mathrm{CHC} (\mathrm{CH} _ {3}) _ {2} \\ \mid \\ \mathrm{CH} _ {3} \\ \text {A} \end{array}
$$
...
$$
\mathrm{B} = \frac {1600}{1606} \times 100 \% = 99.63 \%
$$
...
$$
\mathrm{C} _ {6} \mathrm{H} _ {5} + \mathrm{Br} _ {2} \xrightarrow {300 ^ {\circ} \mathrm{C}} \mathrm{C} _ {6} \mathrm{H} _ {5} - \mathrm{Br} + \mathrm{HBr}
$$
...
$$
\triangle + \mathrm{H} _ {2} \xrightarrow [ \mathrm{Ni} ]{80 ^ {\circ} \mathrm{C}} \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{CH} _ {3}
$$

$$
\square + \mathrm{H} _ {2} \xrightarrow [ \mathrm{Ni} ]{200 ^ {\circ} \mathrm{C}} \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{CH} _ {2} \mathrm{CH} _ {3}
$$

$$
\mathrm{H} _ {2} + \mathrm{H} _ {2} \xrightarrow [ \mathrm{Ni} ]{300 ^ {\circ} \mathrm{C}} \mathrm{CH} _ {3} \mathrm{CH} _ {2} \mathrm{CH} _ {2} \mathrm{CH} _ {2} \mathrm{CH} _ {3}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/41174cd924406e16a56aeab8da45f83ff194c4860d5e900e1781bd3dcadac0eb.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/0c9f010e342e3b013e7fa875ecf955f7e52397df7649ade2d225e581ea80b4da.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8722b1fc420ed479567085235d34416f0704f696b7135f0f3e7eafbc3217ea70.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/d1a29e9b8e3ed99b93570fb0cbec4ec78eaced171821964420317d59a1ce1e3e.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/111e1023aadef4986c1ac953a2a6de037bb546880f59c7e0479fb8057d6e184e.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ea9611c994fda434fa6279fc5b0db546524d7c907391738e91ce4a6f090e20c2.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8cbe139338a3abf2a17cd8eed3beccce0ab3ae136a0b3309e6476c38bb055514.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8c255cefd5a49f7b57b8a3cd9b8baac62d969bcc437b3eb6269fa4feb9ffc3a7.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/1ce55b7e15bfb047069a3bf38ab9de68302ce74d6d3d1ea278d1bc17f8b5545b.jpg)

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/6bcceecd602b88b835ad564e0afd06643ea5eb814ae07e46167e7be5b742caf0.jpg)
...
$$
\begin{array}{r l} & 2 / 3 \mathrm{L} (1.5 n _ {1} + 0.5) = (n _ {1} + 1 / 3) \mathrm{L} \\ & 2 / 3 \mathrm{L} (1.5 n _ {2} + 0.5) = (n _ {2} + 1 / 3) \mathrm{L} \\ & 2 / 3 \mathrm{L} (1.5 n _ {3} + 0.5) = (n _ {3} + 1 / 3) \mathrm{L} \\ & \because n _ {1} + n _ {2} + n _ {3} + 1 = 11 \quad \therefore n _ {1} + n _ {2} + n _ {3} = 10 \end{array}
$$
...
![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/8e3f4c5c4757270ec7b0a15589afc157a032dd19927b637a07ffdba8035d0d5a.jpg)  
B

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/ca51b6cb8b8ad73d4aa3d75029deb1f6059ea17805b618a7640893ec17966191.jpg)  
C

![](高中化学竞赛教程第2分册万长江编,Wanchangjiangbianzhuz-library.sk,1lib.sk,z-lib.sk_1-199_images/b294a5fb5aefead0935e3ca02b17f20e98cc38aec767716b7e0a7ff4d41e717e.jpg)  
D
