...
$$
1 - 3 \quad 0.04 \times 0.1 \times 233 = 0.932 \mathrm{g}; 0.1 \times 0.06 \times 233 = 1.398 \mathrm{g} 。
$$
...
$$
m \left(\mathrm{N} _ {2}\right) = n M = 28 \mathrm{g} \cdot \mathrm{mol} ^ {- 1} \times 4.
$$
...
$$
\text { 第8题 } \quad 8 - 1 \quad M = \frac {\rho V N _ {\mathrm{A}}}{Z} = \frac {4.59 ^ {2} \times 2.96 \times 10 ^ {- 24} \times 4.25 \times 6.02 \times 10 ^ {23}}{2} = 79.8 (\mathrm{g} \cdot \mathrm{mol} ^ {- 1})
$$
...
$$
2 \mathrm{NaH} _ {2} \mathrm{PO} _ {4} \xlongequal {170 ^ {\circ} \mathrm{C}} \mathrm{Na} _ {2} \mathrm{H} _ {2} \mathrm{P} _ {2} \mathrm{O} _ {7} + \mathrm{H} _ {2} \mathrm{O}
$$
...
9-2 化合物 C 的准确摩尔质量为 $728.8 \, \mathrm{g} \cdot \mathrm{mol}^{-1}$ ，故余下的物质摩尔质量为 $311.2 \, \mathrm{g} \cdot \mathrm{mol}^{-1}$ 。可以断定高温氧气气氛下钴的氧化物为 CoO 和 $Co_{3}O_{4}$ ，铁的氧化物为 $Fe_{2}O_{3}$ 。假设 1 mol 沉淀 C，CoO、 $Co_{3}O_{4}$ 、 $Fe_{2}O_{3}$ 的物质的量分别为 x、y、z，则：
...
$$
\begin{array}{r l} & \mathrm {MnC_ {2} O_ {4}} \cdot 2 \mathrm {H_ {2} O} \xlongequal {50 ^ {\circ} \mathrm{C} \sim 100 ^ {\circ} \mathrm{C}} \mathrm {MnC_ {2} O_ {4}} + 2 \mathrm {H_ {2} O} \\ & \frac {179 \mathrm{mg}}{100 \mathrm{mg}} = \frac {143 \mathrm{mg}}{x}, x = 80.0 \mathrm{mg} \end{array}
$$
...
$$
\begin{array}{r l} & \mathrm {MnC_ {2} O_ {4}} \xlongequal {214 ^ {\circ} \mathrm{C} \sim 280 ^ {\circ} \mathrm{C}} \mathrm{MnO} + \mathrm{CO} \uparrow + \mathrm {CO_ {2}} \uparrow \\ & \frac {143 \mathrm{mg}}{80.0 \mathrm{mg}} = \frac {y}{40.0}, y = 71 \end{array}
$$
...
$$
2 \mathrm{Cr} _ {2} \mathrm{O} _ {7} ^ {2 -} + 3 \mathrm{C} _ {2} \mathrm{H} _ {5} \mathrm{OH} + 16 \mathrm{H} ^ {+} = 4 \mathrm{Cr} ^ {3 +} + 3 \mathrm{CH} _ {3} \mathrm{COOH} + 11 \mathrm{H} _ {2} \mathrm{O}
$$
...
400 K 时失重 1 - 83.8% = 16.2%，对应的摩尔质量 $M = 16.2\% \times 449 \, \mathrm{g} \cdot \mathrm{mol}^{-1} = 72.79 \, \mathrm{g} \cdot \mathrm{mol}^{-1}$ ，恰好对应 4 个结晶水。故 400 K 时样品的组成为 $\mathrm{BaTiO(C_{2}O_{4})_{2}}$ 。
...
$$
7 - 2 \quad 400 \mathrm{K}: \mathrm{BaTiO} \left(\mathrm{C} _ {2} \mathrm{O} _ {4}\right) _ {2}; 600 \mathrm{K}: 1 / 2 \mathrm{BaTi} _ {2} \mathrm{O} _ {5} + 1 / 2 \mathrm{BaCO} _ {3}; 900 \mathrm{K}: \mathrm{BaTiO} _ {3}
$$
...
$$
3 \mathrm{NH} _ {4} \mathrm{Cl} + 3 \mathrm{PCl} _ {5} = 12 \mathrm{HCl} +
$$
...
| $p/10^{5} \text{ Pa}$ | 1.013 | 0.6755 | 0.5066 | 0.3378 | 0.2533 |
| --- | --- | --- | --- | --- | --- |
| $V/10^{-3} \text{ m}^{3}$ | 0.4334 | 0.6552 | 0.8771 | 1.321 | 1.765 |
| $\rho/10^{3} \text{ g } \cdot \text{ m}^{-3}$ | 2.307 | 1.526 | 1.140 | 0.7570 | 0.5666 |
| $(\rho/p)/10^{-2} \text{ g } \cdot \text{ m}^{-3} \cdot \text{ Pa}^{-1}$ | 2.277 | 2.259 | 2.251 | 2.241 | 2.237 |
...
| $pV/10^{2} \text{ Pa} \cdot \text{m}^{3}$ | 0.4390 | 0.4426 | 0.4443 | 0.4462 | 0.4471 |
| --- | --- | --- | --- | --- | --- |
| $p/10^{5} \text{ Pa}$ | 1.013 | 0.6755 | 0.5066 | 0.3378 | 0.2533 |
...
$nM=\omega$ , 所以 $M=50.5(\mathrm{g}\cdot \mathrm{mol}^{-1})$ 。
...
$$
c _ {1} = 1.2 \times 10 ^ {- 3} \mathrm{mol} \cdot \mathrm{L} ^ {- 1}; c _ {0} = 0.13 \mathrm{mol} \cdot \mathrm{L} ^ {- 1}
$$
...
$$
3 - 2 \quad S _ {2} O _ {3} ^ {2 -} + 4 C l _ {2} + 5 H _ {2} O = 2 S O _ {4} ^ {2 -} + 8 C l ^ {-} + 10 H ^ {+}
$$

$$
\mathrm{I} _ {3} ^ {-} + 8 \mathrm{Cl} _ {2} + 9 \mathrm{H} _ {2} \mathrm{O} = 3 \mathrm{IO} _ {3} ^ {-} + 16 \mathrm{Cl} ^ {-} + 18 \mathrm{H} ^ {+}
$$
...
$$
40 \mathrm{Mg} + 100 \mathrm{HNO} _ {3} = 5 \mathrm{NO} \uparrow + \mathrm{H} _ {2} \uparrow + \mathrm{NO} _ {2} \uparrow + 3 \mathrm{N} _ {2} \uparrow + 41 \mathrm{H} _ {2} \mathrm{O} + 4 \mathrm{NH} _ {4} \mathrm{NO} _ {3} + 40 \mathrm{Mg} (\mathrm{NO} _ {3}) _ {2}
$$

(1) $MnO_{4}^{-}$

$$
5 \mathrm{XeO} _ {3} + 6 \mathrm{Mn} ^ {2 +} + 9 \mathrm{H} _ {2} \mathrm{O} = 5 \mathrm{Xe} + 6 \mathrm{MnO} _ {4} ^ {-} + 18 \mathrm{H} ^ {+}
$$
...
$$
(\text {或:} 12 \mathrm{XeO} _ {3} + 12 \mathrm{Mn} ^ {2 +} + 18 \mathrm{H} _ {2} \mathrm{O} = 12 \mathrm{Xe} + 12 \mathrm{MnO} _ {4} ^ {-} + 3 \mathrm{O} _ {2} + 36 \mathrm{H} ^ {+})
$$
...
$$
10 - 2 \quad 3 \mathrm{F} _ {2} + 3 \mathrm{KCl} + \mathrm{CuCl} = \mathrm{K} _ {3} \mathrm{CuF} _ {6} + 2 \mathrm{Cl} _ {2} \uparrow ;
$$
...
第2题 2-1 因B的密度是空气的0.139倍，因此 $M(B)=0.139\times29\ \mathrm{g}\cdot \mathrm{mol}^{-1}=4\ \mathrm{g}\cdot \mathrm{mol}^{-1}$ ，即B为HT。因此A中含有T，又因为A在热核动力中提供能量，因此含有Li元素。故A为LiT。
...
$$
x = 0.1568 \times (30.26 - 23.89) \times 10 ^ {- 3}
$$
...
$$
n (\mathrm{Cu} ^ {2 +} + \mathrm{Cu} ^ {3 +}) 0.1568 \times 23.89 \times 10 ^ {- 3}
$$

$$
n \left(\mathrm{Cu} ^ {2 +} + \mathrm{Cu} ^ {3 +}\right) = 3.746 \times 10 ^ {- 3} \mathrm{mol}
$$

则原氧化物中 $\mathrm{Cu}^{2+}$ 的物质的量为:

$$
3.746 \times 10 ^ {- 3} - 0.9988 \times 10 ^ {- 3} = 2.747 \times 10 ^ {- 3} \mathrm{mol}
$$

因此氧化物中 $\mathrm{Cu}$ 的平均化合价为：

$$
3 \times 0.9988 / 3.746 + 2 \times 2.747 / 3.746 = 2.267
$$
...
$$
\therefore \frac {n \times M _ {\mathrm{Ag}}}{n \times M _ {\mathrm{Ag}} + M _ {\mathrm{X} ^ {n -}}} = 0.7526
$$

$$
\frac {n \times 107.87}{n \times 107.87 + M _ {\mathrm{X} ^ {n -}}} = 0.7526
$$

$$
M _ {\mathrm{x} ^ {n -}} = \frac {0.2427 n \times 107.87}{0.7526} = 35.46 n
$$
...
$$
\because n _ {\mathrm{Cl}} = n _ {\mathrm{AgCl}} = \frac {25.81}{107.87 + 35.45} = 0.180 (\mathrm{mol}) \quad n _ {\mathrm{H}} = 2 n _ {\mathrm{H} _ {2}} = \frac {2 \times 0.672}{22.4} = 0.060 (\mathrm{mol})
$$

$$
\therefore n _ {\mathrm{H}}: n _ {\mathrm{Cl}} = 0.060: 0.180 = 1: 3
$$
...
(A) 酸的摩尔质量= $\frac{75.0\times0.164\times a}{0.060}=205a(\mathrm{g}\cdot \mathrm{mol}^{-1})$

当 $a = 1$ ，则 $1.008 + bM_{(\mathrm{Y})} + 3\times 35.45 = 205\times 1$

$$
b M _ {(Y)} = 97.642 \qquad \begin{array}{l l} {b = 1 \text {时}} & {\mathrm{Y为Tc(98)}} \\ {b = 2 \text {时}} & {\mathrm{Y为Ti(49)}} \end{array}
$$
...
$$
b M _ {(\mathrm{Y})} = 195.28 \qquad b = 1 \text {时} \qquad \mathrm{Y为Pt(195.08)}
$$
...
∴ 金属线的金属元素摩尔质量 = $\frac{5.8524}{\frac{6}{k} \times 0.03} = 32.51 \, (\mathrm{g} \cdot \mathrm{mol}^{-1})$
...
$$
5 - 5 \quad 3 \mathrm{Pt} + 4 \mathrm{HNO} _ {3} + 18 \mathrm{HCl} = 3 \mathrm{H} _ {2} \mathrm{PtCl} _ {6} + 4 \mathrm{NO} \uparrow + 8 \mathrm{H} _ {2} \mathrm{O}
$$
...
$$
6 - 4 \quad 2 \mathrm{Si} + \mathrm{C} + \mathrm{CaO} \xlongequal {1000 ^ {\circ} \mathrm{C}} \mathrm{CaSi} _ {2} + \mathrm{CO} \uparrow 。
$$
...
$$
6 - 7 \quad \mathrm{Si} _ {6} \mathrm{Cl} _ {12} + 2 \mathrm{TrCl} = [ \mathrm{Tr} ] _ {2} [ \mathrm{Si} _ {6} \mathrm{Cl} _ {14} ];
$$
...
$$
4 \mathrm{Al} (\mathrm{NO} _ {3}) _ {3} \stackrel {\text {高温}} {=} 12 \mathrm{NO} _ {2} \uparrow + 3 \mathrm{O} _ {2} \uparrow + 2 \mathrm{Al} _ {2} \mathrm{O} _ {3}
$$
...
$$
20 \mathrm{FeC} _ {2} \mathrm{O} _ {4} \cdot 2 \mathrm{H} _ {2} \mathrm{O} \xlongequal {\triangle} 19 \mathrm{FeO} + 19 \mathrm{CO} \uparrow + 21 \mathrm{CO} _ {2} \uparrow + \mathrm{Fe} + 40 \mathrm{H} _ {2} \mathrm{O} 。
$$
...
$$
8 - 5 \quad 20 \mathrm{FeC} _ {2} \mathrm{O} _ {4} \cdot 2 \mathrm{H} _ {2} \mathrm{O} \xlongequal {\triangle} 19 \mathrm{FeO} + 19 \mathrm{CO} \uparrow + 21 \mathrm{CO} _ {2} \uparrow + \mathrm{Fe} + 40 \mathrm{H} _ {2} \mathrm{O}
$$
...
2-1 先确定 D。设 D 化学式为 $MO_{x}$ ，M 摩尔质量为 $y \, \mathrm{g} \cdot \mathrm{mol}^{-1}$ 。则 $16.00x/(y + 16.00x) = 10.38\%$ 。化简得 y = 138.15x。
...
$$
7 - 3 \quad A: 0.0100 \mathrm{mol}; B: 0.0150 \mathrm{mol}.
$$
...
$$
10 - 2 \quad \mathrm{Na} _ {2} \mathrm{SO} _ {3} + \mathrm{Se} = \mathrm{Na} _ {2} \mathrm{SSeO} _ {3};
$$
...
$$
s _ {1} = \frac {1}{2} a t ^ {2} = 250 \mathrm{m}, v _ {1} = a t = 50 \mathrm{m} \cdot \mathrm{s} ^ {- 1}
$$
...
2-3 As原子核外电子排布 $1\mathrm{s}^22\mathrm{s}^22\mathrm{p}^63\mathrm{s}^23\mathrm{p}^63\mathrm{d}^{10}4\mathrm{s}^24\mathrm{p}^3$ ，4p亚层为半满结构。根据洪特规则，半满结构比较稳定，电离能相对较大。
...
第6题 6-1 Ge核外电子排布为 $1\mathrm{s}^22\mathrm{s}^22\mathrm{p}^63\mathrm{s}^23\mathrm{p}^63\mathrm{d}^{10}4\mathrm{s}^24\mathrm{p}^2$ 或[Ar] $3\mathrm{d}^{10}4\mathrm{s}^24\mathrm{p}^2$ 。
...
$$
1 \mathrm{s} ^ {2} 2 \mathrm{s} ^ {2} 2 \mathrm{p} ^ {6} 3 \mathrm{s} ^ {2} 3 \mathrm{p} ^ {6} 3 \mathrm{d} ^ {10} 4 \mathrm{s} ^ {2} 4 \mathrm{p} ^ {2} \text {或} [ \mathrm{Ar} ] 3 \mathrm{d} ^ {10} 4 \mathrm{s} ^ {2} 4 \mathrm{p} ^ {2}
$$
...
$$
6 - 5 \sqrt [ 3 ]{\frac {209}{\rho N _ {\mathrm{A}}}} \times 10 ^ {10}
$$
...
$$
8 - 4 \quad {} _ {92} ^ {235} \mathrm{U} + _ {0} ^ {1} \mathrm{n} = _ {55} ^ {140} \mathrm{Cs} + _ {37} ^ {93} \mathrm{Rb} + 3 _ {0} ^ {1} \mathrm{n} 。
$$
...
$$
9 - 1 \quad {} _ {7} ^ {14} \mathrm{N} + _ {0} ^ {1} \mathrm{n} \longrightarrow {} _ {6} ^ {14} \mathrm{C} + _ {1} ^ {1} \mathrm{H} 。
$$

$$
9 - 2 \quad {} _ {6} ^ {14} \mathrm{C} \longrightarrow {} _ {7} ^ {14} \mathrm{N} + _ {- 1} ^ {0} \mathrm{e} _ {\circ}
$$
...
$$
\partial = \frac {\partial^ {2} \nabla \partial . A I \times_ {\text { 有 }} M}{1 - \log m \cdot g 10.81} = (C) _ {n}
$$

$$
1 - 3 \quad \mathrm{Al} _ {4} \mathrm{SiC} _ {4} + 2 \mathrm{N} _ {2} \xrightarrow {1500 ^ {\circ} \mathrm{C}} 4 \mathrm{AlN} + \mathrm{SiC} + 3 \mathrm{C} _ {\circ}
$$
...
$$
1 - 5 \quad 4 \mathrm{Al} + \mathrm{Si} + 4 \mathrm{C} \xrightarrow [ 80 \sim 100 \mathrm{MPa} ]{1500 \sim 1700 ^ {\circ} \mathrm{C}} \mathrm{Al} _ {4} \mathrm{C} _ {3} + \mathrm{SiC} 。
$$
...
$$
\frac {4 M _ {\mathrm{r}} (\mathrm{B})}{12 x + 4 M _ {\mathrm{r}} (\mathrm{B})} = 0.75
$$
...
$$
\therefore \mathrm{K} _ {3} \mathrm{FeC} _ {6} \mathrm{O} _ {15} \mathrm{H} _ {6} \Rightarrow \mathrm{K} _ {3} \left[ \mathrm{Fe} (\mathrm{C} _ {2} \mathrm{O} _ {4}) _ {3} \right] \cdot 3 \mathrm{H} _ {2} \mathrm{O} 。
$$
...
$$
5 - 2 \quad {} _ {92} ^ {235} \mathrm{U} + _ {0} ^ {1} \mathrm{n} \longrightarrow {} _ {56} ^ {142} \mathrm{Ba} + _ {36} ^ {91} \mathrm{Kr} + 3 _ {0} ^ {1} \mathrm{n}, \quad {} _ {92} ^ {235} \mathrm{U} + _ {0} ^ {1} \mathrm{n} \longrightarrow {} _ {53} ^ {135} \mathrm{I} + _ {39} ^ {97} \mathrm{Y} + 4 _ {0} ^ {1} \mathrm{n} 。
$$
...
$$
\Rightarrow M = x + M (R) = 2 \times 17 = 34 \Rightarrow M (R) = 31 g \cdot m o l ^ {- 1}
$$
...
$$
\mathrm{P}; 16; 1 \mathrm{s} ^ {2} 2 \mathrm{s} ^ {2} 2 \mathrm{p} ^ {6} 3 \mathrm{s} ^ {2} 3 \mathrm{p} ^ {3}; \mathrm{P} _ {2} \mathrm{O} _ {5}; \mathrm{HPO} _ {3} (\mathrm{H} _ {3} \mathrm{PO} _ {4})
$$
...
$$
\mathrm{Fe} + _ {83} ^ {209} \mathrm{Bi} \longrightarrow_ {109} ^ {266} \mathrm{M} + _ {0} ^ {1} \mathrm{n})
$$

$$
\mathrm{Fe} + _ {82} ^ {209} \mathrm{Pb} \longrightarrow_ {108} ^ {266} \mathrm{M} + _ {0} ^ {1} \mathrm{n})
$$
...
$$
{ } _ { 34 } ^ { 83 } \mathrm{SeO} _ { 4 } ^ { 2 - } \longrightarrow { } _ { 35 } ^ { 83 } \mathrm{BrO} _ { 4 } ^ { - } + \mathrm{e} _ { \circ }
$$
...
设 A 的化学式为 $M_{x}N_{y}$ 。讨论得到当 y=4 时，x=3， $M=232.0\ \mathrm{g}\cdot \mathrm{mol}^{-1}$ 。

M 为钍 Th。所以 A 为 $Th_{3}N_{4}$ ; B 为 ThN。 $6d^{2}7s^{2}$ 。

$$
\rho = \frac {z M}{a ^ {3} N _ {\mathrm{A}}} = \frac {4 \times 246.01}{(5.16 \times 10 ^ {- 8}) ^ {3} \times 6.02 \times 10 ^ {23}} = 11.90 \mathrm{g} \cdot \mathrm{cm} ^ {- 3}.
$$
...
$$
\mathbf {8} - \mathbf {5} ^ {232} \mathrm{Th} + ^ {76} \mathrm{Ge} \longrightarrow^ {305} \mathrm{N} + 3 \mathrm{n};
$$
...
$$
\begin{array}{r l} & 2 \mathrm{Cu} ^ {+} (\mathrm{aq}) \xrightarrow {\Delta H} \mathrm{Cu} ^ {2 +} (\mathrm{aq}) + \mathrm{Cu} (\mathrm{s}) \\ & \Biggl \downarrow - 2 \Delta H _ {\mathrm{h}} (\mathrm{Cu} ^ {+}) \uparrow \Delta H _ {\mathrm{h}} (\mathrm{Cu} ^ {2 +}) \Biggl \uparrow - \Delta H _ {\mathrm{s}} \\ & \mathrm{Cu} ^ {+} (\mathrm{g}) \xrightarrow {\Delta H _ {12}} \mathrm{Cu} ^ {2 +} (\mathrm{g}) \\ & \mathrm{Cu} ^ {+} (\mathrm{g}) \xrightarrow {- \Delta H _ {11}} \mathrm{Cu} (\mathrm{g}) \end{array}
$$
...
$$
\mathrm{H} _ {2} \mathrm{O} _ {2} + \mathrm{SO} _ {2} = \mathrm{H} _ {2} \mathrm{SO} _ {4}, n [ \mathrm{Ba(ClO} _ {4}) _ {2} ] = c V = 0.01208 \mathrm{mol} \cdot \mathrm{L} ^ {- 1} \times 7.68 \times 10 ^ {- 3} \mathrm{L} =
$$
...
$$
2 \mathrm{Na} _ {2} \mathrm{S} _ {2} \mathrm{O} _ {4} \longrightarrow 2 \mathrm{Na} _ {2} \mathrm{S} _ {2} \mathrm{O} _ {3} + \mathrm{O} _ {2} \uparrow m (\mathrm{Na} _ {2} \mathrm{S} _ {2} \mathrm{O} _ {3}) = 0.01 \times 2 \times (23 \times 2 + 32 \times 2 + 16 \times 4) = 3.48 \mathrm{g。}
$$
...
$$
\mathrm{NaCl}: M _ {\text {晶胞}} = 4 (23 + 35.5), \rho = M / V N _ {\Lambda}
$$
...
$$
\Rightarrow \mathrm{M} (\mathrm{A}) = \frac {0.01 \mathrm{m}}{1.0.33 \mathrm{g}} = 1003 \mathrm{g} \cdot \mathrm{mol} ^ {- 1}
$$

$$
6 - 4 \quad \rho = 3.54 (\mathrm{g} \cdot \mathrm{cm} ^ {- 3}) 。
$$
...
$$
r (C _ {60}) = \frac {a}{2 \sqrt {2}} = \frac {1420}{2 \sqrt {2}} = 502 \mathrm{pm}
$$

所以 $C_{60}$ 分子堆积形成的八面体空隙可容纳的球半径为：

$$
r (\text { 容   纳 }) = 0.414 \times r (\text { 堆   积 }) = 0.414 \times 502 = 208 \mathrm{pm}
$$
...
第1题 1-1 $5\mathrm{d}^56\mathrm{s}^2$ ；+3。
...
$$
10 - 1 x / 2 \mathrm{Li} _ {2} \mathrm{O} + (1 - x) \mathrm{NiO} + x / 4 \mathrm{O} _ {2} \longrightarrow \mathrm{Li} _ {x} \mathrm{Ni} _ {1 - x} \mathrm{O} 。
$$
...
$$
\mathrm{Li} _ {x} \mathrm{Ni} _ {1 - x} \mathrm{O}: 6.21 \mathrm{g} \cdot \mathrm{cm} ^ {- 3} = \frac {4 \cdot ((1 - x) \cdot 58.69 + x \cdot 6.941 + 16.00)}{N _ {\mathrm{A}} \cdot \mathrm{a} ^ {3}} = 0.10
$$
...
$$
10 - 1 \quad \mathrm{O} _ {2} ^ {2 -}: \mathrm{Na} _ {2} \mathrm{O} _ {2}; \mathrm{O} _ {2} ^ {-}: \mathrm{KO} _ {2}; \mathrm{O} _ {3} ^ {-}: \mathrm{KO} _ {3}; \mathrm{O} _ {2} ^ {+}: \mathrm{O} _ {2} [ \mathrm{PtF} _ {6} ] 。
$$
...
| 微粒 | 原子间距离 | 键能 | 键级 |
| --- | --- | --- | --- |
| $O_{2}$ | 121 pm | 490 kJ·mol $^{-1}$ | 2 |
| $O_{2}^{+}$ | 112 pm | 625 kJ·mol $^{-1}$ | 2.5 |
| $O_{2}^{-}$ | 132 pm | — | 1.5 |
| $O_{2}^{2-}$ | 149 pm | 200 kJ·mol $^{-1}$ | 1 |
...
$$
\left\{ \begin{array}{l} 2 x + 8 y = 48 \mathrm{mmol} \\ 2 y = 4 \mathrm{mmol} \end{array} \right.
$$
...
第3题 3-1 $3\mathrm{d}^54\mathrm{s}^1$ ；半充满的 $\mathrm{d}^5$ 电子结构更稳定。

3-2 $\mathrm{Cr_2O_3 + 2Al = 2Cr + Al_2O_3}$ ； $\mathrm{Al - O}$ （铝一氧）。

3-3 δ键;π键。

第4题 4-1 $1\mathrm{s}^22\mathrm{s}^22\mathrm{p}^63\mathrm{s}^23\mathrm{p}^63\mathrm{d}^{10}4\mathrm{s}^24\mathrm{p}^64\mathrm{d}^{10}4\mathrm{f}^{14}5\mathrm{s}^25\mathrm{p}^65\mathrm{d}^{10}6\mathrm{s}^2$ 。
...
第5题 5-1 Ni; $3\mathrm{d}^84\mathrm{s}^2$ 。
...
$$
6 - 3 \quad 18; 72 \mathrm{NH} _ {3} \uparrow ; \mathrm{C} 。
$$
...
$$
\begin{array}{r l} & 10 - 2 \quad 2 \mathrm{Cu} ^ {2 +} + 4 \mathrm{CN} ^ {-} = 2 \mathrm{CuCN} + (\mathrm{CN}) _ {2} 。 \end{array}
$$
...
$$
\rho = \frac {z M}{a ^ {3} N _ {\mathrm{A}}} = \frac {2 M}{a ^ {3} N _ {\mathrm{A}}} = \frac {2 \times 143.1}{\left(\frac {4 d}{\sqrt {3}}\right) ^ {3} \times 6.02 \times 10 ^ {23}} = 6 (\mathrm{g} \cdot \mathrm{cm} ^ {- 3})
$$
...
$$
\text {   第1题   } \quad 1 - 1 \mathrm{K} _ {2} \mathrm{ReH} _ {9}; 18 \mathrm{K} + \mathrm{KReO} _ {4} + 13 \mathrm{H} _ {2} \mathrm{O} = \mathrm{K} _ {2} \mathrm{ReH} _ {9} + 17 \mathrm{KOH}.
$$
...
$$
2 - 2 \quad {} _ {92} ^ {235} \mathrm{U} + _ {0} ^ {1} \mathrm{n} \longrightarrow {} _ {30} ^ {72} \mathrm{Zn} + _ {62} ^ {160} \mathrm{Sm} + 4 _ {0} ^ {1} \mathrm{n};
$$

![](化竞测试1答案_images/af8a5e0e6eb0bcf07485df1dae4b5f90b53a8464b2f97c541cbffbabba0f786e.jpg)

$$
{ } _ { 30 } ^ { 72 } \mathrm{Zn} + { } _ { 0 } ^ { 1 } \mathrm{n} \longrightarrow { } _ { 28 } ^ { 69 } \mathrm{Ni} + { } _ { 2 } ^ { 4 } \mathrm{He(或} \alpha ) ;
$$

图答题

$$
{ } _ { 28 } ^ { 69 } \mathrm{Ni} + { } _ { 0 } ^ { 1 } \mathrm{n} \longrightarrow { } _ { 26 } ^ { 66 } \mathrm{Fe} + { } _ { 2 } ^ { 4 } \mathrm{He(或} \alpha ) 。
$$
...
| $Cr^{3+}$ | $Fe^{3+}$ | $Mn^{3+}$ | $Ni^{3+}$ |
| --- | --- | --- | --- |
| $t_{2g}^{3}e_{g}^{0}$ | $t_{2g}^{3}e_{g}^{2}$ | $t_{2g}^{3}e_{g}^{1}$ | $t_{2g}^{6}e_{g}^{1}$ |
...
$$
d _ {\mathrm{Bi-Pt}} = \frac {1}{4} \sqrt {3} a = \frac {1}{4} \sqrt {3} \times 6.83 \text{Å} = 2.96 \text{Å}
$$

Bi-La 之间的核间距 $d_{Bi-La}$ 即为晶胞顶点到棱心的距离：

$$
d _ {\mathrm{Bi-La}} = \frac {1}{2} \times 6.83 \text{Å} = 3.42 \text{Å} 。
$$
...
$$
\begin{array}{r l} & c = 2 \times \text {边长为} a \text {的四} \\ & = 2 \times \frac {\sqrt {6}}{3} a = \frac {2 \sqrt {6}}{3} a \\ & = \frac {2 \sqrt {6}}{3} \times 290 \\ & = 473.6 \mathrm{pm} \end{array}
$$
...
$$
\begin{array}{r l} \rho & = \frac {2 M}{N _ {\mathrm{A}} V _ {\text {晶胞}}} = \frac {2 \times 47.9}{6.02 \times 10 ^ {23} \times 8 \sqrt {2} \times (145 \times 10 ^ {- 10}) ^ {3}} \\ & = 4.61 \mathrm{g} \cdot \mathrm{cm} ^ {- 3}. \end{array}
$$
...
$$
r _ {\text {层内}} ^ {2} = (0.154 - 0.654) ^ {2} \times 468.6 ^ {2} + (0.117 - 0.383) ^ {2} \times 978.4 ^ {2}, \text {解得} r = 350.5 \mathrm{pm。}
$$

具有不同 $x$ 坐标的原子是层间原子，因此 $(0, 0.154, 0.117)$ 和 $(0.500, 0.654, 0.117)$ 以及 $(0, 0.654, 0.383)$ 和 $(0.500, 0.654, 0.117)$ 是层间原子，层间距离：

$$
r _ {\text {层间}} ^ {2} = 0.500 ^ {2} \times 713.6 ^ {2} + (0.154 - 0.654) ^ {2} \times 468.6 ^ {2}, \text {解得} r = 426.9 \mathrm{pm}
$$

$$
r _ {\text {层间}} ^ {2} = 0.500 ^ {2} \times 713.6 ^ {2} + (0.383 - 0.117) ^ {2} \times 978.4 ^ {2}, \text {解得} r = 441.6 \mathrm{pm}
$$
...
$$
9 - 2 \quad 2.96 \mathrm{g} \cdot \mathrm{cm} ^ {- 3} 。
$$
...
$$
11 - 3 \quad \mathrm{HIO} _ {3}; \mathrm{I} _ {2} + 5 \mathrm{Cl} _ {2} + 6 \mathrm{H} _ {2} \mathrm{O} \longrightarrow 2 \mathrm{HIO} _ {3} + 10 \mathrm{HCl} 。
$$

$$
\mathbf {11 - 4} \quad (\mathrm{IO} _ {2} ^ {+}) _ {2} \mathrm{SO} _ {4}; (\mathrm{IO} ^ {+}) _ {2} \mathrm{SO} _ {4} 。
$$
...
$$
\Delta_ {\mathrm{r}} H ^ {\theta} = - 3 \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF}) + \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF} _ {3}) = (286.2 - 486) \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} = - 199.8 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1}
$$
...
$$
\Delta_ {\mathrm{r}} H ^ {\theta} = - 5 \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF} _ {3}) + 3 \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF} _ {5}) = (2430 - 2529) \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} = - 99 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1}
$$
...
$$
\Delta_ {\mathrm{r}} H ^ {\theta} = - 7 \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF} _ {5}) + 5 \Delta_ {\mathrm{r}} H ^ {\theta} (\mathrm{IF} _ {7}) = (5901 - 4812.5) \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} = + 1088.5 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1}
$$
...
$$
\text { 第 } 10 \text { 题 } \quad 10 - 1 \quad 1 s ^ {2} 2 s ^ {2} 2 p ^ {6} 3 s ^ {2} 3 p ^ {6} 3 d ^ {10} 4 s ^ {2} 4 p ^ {6} 4 d ^ {9}
$$

$$
2 \mathrm{F} _ {2} + 2 \mathrm{AgCl} = 2 \mathrm{AgF} _ {2} + \mathrm{Cl} _ {2}, 26 \mathrm{AgF} _ {2} + \mathrm{C} _ {10} \mathrm{H} _ {8} = 26 \mathrm{AgF} + \mathrm{C} _ {10} \mathrm{F} _ {18} + 8 \mathrm{HF},
$$
...
$$
\begin{array}{r l} & {\text {第11题}} \\ & {11 - 1 \quad \mathrm{H} _ {2} \mathrm{O} _ {2} + 2 \mathrm{ClO} _ {2} + 2 \mathrm{OH} ^ {-} = 2 \mathrm{ClO} _ {2} ^ {-} + 2 \mathrm{H} _ {2} \mathrm{O} + \mathrm{O} _ {2}.} \\ & {11 - 2 \quad \left[ \begin{array}{c} {\mathrm{OH}} \\ {\mathrm{HO-B-O-O-ClO} _ {2}} \\ {\mathrm{OH}} \end{array} \right] ^ {2 -}.} \end{array}
$$

$$
11 - 3 \quad [ \mathrm{HOOB} (\mathrm{OH}) _ {3} ] ^ {-} + \mathrm{ClO} _ {2} \rightleftharpoons [ \mathrm{O} _ {2} \mathrm{Cl} - \mathrm{OOB} (\mathrm{OH}) _ {3} ] ^ {2 -} + \mathrm{H} ^ {+}
$$

$$
11 - 4 \left[ \begin{array}{c} \mathrm{HO} \\ \mathrm{HO} \end{array} \mathrm{B} \left\langle \begin{array}{c} \mathrm{O} \\ \mathrm{O} \end{array} \right. \left\langle \begin{array}{c} \mathrm{O} \\ \mathrm{O} \end{array} \right. \mathrm{B} \left\langle \begin{array}{c} \mathrm{OH} \\ \mathrm{OH} \end{array} \right. \right] ^ {2 -}
$$
...
$$
1 - 2 \quad 3 \mathrm{S} _ {5} ^ {2 -} + 16 \mathrm{BrO} _ {3} ^ {-} + 24 \mathrm{OH} ^ {-} = 15 \mathrm{SO} _ {4} ^ {2 -} + 16 \mathrm{Br} ^ {-} + 12 \mathrm{H} _ {2} \mathrm{O} 。
$$
...
$$
\text {   第2题   } 2 - 12 \mathrm{NaOH} + 2 \mathrm{SO} _ {2} + \mathrm{Zn} = \mathrm{Zn(OH)} _ {2} + \mathrm{Na} _ {2} \mathrm{S} _ {2} \mathrm{O} _ {4} 。
$$
...
$$
[ \mathrm{H} _ {3} \mathrm{SO} _ {4} ^ {+} ] = [ \mathrm{HSO} _ {4} ^ {-} ] = 1.67 \times 10 ^ {- 2} \mathrm{mol} \cdot \mathrm{dm} ^ {- 3}
$$
...
$$
\Delta H _ {3} = 1 / 4 \left(\Delta H _ {1} - \Delta H _ {2}\right) = 429.2 \mathrm{kJ} \cdot \mathrm{mol} ^ {- 1} 。
$$
...
$$
1 - 5 \quad 12 \mathrm{KO} _ {3} + 6 \mathrm{CO} _ {2} \longrightarrow 6 \mathrm{K} _ {2} \mathrm{CO} _ {3} + 15 \mathrm{O} _ {2} 。
$$
...
$$
10 - 3 \quad S _ {8} + 12 B r _ {2} + 12 A s F _ {5} = 8 [ S B r _ {3} ] ^ {+} [ A s F _ {6} ] ^ {-} + 4 A s F _ {3}
$$
...
$$
11 - 3 \quad \mathrm{Y} - [ \mathrm{NS(O)F} ] _ {3}, \mathrm{X} - [ \mathrm{NS(O)Cl} ] _ {3} 。
$$

$$
11 - 4 \quad [ \mathrm{NS} (\mathrm{O}) (\mathrm{NHCH} _ {3}) ] _ {3} 。
$$
...
$$
1 - 1 \quad 5 \mathrm{N} _ {2} \mathrm{H} _ {4} + 4 \mathrm{MnO} _ {4} ^ {-} + 12 \mathrm{H} ^ {+} = 5 \mathrm{N} _ {2} + 4 \mathrm{Mn} ^ {2 +} + 16 \mathrm{H} _ {2} \mathrm{O}.
$$
...
$$
(100 / 20) \times (c _ {1} \times V _ {1} \times 10 ^ {- 3} - 6 c _ {2} \times V _ {2} \times 10 ^ {- 3}) \mathrm{mol} / 3 = 5 (c _ {1} \times V _ {1} \times 10 ^ {- 3} - 6 c _ {2} \times V _ {2} \times 10 ^ {- 3}) / 3
$$

折合成 $\mathrm{NO}_2$ 的含量为：

$$
46 \times 5 \left(c _ {1} \times V _ {1} - 6 c _ {2} \times V _ {2}\right) / (3 V) \mathrm{mg} \cdot \mathrm{L} ^ {- 1} = 23 \left(c _ {1} V _ {1} - 6 c _ {2} V _ {2}\right) \times 10 ^ {4} / 3 V \mathrm{mg} \cdot \mathrm{m} ^ {- 3} 。
$$
...
$$
1 - 2 \quad 3 \mathrm{SnCl} _ {2} + 12 \mathrm{Cl} ^ {-} + 2 \mathrm{H} _ {3} \mathrm{AsO} _ {3} + 6 \mathrm{H} ^ {+} \longrightarrow 2 \mathrm{As} + 3 \mathrm{SnCl} _ {6} ^ {2 -} + 6 \mathrm{H} _ {2} \mathrm{O} 。
$$
...
$$
10 \mathrm{Bi} + 9 \mathrm{AsF} _ {5} \longrightarrow 2 \mathrm{Bi} _ {5} (\mathrm{AsF} _ {6}) _ {3} + 3 \mathrm{AsF} _ {3}
$$
...
$$
10 - 2 \quad \mathrm{NaNO} _ {2} + \mathrm{NaHSO} _ {3} + \mathrm{SO} _ {2} = \mathrm{HON} (\mathrm{SO} _ {3} \mathrm{Na}) _ {2},
$$
...
$$
10 - 3 \quad R - X + N H _ {2} O H \longrightarrow R - O N H _ {2} + H X,
$$
...
$$
\mathrm{Li} _ {2} \mathrm{CO} _ {3} + 3 \mathrm{MoO} _ {3} \xrightarrow {\triangle} \mathrm{Li} _ {2} \mathrm{Mo} _ {3} \mathrm{O} _ {10} + \mathrm{CO} _ {2}
$$
...
$$
\begin{array}{l} 7 - 2 \quad 5 \mathrm{B} _ {2} \mathrm{H} _ {6} + 2 \mathrm{Na} [ \mathrm{BH} _ {4} ] = \mathrm{Na} _ {2} [ \mathrm{B} _ {12} \mathrm{H} _ {12} ] + 13 \mathrm{H} _ {2} \uparrow ; 26 \mathrm{e}; + 5 / 6. \\ 7 - 3 \quad [ (\mathrm{NH} _ {3}) \mathrm{BH} _ {7} ] ^ {+}, \mathrm{BH} _ {7} = \mathrm{CH} _ {3}. \end{array}
$$
...
$$
\begin{array}{r l} & 10 - 2 \quad [ H P C y _ {3} ] ^ {+} [ H B (C _ {6} F _ {5}) _ {3} ] ^ {-} \\ & 10 - 3 \quad C y _ {3} P ^ {+} C H _ {2} C H _ {2} B ^ {-} (C _ {6} F _ {5}) _ {3} 。 \end{array}
$$
...
$$
\begin{array}{l} \text {子的3d空轨道形} \\ \text {第8题} \quad 8 - 1 \\ \text {时,} M (A) = 69.8 \end{array}
$$
...
$$
6 - 3 \left[ \begin{array}{c} \ddots \\ \mathrm{Cl} \stackrel {\mathrm{Sn}} {\underset {87 ^ {\circ}} {\longrightarrow}} \mathrm{Cl} \\ \mathrm{Cl} \end{array} \right] ^ {-}
$$
...
$$
10 - 2 \quad \mathrm{B} _ {3} \mathrm{N} _ {3} \mathrm{H} _ {3} \mathrm{Cl} _ {3} + 9 \mathrm{H} _ {2} \mathrm{O} = 3 \mathrm{H} _ {3} \mathrm{BO} _ {3} + 3 \mathrm{NH} _ {4} \mathrm{Cl}
$$
...
$$
\frac {0.205 (1 - x)}{M + 1} + \frac {0.205 x}{M \times 2} = \frac {(97.46 - 2.67) \times 0.561}{8.314 \times (273.2 + 22)}
$$
...
$$
d _ {\mathrm{Mg-Ni}} = \frac {1}{4} \times \sqrt {3} a = \frac {1}{4} \sqrt {3} \times 646.5 \mathrm{pm} = 279.9 \mathrm{pm。}
$$

$$
= \frac {4 \times M (\mathrm{Mg} _ {2} \mathrm{NiH} _ {4})}{N _ {\mathrm{A}} a ^ {3}} \times \frac {3.622 / 100}{0.0708 \mathrm{g} \cdot \mathrm{cm} ^ {- 3}}
$$

## 能力测试 B 卷

$$
= \frac {4 \times 111.34 \mathrm{g} \cdot \mathrm{mol} ^ {- 1}}{6.022 \times 10 ^ {23} \mathrm{mol} ^ {- 1} \times (6.465 \times 10 ^ {- 8} \mathrm{cm}) ^ {3}} \times \frac {3.622 / 100}{0.0708 \mathrm{g} \cdot \mathrm{cm} ^ {- 3}} = 1.40 。
$$
...
$$
1 \times (40.08 + 10.81 x) = 2.44 \times 6.02 \times 10 ^ {23} \times (415 \times 10 ^ {- 10}) ^ {3}
$$
...
$$
8 - 3 \quad \mathrm{CaO} + 3 \mathrm{B} _ {2} \mathrm{O} _ {3} + 10 \mathrm{Mg} = \mathrm{CaB} _ {6} + 10 \mathrm{MgO},
$$

$$
\mathrm{CaCl} _ {2} + 6 \mathrm{NaBH} _ {4} = \mathrm{CaB} _ {6} + 2 \mathrm{NaCl} + 4 \mathrm{NaH} + 10 \mathrm{H} _ {2} 。
$$
