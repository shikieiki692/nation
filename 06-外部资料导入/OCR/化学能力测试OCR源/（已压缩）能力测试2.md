...
3-6 B—P之间的距离 $d=\frac{\sqrt{3}}{4}a=2.069\ \text{Å}$ 。
...
9-3 C—C键长 $(d_{c-c})=c-2\times0.406c=0.188c=0.188\times6.37=1.20(\text{Å})$

9-4 最短的 Ca—C 距离= $\sqrt{\left(\frac{a}{2}\right)^{2}+\left(\frac{d_{\mathrm{C}-\mathrm{C}}}{2}\right)^{2}}=\frac{1}{2}\sqrt{(3.87)^{2}+(1.2)^{2}}=2.03(\text{Å})$
...
| GTP concentration | 200 μM | 150 μM | 100 μM | 80 μM | 60 μM | 40 μM | 20 μM |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Time(s) | Product concentration(μM) |  |  |  |  |  |  |
...
|  | Initial rate ($\mu\mathrm{mol}\cdot\mathrm{dm}^{-3}\cdot\mathrm{s}^{-1}$) |  |  |  |  |  |  |
