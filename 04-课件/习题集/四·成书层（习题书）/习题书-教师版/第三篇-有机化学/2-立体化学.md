...
> **题量**：113 ｜ **难度**：d1=2 d2=12 d3=38 d4=51 d5=10
...
An achiral epoxide (meso compound) reacts with an amine nucleophile. What is the stereochemical relationship between the products?
...
## 2.24 Friedel-Crafts和Wolff-Kishner序列中A和B
...
## 2.85 Zimmerman-Traxler-Aldol立体化学
...
## 2.104 Robinson环化与酶催化卤醇环氧化物

提出下面转化（Robinson 环化反应）的机理：
