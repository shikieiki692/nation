...
**按机理(1)**：$v=k_{2}[\mathrm{Fe}^{2+}][\mathrm{Cl}]$，由第一步平衡 $[\mathrm{Cl}]=
rac{k_{1}}{k_{1}'}\cdot
rac{[\mathrm{Fe}^{2+}][\mathrm{Cl}_{2}]}{[\mathrm{Fe}^{3+}][\mathrm{Cl}^{-}]}$

$$v = k_{2}\cdot
rac{k_{1}}{k_{1}'}\cdot
rac{[\mathrm{Fe}^{2+}]^{2}[\mathrm{Cl}_{2}]}{[\mathrm{Fe}^{3+}][\mathrm{Cl}^{-}]}$$

随 $\mathrm{Fe}^{3+}$ 和 $\mathrm{Cl}^{-}$ 浓度增加，速率下降 ✓

**按机理(2)**：$v=k_{4}[\mathrm{Fe}(\mathrm{IV})][\mathrm{Fe}^{2+}]$，由第一步平衡 $[\mathrm{Fe}(\mathrm{IV})]=
rac{k_{3}}{k_{3}'}\cdot
rac{[\mathrm{Fe}^{2+}][\mathrm{Cl}_{2}]}{[\mathrm{Cl}^{-}]^{2}}$

$$v = k_{4}
rac{k_{3}}{k_{3}'}\cdot
rac{[\mathrm{Fe}^{2+}]^{2}[\mathrm{Cl}_{2}]}{[\mathrm{Cl}^{-}]^{2}}$$
