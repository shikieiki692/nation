...
| $\mathrm{WO}_{3}(\mathrm{s})$ | $\Delta H_{\mathrm{f}}^{\ominus}=-842.9\ \mathrm{kJ}\cdot\mathrm{mol}^{-1}$ | $\Delta G_{\mathrm{f}}^{\ominus}=-764.1\ \mathrm{kJ}\cdot\mathrm{mol}^{-1}$ |
| --- | --- | --- |
| $\mathrm{H}_{2}\mathrm{O}(\mathrm{g})$ | $\Delta H_{\mathrm{f}}^{\ominus}=-242\ \mathrm{kJ}\cdot\mathrm{mol}^{-1}$ | $\Delta G_{\mathrm{f}}^{\ominus}=-228\ \mathrm{kJ}\cdot\mathrm{mol}^{-1}$ |
...
右图画出了 E171（晶胞参数 $a = b = 4.59 \, \text{Å}$ , c = 2.96 Å, $\alpha = \beta = \gamma = 90^{\circ}$ , $\rho = 4.25 \, g/cm^{3}$ ）的晶胞。
