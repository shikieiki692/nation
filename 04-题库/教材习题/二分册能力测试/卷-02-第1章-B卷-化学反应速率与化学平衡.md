...
| --- | --- | --- | --- |
| $Δ_fH_m(kJ·mol^{-1})$ | -1206.9 | -635.6 | -393.5 |
| $Δ_fG_m(kJ·mol^{-1})$ | -1128.8 | -604.2 | -394.4 |
...
| $c_{o}(O_{2}^{-})/mol·L^{-1}$ | $7.69×10^{-6}$ | $3.33×10^{-5}$ | $2.00×10^{-4}$ |
| --- | --- | --- | --- |
| $v_{o}/mol·L^{-1}·s^{-1}$ | $3.85×10^{-3}$ | $1.67×10^{-2}$ | 0.100 |
...
| --- | --- | --- | --- | --- | --- |
| $\Delta_fH_m^\ominus (kJ·mol^{-1})$ | -272.0 | — | — | -110.5 | -393.5 |
| $S_m^\ominus (J·mol^{-1}·K^{-1})$ | 60.75 | 27.3 | 5.74 | / | x |
