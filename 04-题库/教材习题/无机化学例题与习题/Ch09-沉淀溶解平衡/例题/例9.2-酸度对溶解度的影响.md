...
question_type: 例题
difficulty: 3
knowledge_points: ["[[溶度积常数]]", "[[溶解度]]", "[[酸效应]]", "[[同离子效应]]", "[[沉淀溶解平衡]]"]
status: 已填充
updated: 2026-07-09
...
$$
c(\mathrm{F}^{-}) = \frac{0.63}{1.63}[c(\mathrm{HF}) + c(\mathrm{F}^{-})] = \frac{0.63\times 2s}{1.63} = 0.773s
$$
...
$$
\begin{array}{r l}
& c (\mathrm{Sr} ^ {2 +}) [ c (\mathrm{F} ^ {-}) ] ^ {2} = 4. 3 \times 1 0 ^ {- 9} \\
