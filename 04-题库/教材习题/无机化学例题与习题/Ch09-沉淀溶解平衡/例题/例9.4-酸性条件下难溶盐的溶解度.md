...
$$
\begin{array}{r l}
c (\mathrm{H} ^ {+}) & = \frac {K _ {\mathrm{a}} ^ {\ominus} c (\mathrm{HF})}{\sqrt {K _ {\mathrm{sp}} ^ {\ominus} + K _ {\mathrm{a}} ^ {\ominus} c (\mathrm{HF})}} \\
& = \frac {6 . 3 \times 1 0 ^ {- 4} \times 0 . 5}{\sqrt {1 . 8 \times 1 0 ^ {- 3} + 6 . 3 \times 1 0 ^ {- 4} \times 0 . 5}} \mathrm{mol} \cdot \mathrm{dm} ^ {- 3} \\
& = 6. 8 \times 1 0 ^ {- 3} \mathrm{mol} \cdot \mathrm{dm} ^ {- 3} \\
& \mathrm{pH} = 2. 2
\end{array}
$$