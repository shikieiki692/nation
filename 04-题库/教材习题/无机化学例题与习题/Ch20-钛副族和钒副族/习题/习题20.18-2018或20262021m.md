...
> **答案**：$3\mathrm{Ti}^{3+} + \mathrm{NO}_{3}^{-} + \mathrm{H}_{2}\mathrm{O} = 3\mathrm{TiO}^{2+} + \mathrm{NO}\uparrow +2\mathrm{H}^{+}$ 或 $3\mathrm{TiCl}_3 + \mathrm{HNO}_3 + \mathrm{H}_2\mathrm{O} = 3\mathrm{TiOCl}_2 + \mathrm{NO}\uparrow +3\mathrm{HCl}$
