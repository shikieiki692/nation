...
knowledge_points: ["[[元素周期律]]", "[[分子轨道理论]]", "[[卤素]]", "[[酸碱平衡]]"]
---
...
> **答案**：（1）从 $Cl_{2}$ 到 $Br_{2}$ 到 $I_{2}$ 键的解离能逐渐下降。这与卤素原子半径大小密切相关。从 $Cl_{2}$ 到 $Br_{2}$ 到 $I_{2}$ ，因为原子半径增大，在卤素双原子分子中，核对成键电子对的引力随原子半径增大而减小，所以导致解离能呈现逐渐下降的趋势。
