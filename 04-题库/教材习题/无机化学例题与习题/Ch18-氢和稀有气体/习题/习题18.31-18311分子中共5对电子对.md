...
> **答案**：(1) $\mathrm{XeF_2}$ $\mathrm{XeF_2}$ 分子中共5对电子对， $\mathrm{Xe}$ 采取 $\mathrm{sp}^3\mathrm{d}$ 杂化，电子对构型为三角双锥形。三对孤电子对占据在两个三角锥共同的底面三角形的三个顶角上， $\mathrm{XeF_2}$ 分子构型为直线形。
