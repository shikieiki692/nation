...
<!-- 校勘注: ①题面「辉铋矿」系「辉锑矿」OCR 笔误（辉铋矿指 Bi₂S₃，与 Sb₂S₃ 不同），按题意改「辉锑矿」；②8-4 答案文字重述乱（OCR「因此体系中存在三个相：SbCl₃ 固相、SbCl₅ 液相、Cl₂ 气相。若再注入 0.11 mol Cl₂ 与 SbCl₃ 反应生成 SbCl₅...」三次重复），关键结论照录；③8-5 答案文「价法 于F的电负性大」残字，已补全；④8-6 答案文字「4 Sb₄O₅Cl₂ → SbCl₃↑ + 5 Sb₃O₄Cl」OCR 错乱，按题面失重率 8.94% 验算 ($228.5/(4\times 639)=8.94\%$ ✓) 与 Sb 守恒（$4\times 4 = 16 = 1+5\times 3$ ✓）重组为 $4\mathrm{Sb_4O_5Cl_2 \to SbCl_3\uparrow + 5Sb_3O_4Cl}$；⑤题面 8-6 末「原子量 Sb=122, O=16, Cl=35.5」按现代值 Sb=121.76、Cl=35.45，已校勘。 -->