...
module: 基础要求-有机化学
status: deprecated
superseded_by: "[[题-103-ABOC-Ch2-2.8-1-写出氢碘酸与以下物种反应的主要产物 注意碳正离子重排]]"
deprecation_reason: "原书「习题解析」节答案碎片，缺真实题干，与前段完整题卡 题-103 为同一题，按一题一卡收口标废（2026-09-22 题库体检 P0-3 修复）"
subject_module: 有机化学
pack: 章节练习
...
> [!warning] 已弃用（2026-09-22）：本文件为原书「习题解析」节的答案碎片，缺真实题干，与完整题卡 [[题-103-ABOC-Ch2-2.8-1-写出氢碘酸与以下物种反应的主要产物 注意碳正离子重排]] 为同一题，已按「一题一卡」收口标记 deprecated；组卷与检索请使用该完整题卡。
