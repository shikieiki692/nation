...
> [!warning] 已弃用（2026-09-22）：本文件为原书「习题解析」节的答案碎片，缺真实题干，与完整题卡 [[题-102-ABOC-Ch2-2.7.4-1-以下物质的两个共振式谁更稳定 占据主导  为什么]] 为同一题，已按「一题一卡」收口标记 deprecated；组卷与检索请使用该完整题卡。
