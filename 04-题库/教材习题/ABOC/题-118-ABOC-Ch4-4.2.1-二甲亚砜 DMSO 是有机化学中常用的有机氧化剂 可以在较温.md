---
title: 题-118-ABOC-Ch4-4.2.1-二甲亚砜 DMSO 是有机化学中常用的有机氧化剂 可以在较温.md
type: 题目
...
二甲亚砜 DMSO 是有机化学中常用的有机氧化剂，可以在较温和的条件下将醇氧化为醛酮。以下列出其作为氧化剂的几种条件，画出 DMSO被活化后的中间体的结构式（接下来与醇发生反应）。
