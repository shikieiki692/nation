...
knowledge_points: ["[[离域π键]]", "[[碳正离子稳定性]]", "[[离去基团活性]]"]
...
试分析下列分子的成键情况，比较 Cl 的活泼性，并说明理由：(1) $\mathrm{C_6H_5Cl}$；(2) $\mathrm{C_6H_5CH_2Cl}$；(3) $(\mathrm{C_6H_5})_2\mathrm{CHCl}$；(4) $(\mathrm{C_6H_5})_3\mathrm{CCl}$。

## 答案

（1）在 $\mathrm{C_6H_5Cl}$ 分子中，一方面，C 原子相互间通过 $sp^{2}-sp^{2}$ 杂化轨道重叠形成 C—Cσ 键，另一方面，一个 C 原子与 Cl 原子间通过 $sp^{2}-3p$ 轨道重叠形成 C—Clσ 键。此外，6 个 C 原子和 Cl 原子通过 p 轨道重叠，形成垂直于分子平面的离域 π 键 $\pi_{7}^{8}$ 。由于 Cl 原子参与形成离域 π 键，因而其活性较低。
...
（4）在 $(\mathrm{C}_6\mathrm{H}_5)_3\mathrm{CCl}$ 分子中, C 原子形成 $\sigma$ 键的情形与上述两分子相似。非苯环上的 C 原子也不参与共轭, 分子中有 3 个 $\pi_6^6$ 。当 Cl 原子解离后, 非苯环上的 C 原子改用 $\mathrm{sp}^2$ 杂化轨道形成 $\sigma$ 键, 剩余的 p 轨道与 18 个 C 原子的 p 轨道重叠, 形成更大更稳定的离域 $\pi$ 键 $\pi_{19}^{18}$ , 这使得 $(\mathrm{C}_6\mathrm{H}_5)_3\mathrm{CCl}$ 分子中的 Cl 原子在这 4 个分子中最活泼。
