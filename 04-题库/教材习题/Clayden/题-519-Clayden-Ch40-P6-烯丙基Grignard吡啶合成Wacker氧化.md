...
updated: 2026-07-25
aliases: [Clayden-Ch40-P6]
source: Clayden Organic Chemistry 2nd Ed. Chapter 40 Problem 6
...
pack: 章节练习
---
# 题-519: 烯丙基Grignard+吡啶合成+Wacker氧化
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| Wacker氧化 | Pd(II)催化烯烃水合→酮的机理 | 直接 |
| [[Grignard试剂]] | 烯丙基Grignard的γ-区域选择性 | 直接 |
| [[金属有机化学]] | Pd催化循环（Wacker过程） | 直接 |
| [[杂环化合物]] | 氨+二羰基→吡啶的缩合 | 间接 |

## 解题思路

1. **读题定位**：三步序列→烯丙基加成→Wacker氧化→吡啶合成
2. **关键转换**：Grignard γ-加成→硅烯醇醚水解→醛→Wacker→酮→NH₃缩合→吡啶
3. **验证**：检查每步区域选择性，吡啶环的取代模式

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| Grignard从α-位进攻 | 不熟悉烯丙基金属的区域选择性 | 烯丙基M从γ-位进攻（远离金属端） | SN2'型进攻的驱动力是什么？ |
| Wacker氧化产物画成醛 | 内烯烃Wacker→酮 | 只有端烯才给醛，内烯烃给酮 | Wacker氧化的区域选择性规则？ |
| 吡啶缩合步骤遗漏 | 不熟悉杂环合成 | 需要双重缩合+脱水+芳构化 | 为什么吡啶比吡咯更稳定？ |