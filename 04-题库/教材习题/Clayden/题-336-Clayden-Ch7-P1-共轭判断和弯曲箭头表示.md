...
teaching_level: 巩固
syllabus_codes: ["21"]
knowledge_points: ["[[共轭效应]]", "[[离域效应]]"]
tags: [化竞, Clayden, 有机化学]
updated: 2026-07-25
aliases: [Clayden-Ch7-P1]
source: Clayden Organic Chemistry 2nd Ed. Chapter 7 Problem 1
cross_references: ["[[题-337-Clayden-Ch7-P2-复杂化合物中共轭体系范围]]", "[[题-340-Clayden-Ch7-P5-化合物芳香性电子计数]]", "[[题-381-Clayden-Ch21-P1-复杂化合物中芳香环识别]]"]
module: 有机化学
status: 已填充
---
# 题-336: 共轭判断和弯曲箭头表示
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[共轭效应]] | 判断分子中哪些部分形成共轭体系 | 直接 |
| [[离域效应]] | 共轭体系中电子的离域分布 | 直接 |
| [[共振论]] | 用弯曲箭头表示共轭体系的共振结构 | 间接 |

## 解题思路

1. **读题定位**：题目要求判断哪些分子是共轭的，并用合理方式解释。需要逐个分析每个化合物中的π体系和p轨道排列
2. **🔑 关键转换**：找出所有相邻的sp²杂化原子（或含孤对电子的杂原子），判断是否存在连续的p轨道重叠。注意酯基中O的孤对电子本身就构成共轭
3. **验证**：用弯曲箭头验证——能否画出至少两个合理的共振结构？如果能，则该部分为共轭体系

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 将孤立双键误判为共轭 | 忽略了sp³碳打断p轨道重叠 | sp³杂化碳原子的四个键均为σ键，无p轨道，会阻断共轭 | 两个双键之间隔一个sp³碳还能共轭吗？ |
| 忘记酯基中的共轭 | 只关注C=C和C=O，忽略杂原子孤对电子 | 酯中O的孤对电子可与C=O共轭（p-π共轭），这是酯基的基本特征 | 酯键为什么有部分双键性质？ |
| 混淆共振箭头和平衡箭头 | 使用了双头箭头表示平衡 | 共振结构之间用双头箭头（↔）表示，反应平衡用可逆箭头（⇌） | 共振结构和互变异构有什么区别？ |