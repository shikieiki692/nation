...
3. **光学纯起始原料**：关键在于使用单一对映体的起始原料——当两个片段都是光学纯的，S_N2取代只会产生一种非对映异构体

> **核心概念**：对于距离较远的手性中心（1,5-或更远），直接的立体化学控制不可行。策略是通过逆合成断开，分别控制每个手性中心的绝对构型，然后通过S_N2等立体专一性反应连接。
...
| [[非对映选择性]] | 光学纯原料+S_N2→单一对映体 | 直接 |
| [[手性中心]] | 远距离手性中心的逆合成断开 | 间接 |

## 解题思路

1. **读题定位**：解释相对立体化学的控制——识别产物为1,5-相关的二醇衍生物
2. **关键转换**：1,5-关系太远→无法直接控制→逆合成断开→一侧阴离子稳定基团+一侧离去基团→光学纯原料+S_N2→单一非对映异构体
