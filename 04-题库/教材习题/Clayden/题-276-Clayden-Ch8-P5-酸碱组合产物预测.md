---
title: 题-276-Clayden-Ch8-P5-酸碱组合产物预测
type: 题目
fidelity: 原书逐字
submodule: 酸碱质子理论
exam_stage: 初赛
...
updated: 2026-07-25
aliases: [Clayden-Ch8-P5]
source: Clayden Organic Chemistry 2nd Ed. Chapter 8 Problem 5
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[pKa]] | 通过pKa比较判断酸碱反应平衡方向 | 直接 |
| [[酸碱强度]] | 诱导效应对酸性的影响（F取代增强酸性） | 直接 |
| [[酸碱质子理论]] | Brønsted酸碱反应的平衡原理 | 间接 |

## 解题思路

1. **读题定位**：识别各反应中的酸和碱，查出pKa值，比较酸性强弱。
2. **🔑 关键转换**：反应平衡偏向较弱酸（pKa较大）的方向，K = 10^(pKa(产物酸) - pKa(反应物酸))。
3. **验证**：(a) K ≈ 10^5.25，平衡远在右侧；(c) CF3CO2H pKa ≈ 0.5，比乙酸强约5个pKa单位。

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 认为平衡偏向强酸方向 | 平衡总是偏向较弱酸（较稳定）方向 | 强酸驱动反应完成 | 为什么平衡偏向弱酸？ |
| 混淆pKa与Ka | pKa = -log(Ka)，pKa越小酸性越强 | 明确pKa与酸性关系 | pKa和Ka的关系是什么？ |
| 忽略诱导效应 | CF3吸电子使COOH酸性增强 | 吸电子基增强酸性 | 为什么CF3CO2H比AcOH强？ |