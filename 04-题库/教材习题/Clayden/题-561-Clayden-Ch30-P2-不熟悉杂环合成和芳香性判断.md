...
updated: 2026-07-25
aliases: [Clayden-Ch30-P2]
source: Clayden Organic Chemistry 2nd Ed. Chapter 30 Problem 2
...
关键步骤：
1. **芳香性判断**：左环是苯环（显然芳香）。右环含两个双键（4e）+氧孤对电子（2e）= 6e，满足4n+2规则。整个体系可看作10电子芳香分子
2. **反应机理**（Pechmann反应，1883年发现）：(a) 酯交换（transesterification）——酚羟基进攻β-酮酯的酯基；(b) 分子内环化——在酚的邻位（对位另一个OH）发生亲电环化
3. **区域选择性**：环化可以发生在两个OH之间的位点（两个OH都是邻对位定位基），但实际选择的位点在位阻和电子效应上都更有利

> **历史意义**：Pechmann反应（1883）是合成香豆素类化合物的经典方法。

## 知识点映射

| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[杂环化合物]] | 香豆素的结构和芳香性判断 | 直接 |
| [[芳香性]] | 10电子稠环体系的芳香性（6e杂环+苯环） | 直接 |
| [[杂环合成]] | Pechmann反应：酯交换+分子内环化 | 直接 |
| [[区域选择性]] | 酚的邻/对位环化选择（位阻+电子效应） | 间接 |

## 解题思路

1. **读题定位**：酚+β-酮酯→稠合内酯——识别为Pechmann反应
2. **🔑 关键转换**：酚OH进攻酯基（酯交换）→分子内亲电环化（酚邻位）→脱水→香豆素
3. **验证**：数π电子判断芳香性——右环6e（2个双键+O孤对）满足4n+2

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 认为右环不芳香 | 忘记氧孤对电子参与共轭 | O的孤对电子贡献2e，使右环达到6e芳香 | 如果O换成C，环还芳香吗？ |
| 环化位点画在两OH之间 | 没考虑位阻效应 | 两OH之间位阻大，实际环化在另一个邻位 | 为什么位阻因素在此很重要？ |
| 没识别酯交换步骤 | 直接画环化 | 第一步是酚OH对酯基的亲核进攻（酯交换） | 酯交换和直接环化有什么区别？ |