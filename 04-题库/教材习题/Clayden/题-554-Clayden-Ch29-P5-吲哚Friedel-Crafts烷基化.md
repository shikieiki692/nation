...
updated: 2026-07-25
aliases: [Clayden-Ch29-P5]
source: Clayden Organic Chemistry 2nd Ed. Chapter 29 Problem 5
...
关键步骤：
1. **Lewis酸活化**：AlCl₃与烯丙基溴络合，生成烯丙基碳正离子（或等效的Lewis酸-底物络合物）
2. **3位亲电进攻**：吲哚的3位是亲电取代的优先位点（教材pp.745-746解释了为什么是3位而非2位）。碳正离子进攻3位形成σ-络合物
3. **1,2-迁移（重排）**：苄基从3位迁移到2位——这是一个Wagner-Meerwein型重排。2位有可失去的质子以恢复芳香性
4. **去质子化**：2位失去质子，恢复吲哚的芳香性，得到最终产物

> **核心概念**：吲哚的3位是亲电取代的动力学位点，但迁移后可获得热力学更稳定的产物。

## 知识点映射

| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[吲哚]] | 吲哚3位的高亲核性（富电子杂环） | 直接 |
| Friedel-Crafts反应 | Lewis酸催化的烯丙基化反应机理 | 直接 |
| [[重排反应]] | 1,2-迁移（Wagner-Meerwein重排）在吲哚化学中的应用 | 直接 |
| [[芳香性]] | 去质子化恢复吲哚芳香性 | 间接 |

## 解题思路

1. **读题定位**：吲哚+烯丙基溴+Lewis酸——经典的Friedel-Crafts烷基化条件
2. **🔑 关键转换**：吲哚3位被碳正离子进攻→σ-络合物→1,2-迁移将基团搬到2位→去质子化恢复芳香性
3. **验证**：检查最终产物的2,3位取代模式是否符合迁移结果

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 直接在2位发生取代 | 没理解3位是动力学有利的进攻位点 | 亲电试剂先在3位进攻，再通过迁移到2位 | 吲哚的2位和3位哪个亲核性更强？ |
| 忘记画1,2-迁移步骤 | 不熟悉吲哚的重排化学 | 必须经过重排才能解释产物的取代模式 | 为什么迁移优先于直接2位进攻？ |
| 没有恢复芳香性 | 机理画到碳正离子就停了 | 必须有去质子化步骤恢复芳香六元体系 | 芳香性恢复的驱动力是什么？ |