...
updated: 2026-07-25
aliases: [Clayden-Ch13-P2]
source: Clayden Organic Chemistry 2nd Ed. Chapter 13 Problem 2
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[NMR谱学]] | ¹H和¹³C NMR区分不同羰基化合物 | 直接 |
| [[波谱分析]] | IR、¹³C NMR、¹H NMR综合运用 | 直接 |
| [[红外光谱]] | 羰基伸缩振动频率与结构的关系 | 直接 |
| [[对称性]] | 分子对称性对NMR信号的影响 | 间接 |

## 解题思路

1. **读题定位**：题目要求用IR和¹³C NMR区分MeMgBr与环酐反应的可能产物，再说明¹H NMR如何简化任务
2. **🔑 关键转换**：识别不同产物的官能团差异（酯/酮/酸）→对应IR特征吸收和¹³C化学位移→利用对称性和积分用¹H NMR进一步区分
3. **验证**：逐一检查每种光谱数据是否与预期产物结构一致

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 混淆酯和酸的C=O频率 | 没有区分不同羰基环境 | 酯约1775 cm⁻¹，酸约1715 cm⁻¹ + 宽OH峰 | 内酯的C=O频率为什么比开链酯高？ |
| 忽略对称性对¹H NMR的影响 | 没有分析分子对称元素 | 对称分子中等价H合为一个信号，积分比不同 | 第二个产物为什么只有一个6H singlet？ |
| 只看化学位移不看积分 | 忽略¹H NMR的积分信息 | 积分比反映不同类型H的数目比 | 如何从积分比推断分子中的甲基数目？ |