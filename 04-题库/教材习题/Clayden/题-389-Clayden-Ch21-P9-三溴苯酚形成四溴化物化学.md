...
source: Clayden Organic Chemistry 2nd Ed. Chapter 21 Problem 9
cross_references: ["[[题-337-Clayden-Ch7-P2-复杂化合物中共轭体系范围]]", "[[题-336-Clayden-Ch7-P1-共轭判断和弯曲箭头表示]]", "[[题-524-Clayden-Ch41-P1-循环中间体创建新手性中心]]", "[[题-525-Clayden-Ch41-P2-拆分法规划不对称合成入门]]"]
module: 有机化学
status: 已填充
---
# 题-389: 三溴苯酚形成四溴化物化学
...
本题考察苯酚的超常反应活性和芳香性暂时丧失的化学。

关键要点：
1. **苯酚的超高活性**：苯酚极其活泼，即使所有邻对位都已被溴化，仍可在有机溶剂中继续反应
2. **第四溴的加成**：第四个Br加在para位（已有一个Br的位置），形成碳正离子中间体
3. **失去芳香性**：由于para位没有H可以失去来恢复芳香性，分子选择失去酚OH的H→产物暂时失去芳香性
4. **选择性**：宁愿失去芳香性也不在meta位溴化——这说明meta位溴化的能垒极高
5. **溴转移反应**：四溴化物可以作为溴化试剂，将Br转移给其他底物（如胺）。选择性由空间位阻决定（NMe₂大，CF₃小）

> **核心概念**：苯酚的反应活性如此之高，以至于可以发生"过度溴化"——在已完全取代的芳环上继续加成，甚至暂时牺牲芳香性。

## 知识点映射

| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[芳香亲电取代]] | 苯酚的超常溴化活性与过度溴化 | 直接 |
| [[苯酚]] | -OH的强活化作用与亲电取代 | 直接 |
| [[活化基]] | -OH作为最强活化基之一的作用 | 间接 |
| [[芳香性]] | 芳香性的暂时丧失与恢复 | 间接 |

## 解题思路

1. **读题定位**：题目要求解释三溴苯酚如何进一步反应形成四溴化物
2. **🔑 关键转换**：苯酚极其活泼→第四个Br加在para位→para位无H可失去→失去酚H→产物暂时失去芳香性→这是比meta位溴化更有利的路径
3. **验证**：检查四溴化物的结构是否合理；检查溴转移反应的选择性是否符合空间位阻预测

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 认为三溴苯酚不能再反应 | 不了解苯酚的超常活性 | 苯酚极其活泼，即使邻对位都被占据仍可继续反应 | 苯酚的反应活性比苯高多少倍？ |
| 不理解为什么会失去芳香性 | 认为芳香性总是会被保持 | 在特定条件下，过度反应可以暂时牺牲芳香性，因为meta位溴化的能垒更高 | 什么条件下会优先恢复芳香性？ |
| 未理解溴转移反应的选择性 | 忽略空间位阻 | NMe₂比CF₃大得多，溴转移到位阻较小的CF₃邻位 | 为什么说四溴化物是"有用的溴化试剂"？ |