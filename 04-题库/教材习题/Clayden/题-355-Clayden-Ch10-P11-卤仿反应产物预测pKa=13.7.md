...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[羧酸衍生物]] | 酮的亲核加成-消除反应 | 直接 |
| [[pKa]] | 用pKa值预测离去基团能力 | 直接 |
| [[卤仿反应]] | 甲基酮与碱反应生成卤仿和羧酸盐 | 间接 |
| [[离去基团]] | Br₃C⁻作为离去基团的可行性 | 间接 |

## 解题思路

1. **读题定位**：题目要求预测酮与NaOH反应的产物，并利用CHBr₃的pKa值。
2. **🔑 关键转换**：理解OH⁻进攻酮羰基后，Br₃C⁻可以作为离去基团（pKa = 13.7），生成羧酸，然后发生酸碱中和。
3. **验证**：检查产物是否符合卤仿反应的特征：羧酸盐 + 卤仿。
