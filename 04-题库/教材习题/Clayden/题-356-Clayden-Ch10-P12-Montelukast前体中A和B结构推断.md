---
title: 题-356-Clayden-Ch10-P12-Montelukast前体中A和B结构推断
type: 题目
fidelity: 原书逐字
submodule: 羧酸衍生物
exam_stage: 初赛
...
| [[羧酸衍生物]] | 酯的还原和酰化反应 | 直接 |
| [[波谱分析]] | 利用IR和质谱推断结构 | 直接 |
| [[还原反应]] | LiAlH₄还原酯的机理和选择性 | 间接 |
| [[酯化反应]] | 醇与酰氯的酯化反应 | 间接 |

## 解题思路

1. **读题定位**：题目要求根据反应和光谱数据推断化合物A和B的结构。
2. **🔑 关键转换**：利用IR光谱判断官能团（醇、羰基的存在与否），结合质谱确定分子量。
3. **验证**：检查推断的结构是否与所有光谱数据一致。
