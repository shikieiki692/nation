---
title: 题-350-Clayden-Ch10-P6-丁二酸酐选择性形成二酯vs单酯
type: 题目
fidelity: 原书逐字
submodule: 羧酸衍生物
exam_stage: 初赛
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[羧酸衍生物]] | 酸酐的选择性开环和酯化 | 直接 |
| [[化学选择性]] | 不同条件下选择性生成单酯或二酯 | 直接 |
| [[四面体中间体]] | 四面体中间体的形成和分解选择性 | 间接 |
| [[酯化反应]] | 酸催化和碱催化酯化的区别 | 间接 |

## 解题思路

1. **读题定位**：题目要求解释为什么不同条件下环酸酐可以生成单酯或二酯。
2. **🔑 关键转换**：理解碱性条件下羧酸根负离子的稳定性（阻止进一步反应），以及酸性条件下质子化使羧酸重新活化。
3. **验证**：检查pKa值，确认离去基团选择的正确性。
