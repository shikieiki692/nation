...
updated: 2026-07-25
aliases: [Clayden-Ch14-P1]
source: Clayden Organic Chemistry 2nd Ed. Chapter 14 Problem 1
...
判断手性的唯一标准：是否存在对称面（mirror plane）？

| 分子 | 手性？ | 分析 |
|------|:---:|------|
| 分子1（二元酸） | ✗ 非手性 | 两个CO₂H基团相同→有对称面 |
| 分子2（环状） | ✓ 手性 | 四面体中心：环平面和垂直平面都不是对称面 |
| 分子3（环己醇） | ✗ 非手性 | 高对称性——所有CH₂等价→有对称面 |
| 分子4（螺环） | ✗ 非手性 | 垂直于纸面的对称面 |
| 分子5（螺缩醛） | ✓ 手性 | 中心sp³碳→两环正交→氧破坏对称面 |
...
1. **读题定位**：5个分子逐个判断对称面→有则非手性，无则手性
2. **🔑 关键转换**：不要找"手性碳"！直接找对称面。分子2最容易错——看似有对称面但画出四面体后发现没有
3. **验证**：分子5螺缩醛——中心sp³碳使两环正交，氧原子破坏潜在对称面

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 看到"四个不同基团"就认为手性 | 用错误标准 | 手性唯一标准是对称面，不是手性碳 | 没有手性碳但有手性的分子存在吗？ |
| 分子1判断为手性 | 被两种画法误导 | CO₂H两种画法代表同一基团→有对称面 | 如何快速判断两个基团是否相同？ |
| 分子2判断为非手性 | 没画出四面体 | 必须考虑四面体几何——环平面不是对称面 | 为什么环上碳不都在同一平面？ |