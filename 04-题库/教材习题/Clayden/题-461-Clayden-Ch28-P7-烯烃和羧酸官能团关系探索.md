---
title: 题-461-Clayden-Ch28-P7-烯烃和羧酸官能团关系探索
type: 题目
fidelity: 原书逐字
submodule: 逆合成分析
exam_stage: 初赛
...
updated: 2026-07-25
aliases: [Clayden-Ch28-P7]
source: Clayden Organic Chemistry 2nd Ed. Chapter 28 Problem 7
...
三种化合物中烯烃和COOH的距离关系不同，决定了合成策略：

**化合物1（共轭，1,2-关系）**：
- 烯烃与C=O共轭→alpha,beta-不饱和羰基
- 最佳方法：Aldol缩合
- 需要特定烯醇等价物控制选择性
- 选择：Wittig试剂、丙二酸酯或硅烯醇醚

**化合物2（非共轭，1,3-关系）**：
- 烯烃和COOH间隔一个碳→非共轭
- 困难：容易异构化到共轭位置
- 解决方案：用CN-作为-CO2H的合成等价物
- 电亲体是烯丙基卤→SN2反应→避免异构化

**化合物3（末端烯烃，1,4-关系）**：
- 末端烯烃和COOH
- 最佳策略：丙二酸酯 + 烯丙基溴 → 烷基化 → 水解 → 脱羧
- 这是丙二酸酯合成的经典应用
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[逆合成分析]] | 利用官能团间距选择合成策略 | 直接 |
| FGI | 官能团互变在逆合成中的应用 | 直接 |
| [[官能团互变]] | CN-作为COOH的合成等价物 | 直接 |
| [[Aldol缩合]] | 1,2-共轭关系的合成 | 间接 |

## 解题思路

1. 读题定位：三个含烯烃和COOH的化合物，间距不同
2. 关键转换：
   - 1,2-共轭→Aldol缩合
   - 1,3-非共轭→CN-合成等价物+烯丙基卤
   - 1,4-→丙二酸酯+烯丙基溴+脱羧
3. 验证：每种关系对应正确的合成方法
...
| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 用简单酯化做化合物1 | 没识别1,2-共轭关系 | 1,2-共轭→Aldol缩合产物，不是酯 | alpha,beta-不饱和酸如何合成？ |
| 忽略化合物2的异构化风险 | 非共轭烯烃容易异构化到共轭 | 用CN-/烯丙基卤避免异构化 | 为什么非共轭烯烃容易异构化？ |
| 用Grignard直接加成到CO2 | 不能精确控制C-C键位置 | 丙二酸酯合成法更灵活 | 丙二酸酯合成的应用范围是什么？ |