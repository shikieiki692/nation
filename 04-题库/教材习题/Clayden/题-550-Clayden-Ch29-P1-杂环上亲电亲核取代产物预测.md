---
title: 题-550-Clayden-Ch29-P1-杂环上亲电亲核取代产物预测
type: 题目
submodule: 杂环化合物
exam_stage: 初赛
subject: 有机化学
...
updated: 2026-07-25
aliases: [Clayden-Ch29-P1]
source: Clayden Organic Chemistry 2nd Ed. Chapter 29 Problem 1
cross_references: ["[[题-561-Clayden-Ch30-P2-不熟悉杂环合成和芳香性判断]]", "[[题-560-Clayden-Ch30-P1-吡咯并吡啶三环芳香杂环合成]]"]
module: 有机化学
status: 已填充
---
# 题-550: 杂环上亲电/亲核取代产物预测
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[杂环化合物]] | 吡咯、喹啉、噻吩、吡啶的不同反应性 | 直接 |
| [[亲电取代]] | 富电子杂环（吡咯/噻吩）vs 缺电子杂环（吡啶）的反应位点选择 | 直接 |
| [[芳香亲核取代]] | 吡啶的SNAr反应：负电荷离域到氮上的选择性 | 直接 |
| [[芳香性]] | 吡啶氮的吸电子效应使苯环被活化（间接活化） | 间接 |

## 解题思路

1. **读题定位**：四个反应分别涉及吡咯、喹啉、噻吩和吡啶——先判断每个杂环是富电子还是缺电子
2. **🔑 关键转换**：富电子杂环（吡咯/噻吩）→亲电取代；缺电子杂环（吡啶）→亲核取代
3. **验证**：检查产物是否符合杂环的电子效应——吡咯的α位（2,5位）优先；吡啶的2/4位亲核取代

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 将喹啉硝化画在吡啶环上 | 忽略了氮的吸电子效应 | 吡啶氮使吡啶环缺电子，亲电取代优先在苯环上进行 | 喹啉中哪个环更缺电子？ |
| 吡啶亲核取代画在3位 | 没考虑中间体电荷分布 | 亲核进攻必须在2或4位，负电荷才能离域到氮上 | 为什么吡啶3位不适合亲核取代？ |
| 噻吩酰基化画在3位 | 忽略了硫的给电子效应 | 噻吩的α位（2位）电子密度最高，亲电取代优先 | 噻吩和吡咯的反应性哪个更高？ |