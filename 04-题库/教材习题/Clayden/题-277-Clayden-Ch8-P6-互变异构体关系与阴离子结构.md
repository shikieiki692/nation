---
title: 题-277-Clayden-Ch8-P6-互变异构体关系与阴离子结构
type: 题目
fidelity: 原书逐字
submodule: 酸碱质子理论
exam_stage: 初赛
...
teaching_level: 拓展
syllabus_codes: []
knowledge_points: ["[[pKa]]", "[[互变异构]]"]
tags: [化竞, Clayden, 有机化学]
updated: 2026-07-25
aliases: [Clayden-Ch8-P6]
source: Clayden Organic Chemistry 2nd Ed. Chapter 8 Problem 6
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[pKa]] | 互变异构体酸性相同，去质子化产物相同 | 直接 |
| [[互变异构]] | 酮-烯醇/酰胺-亚胺互变异构的本质 | 直接 |
| [[离域效应]] | 去质子化后阴离子的共振稳定化 | 间接 |

## 解题思路

1. **读题定位**：识别两个分子为互变异构体，氢在N和O之间移动。
2. **🔑 关键转换**：去质子化后，负电荷通过共振离域在N和O上，两个互变异构体给出相同的阴离子。
3. **验证**：画出两个互变异构体的去质子化产物，确认共振结构相同。

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 认为两个互变异构体是不同化合物 | 互变异构体在溶液中快速互变，是同一化合物的两种形式 | 它们是互变异构体，本质上是同一物质 | 互变异构和异构有什么区别？ |
| 忽略阴离子的离域稳定化 | 阴离子的负电荷离域在N和O上 | 共振结构使阴离子稳定 | 为什么去质子化后阴离子稳定？ |
| 认为N和O的酸性相同 | N-H和O-H的pKa不同，但互变异构体去质子化产物相同 | 关键是去质子化后的阴离子相同 | 为什么两个互变异构体的pKa相同？ |