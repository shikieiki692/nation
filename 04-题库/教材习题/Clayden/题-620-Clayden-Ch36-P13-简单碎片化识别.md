---
title: 题-620-Clayden-Ch36-P13-简单碎片化识别
type: 题目
fidelity: 原书逐字
submodule: 重排反应
exam_stage: 初赛
...
updated: 2026-07-25
aliases: [Clayden-Ch36-P13]
source: Clayden Organic Chemistry 2nd Ed. Chapter 36 Problem 13
cross_references: ["[[题-433-Clayden-Ch24-P2-不饱和羰基直接共轭加成区域选择性]]", "[[题-515-Clayden-Ch40-P2-Heck反应机理步骤理解]]", "[[题-432-Clayden-Ch24-P1-氨基醇制备中区域选择性试剂选择]]", "[[题-514-Clayden-Ch40-P1-烯醇醚溴化WittigPd化学入门]]"]
module: 有机化学
status: 已填充
subject_module: 有机化学
pack: 章节练习
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[Grob碎裂化反应]] | 一步碎片化的基本机理和三要素 | 直接 |
| [[重排反应]] | 碎片化作为C-C键断裂的重排类型 | 直接 |
| [[机理书写]] | 通过编号追踪原子位置变化 | 直接 |
| [[离去基团]] | mesylate和羧酸根作为离去基团的区别 | 间接 |
| [[构象分析]] | 碎片化前必须满足反式共面排列 | 间接 |

## 解题思路

1. **读题定位**：题目明确说"find fragmentations by numbers"——需要用编号法追踪原子，然后画出碱性条件下一步碎片化的机理。关键词：one-step fragmentations, basic solution, acidic work-up
2. **🔑 关键转换**：识别六元环的1-6编号→找到OH和离去基团的位置→碱拔OH→O⁻孤对电子推动C-C键断裂→离去基团离去→产物
3. **验证**：检查编号是否在产物中一致；检查离去基团是否正确识别（第一个是OMs，第二个是CO₂⁻）；检查O⁻-断裂键-离去基团是否反式共面

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 编号追踪出错 | 没有仔细追踪每个碳原子的位置变化 | 应该用虚线标出断裂键和新形成键，确保编号一致 | 碎片化后哪些键断裂了？哪些键形成了？ |
| 离去基团识别错误 | 没有理解碎片化中"push"和"pull"的关系 | O⁻是push，mesylate/CO₂⁻是pull——两者缺一不可 | 为什么第二个底物中CO₂⁻是离去基团而不是OH？ |
| 忽略构象要求 | 只画平面机理没考虑立体化学 | O⁻孤对电子、断裂键、离去基团键必须反式共面 | 如果这三个基团不在平行位置，碎片化能发生吗？ |
| 忘记酸性work-up | 产物中负离子未质子化 | 碎片化后需酸性work-up才能得到中性产物 | 碱性条件下产物是什么形式？ |