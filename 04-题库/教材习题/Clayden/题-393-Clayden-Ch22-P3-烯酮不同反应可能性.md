...
updated: 2026-07-25
aliases: [Clayden-Ch22-P3]
source: Clayden Organic Chemistry 2nd Ed. Chapter 22 Problem 3
...
关键步骤：
1. **反应1——烯醇化+硅捕获**：碱夺取α-H生成烯醇负离子，然后被TMSCl捕获形成硅烯醇醚。这是热力学控制的可逆过程，产物保留了C=C双键
2. **反应2——直接加成（1,2-加成）**：硬的、不可逆的亲核试剂（如RLi或R₂CuLi以外的Grignard试剂）直接进攻C=O碳，形成C-C键。这是动力学控制的过程
3. **反应3——共轭加成（1,4-加成）**：软的、可逆的亲核试剂（如铜锂试剂R₂CuLi或硫醇）进攻β-碳，通过共轭体系传递电子。这是热力学控制的过程

> **核心概念**：硬亲核试剂→直接加成（1,2）；软亲核试剂→共轭加成（1,4）；碱→烯醇化。这三种反应模式的选择取决于试剂的软硬度和反应条件。

## 知识点映射

| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[共轭加成]] | 软亲核试剂的1,4-共轭加成 | 直接 |
| [[Michael加成]] | α,β-不饱和羰基化合物的共轭加成反应 | 直接 |
| [[亲电加成]] | 硬亲核试剂对C=O的1,2-直接加成 | 间接 |

## 解题思路

1. **读题定位**：题目要求解释三种不同反应结果——同一个烯酮底物在不同条件下产生三种不同产物
2. **🔑 关键转换**：烯酮有三个反应位点：α-H（烯醇化）、C=O碳（直接加成）、β-碳（共轭加成）→ 试剂的软硬度决定反应路径
3. **验证**：检查每种产物是否与对应试剂匹配——TMSCl→硅烯醇醚、硬亲核试剂→醇、软亲核试剂→共轭加成产物

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 混淆硬/软亲核试剂的加成模式 | 对HSAB理论理解不深 | 硬亲核试剂→1,2-直接加成；软亲核试剂→1,4-共轭加成 | R₂CuLi为什么是软亲核试剂？ |
| 忽略烯醇化竞争 | 只考虑加成反应 | 碱存在时α-H可被夺取，与加成反应竞争 | 烯醇化和共轭加成如何竞争？ |
| 认为三种反应互不相关 | 没有理解它们是同一底物的不同反应模式 | 三种反应都是烯酮的典型反应，选择取决于试剂和条件 | 如何预测一个试剂会进行哪种反应？ |