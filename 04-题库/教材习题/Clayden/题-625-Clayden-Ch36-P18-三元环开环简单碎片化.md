...
teaching_level: 拓展
syllabus_codes: ["21"]
knowledge_points: ["[[Grob碎裂化反应]]", "[[环张力]]"]
tags: [化竞, Clayden, 有机化学, 重排反应, 碎片化, 三元环]
updated: 2026-07-25
aliases: [Clayden-Ch36-P18]
source: Clayden Organic Chemistry 2nd Ed. Chapter 36 Problem 18
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[Grob碎裂化反应]] | 三元环碎片化的机理和push-pull要求 | 直接 |
| [[环张力]] | 三元环张力使C-C键容易断裂 | 直接 |
| [[重排反应]] | 三元环开环作为重排的一种形式 | 直接 |
| [[酯的水解]] | 碱催化酯水解为碎片化提供O⁻推电子基团 | 间接 |
| [[烯醇负离子]] | 烯醇负离子作为碎片化中的离去基团 | 间接 |

## 解题思路

1. **读题定位**：题目要求给出两个反应的机理，解释第一个反应的烯烃立体化学，并讨论它们是否算"碎片化"。关键词：alkene geometry, do you consider fragmentations
2. **🔑 关键转换**：第一个反应——三元环张力驱动C-C键断裂（无push），热力学控制烯烃构型；第二个反应——酯水解→O⁻推动碎片化，烯醇负离子离去
3. **验证**：检查三元环是否正确开环；检查烯烃立体化学是否为热力学更稳定的构型；检查两个反应中是否都有C-C键断裂

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 第一个反应也画push | 没理解三元环的特殊性 | 三元环张力大，即使没有push也能断裂——这是三元环的特殊性质 | 为什么四元环碎片化需要push但三元环不一定？ |
| 烯烃构型画成动力学产物 | 没考虑热力学控制 | 第一个反应的烯烃构型是热力学控制的，通常trans更稳定 | 如何判断烯烃的热力学稳定性？ |
| 第二个反应忘记酯水解 | 直接画碎片化 | 必须先NaOH水解酯基得到O⁻，才能推动碎片化 | 碱性条件下酯会发生什么反应？ |
| 认为两个反应都不是碎片化 | 对碎片化定义理解太窄 | 两者都涉及C-C键断裂，至少第二个是经典碎片化；第一个有争议但可以称为碎片化 | 碎片化的定义是什么？ |