...
updated: 2026-07-25
aliases: [Clayden-Ch8-P4]
source: Clayden Organic Chemistry 2nd Ed. Chapter 8 Problem 4
cross_references: ["[[题-274-Clayden-Ch8-P3-羟基酸在不同pH下的存在形式]]", "[[题-282-Clayden-Ch8-P11-选择合适的碱去质子化给定分子]]"]
module: 有机化学
status: 已填充
subject_module: 有机化学
pack: 章节练习
---
# 题-275: 三个分子的质子化/去质子化位点
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[pKa]] | 通过pKa比较选择质子化/去质子化位点 | 直接 |
| [[有机酸碱性]] | 胺、醇、炔烃碱性和酸性的比较 | 直接 |
| [[离域效应]] | 质子化/去质子化后阳离子/阴离子的稳定性 | 间接 |

## 解题思路

1. **读题定位**：识别分子中可能的质子化位点（碱性原子：N、O）和去质子化位点（酸性氢：OH、NH、≡CH）。
2. **🔑 关键转换**：质子化发生在最碱性位点（胺N > 醇O）；去质子化发生在最酸性氢（羧酸 > 醇OH > 末端炔H）。
3. **验证**：对比各基团pKa，确保选择的位点正确。胺的pKa ~ 11 > 醇pKa ~ 16 > 炔pKa ~ 25。

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 哌啶在碱中去质子化 | 仲胺N上虽有H，但pKa ~ 35，极难去质子化 | 哌啶在碱中通常不反应 | 仲胺N-H的pKa是多少？ |
| 叔胺-醇中胺被去质子化 | 叔胺无N-H，不可去质子化 | NaH去质子化醇OH | 为什么胺比醇更碱性？ |
| 脒-炔烃中质子化在胺N上 | 脒有亚胺N（=N-）和胺N（-NH-），亚胺N更碱性 | 质子化在亚胺N上 | 为什么亚胺N比胺N更碱性？ |