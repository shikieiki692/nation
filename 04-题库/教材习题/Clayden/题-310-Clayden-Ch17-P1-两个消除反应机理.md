...
updated: 2026-07-25
aliases: [Clayden-Ch17-P1]
source: Clayden Organic Chemistry 2nd Ed. Chapter 17 Problem 1
cross_references: ["[[题-299-Clayden-Ch15-P1-SN1与SN2机理判断]]", "[[题-317-Clayden-Ch17-P8-环己基溴E2困难和构象变化]]", "[[题-294-Clayden-Ch14-P4-四个化合物立体化学讨论]]"]
module: 有机化学
status: 已填充
subject_module: 有机化学
pack: 章节练习
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| E2反应 | E2消除的机理和立体化学要求 | 直接 |
| E1反应 | E2与E1的区分 | 直接 |
| [[反式共平面]] | E2的立体化学要求 | 间接 |

## 解题思路

1. **读题定位**：两个消除反应→伯碳上的离去基团→E2
2. **🔑 关键转换**：碱夺取β-H + 离去基团离开 → 同步形成C=C双键。H和LG必须反式共平面
3. **验证**：检查产物烯烃结构，H和离去基团位置是否满足反式共平面

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 画成E1机理 | 没考虑碳正离子稳定性 | 伯碳正离子不稳定→必须E2 | 什么条件下走E1？ |
| 忘记画碱 | 只画了H和LG离开 | E2需要碱来夺取β-H | 常用E2碱有哪些？ |
| H和LG画成顺式 | 没考虑立体化学 | E2要求H和LG反式共平面 | 为什么必须反式？ |