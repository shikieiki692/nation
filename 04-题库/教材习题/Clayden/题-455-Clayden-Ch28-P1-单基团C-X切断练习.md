---
title: 题-455-Clayden-Ch28-P1-单基团C-X切断练习
type: 题目
fidelity: 原书逐字
submodule: 逆合成分析
exam_stage: 初赛
...
updated: 2026-07-25
aliases: [Clayden-Ch28-P1]
source: Clayden Organic Chemistry 2nd Ed. Chapter 28 Problem 1
...
|---|---|:---:|
| [[逆合成分析]] | 单基团切断策略 | 直接 |
| [[切断法]] | 选择正确的C-X键断裂位点 | 直接 |
| [[合成子]] | 切断后对应的合成等价物 | 直接 |
| Williamson醚合成 | C-O键形成的SN2策略 | 间接 |

## 解题思路

1. 读题定位：四种含杂原子的化合物，需要设计合成路线
2. 关键转换：识别每个C-X键→选择最容易形成的键进行切断→考虑SN2/SNAr/还原胺化等方法
3. 验证：检查合成路线中每步反应的可行性和选择性

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 对叔碳进行SN2 | 忽略了叔碳位阻对SN2的阻碍 | 叔碳上SN2极慢→应选择另一侧的切断 | SN2反应对碳级数有什么要求？ |
| 忘记还原胺化是制胺最佳方法 | 考虑了太多复杂方法 | 还原胺化（醛酮+胺+NaBH3CN）简洁高效 | 还原胺化的条件和适用范围是什么？ |
| 对SH需要强碱 | 混淆了SH和OH的酸性 | SH pKa约10，比OH（pKa约16）酸性强得多→弱碱即可去质子化 | 为什么SH比OH酸性强？ |