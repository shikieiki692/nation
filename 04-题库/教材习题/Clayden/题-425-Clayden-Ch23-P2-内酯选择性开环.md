...
updated: 2026-07-25
aliases: [Clayden-Ch23-P2]
source: Clayden Organic Chemistry 2nd Ed. Chapter 23 Problem 2
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[化学选择性]] | 内酯水解vs苄位C–O还原的选择性 | 直接 |
| [[保护基]] | 选择性反应中保护策略的运用 | 直接 |
| [[亲核加成]] | 内酯的亲核开环反应 | 间接 |
| [[催化氢化]] | 苄位C–O键的催化氢解 | 间接 |

## 解题思路

1. **读题定位**：题目要求将内酯选择性转化为两种产物——羟基酸（水解）或去官能团化的酸（还原）
2. **🔑 关键转换**：水解→碱性开环得羟基酸；还原→苄位C–O选择性断裂（氢解或HBr+还原）
3. **验证**：检查产物结构是否正确，官能团是否保留/转化

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 用水解条件还原内酯 | 混淆水解和还原 | 水解得羟基酸，还原需氢解或HBr+还原 | 碱性水解内酯的机理是什么？ |
| 不了解苄位C–O的特殊性 | 没有考虑苄位碳正离子稳定性 | 苄位C–O比普通C–O更容易断裂 | 为什么苄位C–O键容易氢解？ |
| 忽略羧基的兼容性 | 还原条件可能影响羧基 | 需选择性还原C–O而不还原CO₂H | 催化氢化能还原羧基吗？ |