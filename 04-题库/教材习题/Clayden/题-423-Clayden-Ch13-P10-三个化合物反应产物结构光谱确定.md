---
title: 题-423-Clayden-Ch13-P10-三个化合物反应产物结构光谱确定
type: 题目
fidelity: 原书逐字
submodule: NMR谱学
exam_stage: 决赛
...
updated: 2026-07-25
aliases: [Clayden-Ch13-P10]
source: Clayden Organic Chemistry 2nd Ed. Chapter 13 Problem 10
cross_references: ["[[题-536-Clayden-Ch18-P1-C6H5FO的13C NMR C-F偶合结构确定]]", "[[题-561-Clayden-Ch30-P2-不熟悉杂环合成和芳香性判断]]", "[[题-560-Clayden-Ch30-P1-吡咯并吡啶三环芳香杂环合成]]", "[[题-537-Clayden-Ch18-P2-Bullatenone结构A预测NMR并纠正]]"]
module: 有机化学
status: 已填充
subject_module: 有机化学
pack: 章节练习
...
| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[NMR谱学]] | 综合IR、¹³C、¹H NMR推断产物结构 | 直接 |
| [[波谱综合解析]] | 多种光谱数据交叉验证结构 | 直接 |
| [[质谱]] | 分子式确定不饱和度和元素组成 | 间接 |
| [[红外光谱]] | 官能团鉴定（羰基类型、OH等） | 间接 |

## 解题思路

1. **读题定位**：题目给出三个反应的光谱数据，要求推断产物结构——核心是系统分析每种光谱信息
2. **🔑 关键转换**：从分子式计算不饱和度→IR确定官能团→¹³C NMR确定碳类型和数目→¹H NMR确定连接关系和对称性→综合推断结构
3. **验证**：将推断结构的预期光谱与实际数据逐一比对，确认一致性

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| 不计算不饱和度 | 直接猜测结构 | 分子式→不饱和度→判断环/双键/三键数目 | C₁₀H₁₄O的不饱和度是多少？ |
| 混淆酯和酸的IR频率 | 没有区分不同羰基环境 | 酯约1745 cm⁻¹，酸约1715 cm⁻¹ + 宽OH峰 | 如何通过IR区分酯、酮、酸？ |
| 忽略对称性约束 | 没有分析等价H | 两个2H双峰（J=9 Hz）=对位二取代苯 | 对位二取代苯的NMR特征是什么？ |