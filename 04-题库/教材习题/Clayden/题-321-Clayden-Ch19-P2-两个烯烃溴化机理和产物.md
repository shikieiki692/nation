---
title: 题-321-Clayden-Ch19-P2-两个烯烃溴化机理和产物
type: 题目
fidelity: 原书逐字
submodule: 烯烃的亲电加成
exam_stage: 初赛
...
updated: 2026-07-25
aliases: [Clayden-Ch19-P2]
source: Clayden Organic Chemistry 2nd Ed. Chapter 19 Problem 2
...
Suggest mechanisms and draw the products for the bromination of each of the following alkenes:
...
溴化反应的核心机理是经过**溴鎓离子**中间体的反式（anti）加成。

1. **(E)-2-丁烯**：Br₂ 接近双键，π电子对亲电的 Br 进攻形成溴鎓离子桥。由于 (E)-2-丁烯是反式烯烃，且分子关于双键中心对称，Br⁻ 从溴鎓离子背面进攻任一碳原子，开环后得到 **(2R,3S)-2,3-二溴丁烷——内消旋体（meso）**。注意：不是外消旋体！因为分子有对称面。若为 (Z)-2-丁烯则得到外消旋体。

2. **环己烯**：Br₂ 从环的一面形成溴鎓离子，Br⁻ 从环的另一面（背面）进攻，得到 ***trans*-1,2-二溴环己烷**。由于初始烯烃是对称的但无手性，产物为等量的 (1R,2R) 和 (1S,2S) 对映体的**外消旋混合物**。

## 知识点映射

| 关联 KP | 考查角度 | 直接/间接 |
|---|---|:---:|
| [[亲电加成]] | 溴化反应的亲电加成机理（溴鎓离子路径） | 直接 |
| [[溴鎓离子]] | 溴鎓离子中间体的形成与开环——反式加成的根源 | 直接 |
| [[烯烃]] | E/Z烯烃与反式加成产物立体化学的关系 | 间接 |

## 解题思路

1. **读题定位**：两个烯烃的溴化，需画机理+产物，关注立体化学
2. **🔑 关键转换**：溴鎓离子形成 → Br⁻ 反面进攻开环 → 确定产物的相对/绝对构型
3. **验证**：(E)-烯烃+anti加成→内消旋体；对称环烯烃+anti加成→外消旋体；检查是否有手性中心和对称面

## 易错分析

| 错误 | 原因 | 纠正 | 课堂提问 |
|------|------|------|----------|
| (E)-2-丁烯溴化产物写成外消旋体 | 混淆了内消旋体和外消旋体 | (E)-2-丁烯+anti加成→meso，产物有对称面 | meso化合物和外消旋混合物的本质区别是什么？ |
| 环己烯产物写成cis-1,2-二溴环己烷 | 忽视了溴鎓离子的反式开环 | Br⁻必须从溴鎓离子背面进攻→trans产物 | 为什么Br⁻不能从同面进攻？ |
| 溴化机理中直接写Br⁻进攻碳 | 跳过溴鎓离子中间体 | 必须先形成三元环溴鎓离子，再被亲核进攻 | 为什么溴化不直接走碳阳离子机理？ |