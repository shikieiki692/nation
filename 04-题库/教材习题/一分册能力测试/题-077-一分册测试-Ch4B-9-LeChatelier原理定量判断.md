---
title: "题-077-一分册测试-Ch4B-9-LeChatelier原理定量判断"
type: 题目
aliases: ["一分册测试Ch4B题9"]
source_subject: 化学原理
submodule: 平衡移动定量分析
...
teaching_level: 竞赛
fidelity: 原书逐字
knowledge_points: ["[[化学平衡]]", "[[平衡常数]]", "[[Gibbs自由能]]"]
concepts: ["Kp与Qp比较", "Le Chatelier原理定量化", "加压扰动判断", "组分扰动判断"]
pack: 模块习题集
tags: [化竞, 一分册测试, 计算]
created: 2026-09-03
updated: 2026-09-03
...
# 题-077-一分册测试-Ch4B-9-LeChatelier原理定量判断
...
<!-- 校勘注: 9-3① 答案在原书中仅存孤立「NH₃」残句，依 Qp=232>Kp → 平衡逆向移动的逻辑与②④句式平行性，校勘补全为「故系统表现出平衡向左移动、减小 NH₃ 浓度的行为」（置信度高）；试题侧 B 卷第10题后存在镜像乱码区（「>>>（台）」「<<（台01）」等三级标题记号行及倒置文本），为第9/10题的镜像 OCR 幻觉，剔除；余为原书逐字 -->
