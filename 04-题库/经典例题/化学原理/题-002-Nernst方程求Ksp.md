...
- [[标准电极电势]] — 两个相关电极的 Eθ 差值
- [[溶度积]] — Ksp 的电化学测定法

## 解题思路1. 写出两个电极的 Nernst 方程2. 在特定条件下（[Cl⁻]=1）联立3. 利用 $E^{\ominus}$ 差值求解 $\lg K_{sp}$

## 易错分析- 混淆 $E^{\ominus}(\mathrm{AgCl/Ag})$ 和 $E^{\ominus}(\mathrm{Ag^+/Ag})$ 的关系- 忘记 $E^{\ominus}(\mathrm{AgCl/Ag})$ 对应 [Cl⁻] = 1 mol/L
