...
$$
n _ {\mathrm{H} _ {2} \mathrm{O}} = \frac {0.994 \mathrm{g}}{18.01 \mathrm{g} \mathrm{mol} ^ {- 1}} = 0.05519 \mathrm{mol}
$$

反应 2 产生 $CO_{2}$ 的物质的量（理想气体状态方程）:

$$
n _ {\mathrm{CO} _ {2}} = \frac {p V}{R T} = \frac {101.325 \mathrm{kPa} \times 1.245 \mathrm{L}}{8.314 \times 273.15 \mathrm{K}} = 0.05555 \mathrm{mol}
$$
...
$$
\begin{array}{l} \frac {2.356}{A _ {\mathbf {M}} \cdot n} = \frac {0.05533}{3 y} \\ A _ {\mathsf {M}} = \frac {2.356 \cdot 3 y}{0.05533 n} \\ \end{array}
$$

观察化学式，由于电荷守恒，金属的价态为 $4y / n$ ，假设其为整数。所以令 $t = 4y / n$

$$
A _ {\mathsf {M}} = \frac {2.356 \cdot 3 y}{0.05533 n} = \frac {2.356 \times 3}{0.05533 \times 4} t = 31.93 t
$$
...
$$
\begin{array}{l} M (\mathbf {A}) = 5 M \left(\mathrm{H} _ {2} \mathrm{O}\right) / 11.1 \% \\ = 5 \times (2 \times 1.008 + 16.00) \text { g mol} ^ {- 1} / 11.1\% \\ = 811 \mathrm{g} \mathrm{mol} ^ {- 1} \\ \end{array}
$$

通过失重推出剩余物的重量占总重的比例，并推出剩余物的式量：

$$
\begin{array}{l} M \left(\mathbf {M} _ {2} \mathrm{O} _ {3}\right) = M (\mathbf {A}) \times (1 - 11.1 \% - 31.2 \%) \\ = 811 \mathrm{g} \mathrm{mol} ^ {- 1} \times (1 - 11.1 \% - 31.2 \%) \\ = 468 \mathrm{g} \mathrm{mol} ^ {- 1} \\ \end{array}
$$

由此可以得到 M 的摩尔质量，通过查阅元素周期表便可以确定 M 为 Bi:

$$
\begin{array}{l} M (\mathbf {M}) = \frac {1}{2} \times \left[ M \left(\mathbf {M} _ {2} \mathrm{O} _ {3}\right) - 3 M (\mathrm{O}) \right] \\ = \frac {1}{2} \times (468 \mathrm{g} \mathrm{mol} ^ {- 1} - 3 \times 16 \mathrm{g} \mathrm{mol} ^ {- 1}) \\ = 210 \mathrm{g} \mathrm{mol} ^ {- 1} \\ \end{array}
$$
...
$$
M \left(\mathrm{CO} _ {3} ^ {2 -}\right) = 60.01 \mathrm{g} \mathrm{mol} ^ {- 1}
$$

$$
M \left(\mathrm{C} _ {2} \mathrm{O} _ {4} ^ {2 -}\right) = 88.02 \mathrm{g} \mathrm{mol} ^ {- 1}
$$

并且通过前面的条件可推得

$$
\begin{array}{l} 3 M (\mathbf {X}) + y M \left(\mathrm{H} _ {2} \mathrm{O}\right) = 811 \mathrm{g} \mathrm{mol} ^ {- 1} - 2 \times 210 \mathrm{g} \mathrm{mol} ^ {- 1} \\ = 391 \mathrm{g} \mathrm{mol} ^ {- 1} \\ \end{array}
$$
