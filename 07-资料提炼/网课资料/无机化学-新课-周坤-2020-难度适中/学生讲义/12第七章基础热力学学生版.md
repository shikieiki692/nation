...
<table><tr><td>物质</td><td>MnO (s)</td><td> $Mn_{2}O_{3}$ (s)</td><td> $Mn_{3}O_{4}$ (s)</td><td> $MnO_{2}$ (s)</td><td> $Mn_{2}O_{7}$ (s)</td></tr><tr><td> $S^{\Phi}/\mathrm{J}·\mathrm{mol}^{-1}·\mathrm{K}^{-1}$ </td><td>61.5</td><td>—</td><td>—</td><td>—</td><td>32</td></tr><tr><td> $\Delta_{f}H_{m}^{\Phi}/\mathrm{kJ}·\mathrm{mol}^{-1}$ </td><td>-385.1</td><td>—</td><td>—</td><td>—</td><td>—</td></tr><tr><td> $\Delta_{f}G_{m}^{\Phi}/\mathrm{kJ}·\mathrm{mol}^{-1}$ </td><td>-363.3</td><td>-379.9</td><td>-1282.9</td><td>-466.7</td><td>—</td></tr><tr><td>物质</td><td> $O_{2}$ (g)</td><td> $H_{2}$ (g)</td><td> $H_{2}O$ (g)</td><td>CO (g)</td><td>C(石墨)</td></tr><tr><td> $S^{\Phi}/\mathrm{J}·\mathrm{mol}^{-1}·\mathrm{K}^{-1}$ </td><td>205</td><td>130.5</td><td>188.7</td><td>197.5</td><td>5.74</td></tr><tr><td> $\Delta_{f}H_{m}^{\Phi}/\mathrm{kJ}·\mathrm{mol}^{-1}$ </td><td>—</td><td>—</td><td>-248.1</td><td>-110.5</td><td>—</td></tr></table>
