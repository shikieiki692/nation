...
<table><tr><td>2-1共2分</td><td>反应1: $H_{2}O(l) = H_{2}O(g)$  $K_{P}^{o} = \frac{3.167\ kPa}{100\ kPa} = 3.167 \times 10^{-2}$ 1 分 $\Delta_{v}G_{m}^{o} = -RT\ln K_{p}^{o}$ 0.5 分 $\Delta_{v}G_{m}^{o}(H_{2}O) = 8.56\ \mathrm{kJ}\ \mathrm{mol}^{-1}$ 0.5 分</td></tr><tr><td>2-2共5分</td><td>电池总反应(反应2), $3H_{2}(p^{o}) + Au_{2}O_{3} \longrightarrow 2Au + 3H_{2}O(l)$ 1 分或者系数选择其他按比例示出的方式亦可,例如 $H_{2}(p^{o}) + \frac{1}{3}Au_{2}O_{3} \longrightarrow \frac{2}{3}Au + H_{2}O(l)$ 电池电动势: $E^{o} = 1.362\ V$ 0.5 分 $\Delta_{r}G_{m}^{o}(2) = -nE^{o}F = -6 \times 1.362 \times 9.65 \times 10^{4}/10^{3} = -788.6\ \mathrm{kJ}\cdot \mathrm{mol}^{-1}$ 1 分若系数选择其他按比例,则此处电子数n应与之相应, $\Delta_{r}G_{m}^{o}(2)$ 按比例变化。又知:(反应3) $H_{2}(g) + 1/2\ O_{2}(g) \rightarrow H_{2}O(g)$  $\Delta_{r}G_{m}^{o}(3) = \Delta_{f}G_{m}^{o}(H_{2}O,g) = -228.6\ \mathrm{kJ}\ \mathrm{mol}^{-1}$ 0.5 分则:(反应4) $H_{2}(g) + 1/2\ O_{2}(g) \rightarrow H_{2}O(l)$  $\Delta_{r}G_{m}^{o}(4) = -228.6 - 8.56 = -237.2\ \mathrm{kJ}\ \mathrm{mol}^{-1}$ 1 分则 反应(2)*2-反应(4)*6 $2Au_{2}O_{3} = 4Au + 3O_{2}$  $\Delta_{r}G_{m}^{o} = (-788.6) \times 2 - (-237.2 \times 6) = -154.2\ (\mathrm{kJ}\ \mathrm{mol}^{-1})$ 1 分</td></tr><tr><td>2-3共1分</td><td> $\Delta_{f}G_{m}^{o}(Au_{2}O_{3}) = -\Delta_{r}G_{m}^{o}/2 = 77.1\ (\mathrm{kJ}\ \mathrm{mol}^{-1})$ 1 分</td></tr></table>
...
| 函数 | 微分式 | 积分式 |
| --- | --- | --- |
| y=f(x) | dy/dx=ky | lny=kx+c,c为常数 |
| y=f(x) | dy/dx=k(ay+b),a和b为常数 | 1/a ln(ay+b)=kx+c,c为常数 |
...
<table><tr><td>配合物</td><td><img src="2022-36-CChO-juesai-grading-2_images/9d2999c88070f23f555ebde6791102025b551efd28f717037baf0400bf8a65be.jpg"/>(a)</td><td> $\neg^+$ <img src="2022-36-CChO-juesai-grading-2_images/b611dfd92acd60ab016f73e9fa0a1dc6cf7c32294063c9c055895f0dcc113fdd.jpg"/>(b)</td><td> $\neg^+$ <img src="2022-36-CChO-juesai-grading-2_images/7fbdc7757261ef1881ce32ff4cbaa818b74422669e5d03a9ab1f8e038c8732de.jpg"/>(c)</td><td><img src="2022-36-CChO-juesai-grading-2_images/1110e3bb16752e5904dd7dff8f4460dd686069f507d2ac090599d24a84b52146.jpg"/>(d)</td></tr><tr><td>F-E记号</td><td> $\{MnNO\}^6$ </td><td> $\{Fe(NO)_2\}^9$ </td><td>需回答</td><td>需回答</td></tr></table>
